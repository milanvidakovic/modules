...
sprintf:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/sprintf.c:204:    	asm("ld.w r0, [190300]\njr r0\n");
# 204 "/mnt/c/Prj/Altera/C/moxiebox/modules/lib/sprintf.c" 1
	ld.w r0, [190300]
jr r0

# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/sprintf.c:205: }
	nop	
	mov.w	sp, r13	#,
	pop	r13		#
	ret	
...
vsprintf:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/sprintf.c:209:    	asm("ld.w r0, [190304]\njr r0\n");
# 209 "/mnt/c/Prj/Altera/C/moxiebox/modules/lib/sprintf.c" 1
	ld.w r0, [190304]
jr r0

# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/sprintf.c:210: }
	nop	
	mov.w	sp, r13	#,
	pop	r13		#
	ret	
