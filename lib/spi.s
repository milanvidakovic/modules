...
# -D KERNEL /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c -mel
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:36: 		*PORT_SPI_OUT = b; //send the byte to the SPI
	...
	j	.L1		#
.L2:
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:39: 	else if (port == SPI1) {
	ld.w	r1, [r13 + (8)]	# tmp44, port
	mov.w	r0, 1	# tmp45,
	cmp.w	r1, r0	# tmp44, tmp45
	jnz	.L1		#
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:40: 		received_from_slave1 = 0;
	xor.w	r0, r0	# tmp46
	st.w	[received_from_slave1], r0	# received_from_slave1, tmp46
.L7:
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:44: 			if (counter++ == 65535)
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:44: 			if (counter++ == 65535)
	...
	jz	.L9		#
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:46: 			busy1 = *PORT_SPI1_OUT_BUSY;
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:47: 		} while (busy1);
	ld.s	r1, [r13 + (-6)]	# tmp50, busy1
	xor.w	r0, r0	# tmp51
	cmp.w	r1, r0	# tmp50, tmp51
	jnz	.L7		#
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:48: 		*PORT_SPI1_OUT = b; //send the byte to the SPI
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:32: 				return;
	...
	j	.L1		#
.L9:
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:45: 				return;
	nop	
.L1:
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:50: }
	mov.w	sp, r13	#,
	pop	r13		#
	ret	
...
read_spi:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 4 #111	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:54: 	int counter = 0;
	xor.w	r0, r0	# tmp36
	st.w	[r13 + (-4)], r0	# counter, tmp36
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:55: 	if (port == SPI0) {
	ld.w	r1, [r13 + (8)]	# tmp37, port
	xor.w	r0, r0	# tmp38
	cmp.w	r1, r0	# tmp37, tmp38
	jnz	.L11		#
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:56: 		while (!received_from_slave || *PORT_SPI_OUT_BUSY) 
	j	.L12		#
.L14:
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:58: 			if (counter++ == 65535)
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:58: 			if (counter++ == 65535)
	...
	jnz	.L12		#
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:59: 				return 0;
	xor.w	r0, r0	# _11
	j	.L10		#
.L12:
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:56: 		while (!received_from_slave || *PORT_SPI_OUT_BUSY) 
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:56: 		while (!received_from_slave || *PORT_SPI_OUT_BUSY) 
	...
	jnz	.L14		#
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:61: 		return received_byte;
	ld.w	r0, [received_byte]	# _11, received_byte
	j	.L10		#
.L11:
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:63: 	else if (port == SPI1) {
	ld.w	r1, [r13 + (8)]	# tmp44, port
	mov.w	r0, 1	# tmp45,
	cmp.w	r1, r0	# tmp44, tmp45
	jnz	.L15		#
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:64: 		while (!received_from_slave1 || *PORT_SPI1_OUT_BUSY) 
	j	.L16		#
.L17:
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:66: 			if (counter++ == 65535)
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:66: 			if (counter++ == 65535)
	...
	jnz	.L16		#
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:67: 				return 0;
	xor.w	r0, r0	# _11
	j	.L10		#
.L16:
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:64: 		while (!received_from_slave1 || *PORT_SPI1_OUT_BUSY) 
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:64: 		while (!received_from_slave1 || *PORT_SPI1_OUT_BUSY) 
	...
	jnz	.L17		#
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:69: 		return received_byte1;
	ld.w	r0, [received_byte1]	# _11, received_byte1
	j	.L10		#
.L15:
.L10:
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:71: }
	mov.w	sp, r13	#,
	pop	r13		#
	ret	
...
SPI_Byte:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:76: 	send_spi(port, transmit);
	mov.w	r0, sp	# tmp28,
	...
	st.w	[r0], r1	#, tmp30
	call	send_spi		#
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:77: 	return read_spi(port);
	mov.w	r1, sp	# tmp31,
	ld.w	r0, [r13 + (8)]	# tmp32, port
	st.w	[r1], r0	#, tmp32
	call	read_spi		#
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:78: }
	mov.w	sp, r13	#,
	pop	r13		#
	ret	
...
spi_irq_triggered:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:82: 	asm 
# 82 "/mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c" 1
	push r0
push r1
push r2
push r3
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:87: 	received_byte = *PORT_SPI_IN;
	ld.w	r0, [PORT_SPI_IN]	# PORT_SPI_IN.12_1, PORT_SPI_IN
	ld.s	r0, [r0]	# _2, *PORT_SPI_IN.12_1
	zex.s	r0, r0	# _3, _2
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:87: 	received_byte = *PORT_SPI_IN;
	st.w	[received_byte], r0	# received_byte, _3
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:88: 	received_from_slave = 1;
	mov.w	r0, 1	# tmp29,
	st.w	[received_from_slave], r0	# received_from_slave, tmp29
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:89: 	asm 
# 89 "/mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c" 1
	pop r13
pop r12
pop r11
pop r10
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:102: 	received_byte1 = *PORT_SPI1_IN;
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:103: 	received_from_slave1 = 1;
	mov.w	r0, 1	# tmp29,
...
init_spi:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:112: 	*SPI_HANDLER_INSTR 	= 1;
	ld.w	r0, [SPI_HANDLER_INSTR]	# SPI_HANDLER_INSTR.14_1, SPI_HANDLER_INSTR
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:112: 	*SPI_HANDLER_INSTR 	= 1;
	mov.s	r1, 1	# tmp32,
	st.s	[r0], r1	# *SPI_HANDLER_INSTR.14_1, tmp32
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:113: 	*SPI_HANDLER_ADDR 	= (int)&spi_irq_triggered;
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:115: 	*SPI1_HANDLER_INSTR 	= 1;
	ld.w	r0, [SPI1_HANDLER_INSTR]	# SPI1_HANDLER_INSTR.17_4, SPI1_HANDLER_INSTR
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:115: 	*SPI1_HANDLER_INSTR 	= 1;
	mov.s	r1, 1	# tmp33,
	st.s	[r0], r1	# *SPI1_HANDLER_INSTR.17_4, tmp33
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:116: 	*SPI1_HANDLER_ADDR 	= (int)&spi1_irq_triggered;
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/spi.c:118: }
	nop	
	mov.w	sp, r13	#,
	pop	r13		#
	ret	
