...
# options passed:  /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c -mel
...
cls:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:666: 	asm("ld.w r0, [190000]\njr r0\n");
# 666 "/mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c" 1
	ld.w r0, [190000]
jr r0
...
put_char:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:669: 	asm("ld.w r0, [190004]\njr r0\n");
# 669 "/mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c" 1
	ld.w r0, [190004]
jr r0

# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:670: }
	nop	
	mov.w	sp, r13	#,
	pop	r13		#
	ret	
...
printf:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:672: 	asm("ld.w r0, [190008]\njr r0\n");
...
puts:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:676: 	asm("ld.w r0, [190012]\njr r0\n");
...
rand:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:680: 	asm("ld.w r0, [190016]\njr r0\n");
...
should_break:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:684: 	asm("ld.w r0, [190020]\njr r0\n");
...
getc:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:688: 	asm("ld.w r0, [190024]\njr r0\n");
...
gets:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:692: 	asm("ld.w r0, [190028]\njr r0\n");
...
init_stdio:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:696: 	asm("ld.w r0, [190032]\njr r0\n");
...
delay:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:700: 	asm("ld.w r0, [190036]\njr r0\n");
...
xy:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:704: 	asm("ld.w r0, [190040]\njr r0\n");
...
get_millis:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:708: 	asm("ld.w r0, [190044]\njr r0\n");
...
is_key_pressed:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:712: 	asm("ld.w r0, [190048]\njr r0\n");
...
is_key_released:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:716: 	asm("ld.w r0, [190052]\njr r0\n");
...
toggle_cursor:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:720: 	asm("ld.w r0, [190056]\njr r0\n");
...
putchar:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:724: 	asm("ld.w r0, [190060]\njr r0\n");
# 724 "/mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c" 1
	ld.w r0, [190060]
jr r0

# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:725: }
	nop	
	mov.w	sp, r13	#,
	pop	r13		#
	ret	
...
video_mode:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:728: 	asm("ld.w r0, [190064]\njr r0\n");
# 728 "/mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c" 1
	ld.w r0, [190064]
jr r0

# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:729: }
	nop	
	mov.w	sp, r13	#,
	pop	r13		#
	ret	
...
scroll_up:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:731: 	asm("ld.w r0, [190416]\njr r0\n");
# 731 "/mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c" 1
	ld.w r0, [190416]
jr r0

# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/stdio.c:732: }
	nop	
	mov.w	sp, r13	#,
	pop	r13		#
	ret	
