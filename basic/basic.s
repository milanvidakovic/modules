...
toUppercaseBuffer:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 8 #111	#,
# basic.c:273: 	char *c = txtpos;
	ld.w	r0, [txtpos]	# tmp36, txtpos
	st.w	[r13 + (-4)], r0	# c, tmp36
# basic.c:274: 	char quote = 0;
	xor.w	r0, r0	# tmp37
	st.b	[r13 + (-5)], r0	# quote, tmp37
# basic.c:276: 	while (*c != NL)
	j	.L4		#
.L9:
# basic.c:279: 		if (*c == quote)
...
# basic.c:282: 			quote = *c;
	...
	j	.L6		#
.L8:
# basic.c:283: 		else if (quote == 0 && *c >= 'a' && *c <= 'z')
	ld.b	r0, [r13 + (-5)]	#, quote
	sex.b	r1, r0	# tmp50,
	xor.w	r0, r0	# tmp51
...
ignore_blanks:
	push	r13		#
	mov.w	r13, sp	#,
# basic.c:291: 	while (*txtpos == SPACE || *txtpos == TAB)
	j	.L11		#
.L12:
# basic.c:292: 		txtpos++;
...
skip_to_end:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 4 #111	#,
# basic.c:297: 	txtpos = program_end + sizeof(LINENUM);
	ld.w	r0, [program_end]	# program_end.10_1, program_end
	add.w	r0, 4 #111	# _2,
# basic.c:297: 	txtpos = program_end + sizeof(LINENUM);
	st.w	[txtpos], r0	# txtpos, _2
# basic.c:300: 	while (*txtpos != NL)
	j	.L14		#
.L15:
# basic.c:301: 		txtpos++;
...
findline:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 4 #111	#,
# basic.c:321: 	unsigned char *line = program_start;
	ld.w	r0, [program_start]	# tmp35, program_start
	st.w	[r13 + (-4)], r0	# line, tmp35
.L25:
# basic.c:324: 		if (line == program_end)
...
# basic.c:325: 			return line;
	...
	j	.L23		#
.L22:
# basic.c:327: 		if (((LINENUM *)line)[0] >= linenum)
...
# basic.c:327: 		if (((LINENUM *)line)[0] >= linenum)
	...
	js	.L24		#
# basic.c:328: 			return line;
	ld.w	r0, [r13 + (-4)]	# _9, line
	j	.L23		#
.L24:
# basic.c:331: 		line += line[sizeof(LINENUM)];
...
# basic.c:343: 	printf("%d ", line_num);
	...
	st.w	[r0], r1	#, tmp41
	call	printf		#
# basic.c:344: 	while (*list_line != NL)
	j	.L27		#
.L28:
# basic.c:346: 		put_char(*list_line);
...
testnum:
	...
	push	r6		#
	sub.w	sp, 28 #111	#,
# basic.c:355: 	VAR num = 0;
	xor.w	r0, r0	# tmp41
	st.w	[r13 + (-8)], r0	# num, tmp41
# basic.c:356: 	ignore_blanks(txtpos);
	ld.w	r0, [txtpos]	# txtpos.27_1, txtpos
	mov.w	r1, sp	# tmp42,
	st.w	[r1], r0	#, txtpos.27_1
	call	ignore_blanks		#
# basic.c:358: 	while (*txtpos >= '0' && *txtpos <= '9')
	j	.L30		#
.L34:
# basic.c:361: 		if (num >= 0xFFFFFFFF / 10)
	...
	jss	.L37		#
# basic.c:363: 			num = 0xFFFFFFFF;
	mov.w	r0, 1333788672	# tmp47,
	st.w	[r13 + (-8)], r0	# num, tmp47
# basic.c:364: 			break;
	j	.L33		#
.L37:
# basic.c:367: 		num = num * 10 + *txtpos - '0';
...
entered_with_line_num:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 84 #111	#,
# basic.c:383: 	linelen = 0;
	xor.w	r0, r0	# tmp98
	st.b	[r13 + (-1)], r0	# linelen, tmp98
# basic.c:384: 	while (txtpos[linelen] != NL)
	j	.L39		#
.L40:
# basic.c:385: 		linelen++;
...
# basic.c:384: 	while (txtpos[linelen] != NL)
	...
	jnz	.L40		#
# basic.c:386: 	linelen++; // Include the NL in the line length
	ld.b	r0, [r13 + (-1)]	# linelen.34_6, linelen
	add.w	r0, 1 #111	# tmp103,
	st.b	[r13 + (-1)], r0	# linelen, tmp104
# basic.c:387: 	linelen += sizeof(LINENUM) + sizeof(char); // Add space for the line number and line length
...
# basic.c:397: 		txtpos[sizeof(LINENUM) + sizeof(char)] = ' ';
...
# basic.c:409: 	if (start != program_end && *((LINENUM *)start) == linenum)
	...
	jnz	.L43		#
# basic.c:414: 		from = start + start[sizeof(LINENUM)];
...
# basic.c:415: 		dest = start;
	ld.w	r0, [r13 + (-8)]	# tmp123, start
	st.w	[r13 + (-20)], r0	# dest, tmp123
# basic.c:417: 		tomove = program_end - from;
...
# basic.c:418: 		while (tomove > 0)
	j	.L44		#
.L45:
# basic.c:420: 			*dest = *from;
...
# basic.c:418: 		while (tomove > 0)
	...
	jnz	.L45		#
# basic.c:425: 		program_end = dest;
	ld.w	r0, [r13 + (-20)]	# tmp135, dest
	st.w	[program_end], r0	# program_end, tmp135
.L43:
# basic.c:428: 	if (txtpos[sizeof(LINENUM) + sizeof(char)] == NL)
...
# basic.c:428: 	if (txtpos[sizeof(LINENUM) + sizeof(char)] == NL)
	...
	jz	.L58		#
# basic.c:435: 	first_time = 1; // odd address hack
	mov.w	r0, 1	# tmp138,
	st.w	[r13 + (-16)], r0	# first_time, tmp138
# basic.c:437: 	while (linelen > 0)
	j	.L48		#
.L57:
# basic.c:443: 		space_to_make = txtpos - program_end;
...
# basic.c:448: 		tomove = program_end - start;
...
# basic.c:463: 		if(first_time && (txtpos[sizeof(LINENUM) + sizeof(char)] == ' '))
...
# basic.c:463: 		if(first_time && (txtpos[sizeof(LINENUM) + sizeof(char)] == ' '))
	...
	jnz	.L52		#
# basic.c:468: 			k = txtpos[sizeof(LINENUM)];
	ld.w	r0, [txtpos]	# txtpos.54_45, txtpos
	add.w	r0, 4 #111	# _46,
	ld.b	r0, [r0]	# _47, *_46
# basic.c:468: 			k = txtpos[sizeof(LINENUM)];
	st.b	[r13 + (-49)], r0	# k, _47
# basic.c:469: 			k -= sizeof(LINENUM) + sizeof(char); // actual length of line
	ld.b	r0, [r13 + (-49)]	# k.55_48, k
	add.w	r0, -5 #111	# tmp161,
	st.b	[r13 + (-49)], r0	# k, _49
# basic.c:470: 			for (l = 0; l < k; l++)
	xor.w	r0, r0	# tmp162
	st.w	[r13 + (-12)], r0	# l, tmp162
# basic.c:470: 			for (l = 0; l < k; l++)
	j	.L53		#
.L54:
# basic.c:472: 				txtpos[sizeof(LINENUM) + sizeof(char) + l] = txtpos[sizeof(LINENUM) + sizeof(char) + l + 1];
...
# basic.c:470: 			for (l = 0; l < k; l++)
	...
	jss	.L54		#
# basic.c:474: 			txtpos[k + sizeof(LINENUM) + sizeof(char) - 2] = 32;
...
# basic.c:475: 			txtpos[k + sizeof(LINENUM) + sizeof(char) - 1] = NL;
...
.L52:
# basic.c:480: 		for (tomove = 0; tomove < space_to_make; tomove++)
	xor.w	r0, r0	# tmp168
	st.w	[r13 + (-32)], r0	# tomove, tmp168
# basic.c:480: 		for (tomove = 0; tomove < space_to_make; tomove++)
	j	.L55		#
.L56:
# basic.c:482: 			*start = *txtpos;
...
# basic.c:480: 		for (tomove = 0; tomove < space_to_make; tomove++)
	...
	js	.L56		#
# basic.c:489: 		program_end = newEnd;
	ld.w	r0, [r13 + (-48)]	# tmp178, newEnd
	st.w	[program_end], r0	# program_end, tmp178
# basic.c:490: 		first_time = 0;  // odd address hack
	xor.w	r0, r0	# tmp179
...
exec_mem:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:512: 	printf("TinyBasic %s\n", kVersion);
	mov.w	r0, sp	# tmp29,
	mov.w	r1, .LC4	# tmp30,
	st.w	[r0 + (4)], r1	#, tmp30
	mov.w	r1, .LC5	# tmp31,
	st.w	[r0], r1	#, tmp31
	call	printf		#
# basic.c:513: 	printf("%d bytes free\n", variables_begin - program_end);
...
# basic.c:519: 	table_index = 0;
	xor.w	r0, r0	# tmp46
	st.b	[table_index], r0	# table_index, tmp46
.L71:
# basic.c:523: 		if (*table == 0)
...
# basic.c:540: 			if (*table == 0x01)
	...
	cmp.w	r1, r0	# tmp56, tmp57
	jnz	.L69		#
# basic.c:542: 				txtpos += i;  // Advance the pointer to following the keyword
...
# basic.c:569: 	txtpos++;
	...
	add.w	r0, 1 #111	# _4,
	st.w	[txtpos], r0	# txtpos, _4
# basic.c:572: 	while (txtpos[i] != delim)
	j	.L76		#
.L78:
# basic.c:574: 		if (txtpos[i] == NL)
...
# basic.c:572: 	while (txtpos[i] != delim)
	cmp.w	r1, r0	# _13, _14
	jnz	.L78		#
# basic.c:580: 	while (*txtpos != delim)
	j	.L79		#
.L80:
# basic.c:582: 		put_char(*txtpos);
...
# basic.c:580: 	while (*txtpos != delim)
	cmp.w	r1, r0	# _22, _23
	jnz	.L80		#
# basic.c:585: 	txtpos++; // Skip over the last delimiter
...
check_no_arg_func:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:592: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:593: 	if (*txtpos != '(')
...
# basic.c:595: 	txtpos++;
	...
	add.w	r0, 1 #111	# _4,
	st.w	[txtpos], r0	# txtpos, _4
# basic.c:596: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:597: 	if (*txtpos != ')')
...
expr4:
	...
	push	r6		#
	sub.w	sp, 52 #111	#,
# basic.c:605: 	unsigned char f = table_index;
	ld.b	r0, [table_index]	# table_index.90_1, table_index
	st.b	[r13 + (-21)], r0	# f, table_index.90_1
# basic.c:608: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:614: 	if (*txtpos == '-') {
...
# basic.c:616: 		return -expr4();
	...
	j	.L87		#
.L86:
# basic.c:627: 	if (*txtpos >= '0' && *txtpos <= '9')
...
# basic.c:648: 		} while ((*txtpos >= '0' && *txtpos <= '9') || (*txtpos == '.'));
...
# basic.c:648: 		} while ((*txtpos >= '0' && *txtpos <= '9') || (*txtpos == '.'));
	...
	jz	.L93		#
# basic.c:652: 		return a;
	ld.w	r1, [r13 + (-8)]	# _98, a
	j	.L87		#
.L88:
# basic.c:659: 	if (txtpos[0] >= 'A' && txtpos[0] <= 'Z')
...
# basic.c:659: 	if (txtpos[0] >= 'A' && txtpos[0] <= 'Z')
	...
	cmp.w	r1, r0	# tmp159, tmp160
	jg	.L94		#
# basic.c:663: 		if (txtpos[1] < 'A' || txtpos[1] > 'Z')
...
# basic.c:663: 		if (txtpos[1] < 'A' || txtpos[1] > 'Z')
	...
	jse	.L96		#
.L95:
# basic.c:669: 			val = ((VAR *)variables_begin)[*txtpos - 'A'];
...
# basic.c:671: 			return val;
	ld.w	r1, [r13 + (-28)]	# _98, val
	j	.L87		#
.L96:
# basic.c:675: 		scantable(func_tab);
	mov.w	r1, sp	# tmp168,
	mov.w	r0, func_tab	# tmp169,
	st.w	[r1], r0	#, tmp169
	call	scantable		#
# basic.c:681: 		if (table_index == FUNC_UNKNOWN)
...
# basic.c:681: 		if (table_index == FUNC_UNKNOWN)
	...
	jz	.L128		#
# basic.c:684: 		switch(table_index)
	...
	j	.L100		#
.L102:
# basic.c:687: 			if (check_no_arg_func())
...
# basic.c:689: 			return getc();
	...
	j	.L87		#
.L103:
# basic.c:691: 			if (check_no_arg_func())
	call	check_no_arg_func		#
	mov.w	r1, r0	# _57,
# basic.c:691: 			if (check_no_arg_func())
	xor.w	r0, r0	# tmp179
	...
	jnz	.L130		#
# basic.c:693: 			return is_key_pressed();
	call	is_key_pressed		#
	st.w	[sp], r0	#, _58
	call	__floatsisf		#
	mov.w	r1, r0	# _98,
	j	.L87		#
.L101:
# basic.c:695: 			return M_PI;
	mov.w	r1, 1078530011	# _98,
	j	.L87		#
.L99:
# basic.c:697: 			return M_E;
	mov.w	r1, 1076754516	# _98,
	j	.L87		#
.L100:
# basic.c:700: 		f = table_index;
...
# basic.c:706: 		expression_error = 0;
	xor.w	r0, r0	# tmp182
	st.b	[expression_error], r0	# expression_error, tmp182
# basic.c:707: 		val = expression();
	call	expression		#
	st.w	[r13 + (-28)], r0	# val,
# basic.c:708: 		if (expression_error)
...
# basic.c:708: 		if (expression_error)
	...
	jnz	.L132		#
# basic.c:711: 		ignore_blanks();
	call	ignore_blanks		#
# basic.c:716: 		VAR val2 = 0;
	xor.w	r0, r0	# tmp185
...
# basic.c:722: 				expression_error = 0;
	xor.w	r0, r0	# tmp190
	st.b	[expression_error], r0	# expression_error, tmp190
# basic.c:723: 				val2 = expression();
	call	expression		#
	st.w	[r13 + (-20)], r0	# val2,
# basic.c:724: 				if (expression_error)
...
# basic.c:732: 		switch (f)
	...
	j	.L94		#
.L121:
# basic.c:735: 				return buffer[(int)val];
...
# basic.c:737: 				if (val < 0)
	...
	jges	.L127		#
# basic.c:738: 					return -val;
	ld.w	r1, [r13 + (-28)]	# tmp223, val
	mov.w	r0, -2147483648	# tmp224,
	xor.w	r1, r0	# _98, tmp224
	j	.L87		#
.L127:
# basic.c:739: 				return val;
	ld.w	r1, [r13 + (-28)]	# _98, val
	j	.L87		#
.L120:
# basic.c:741: 				return(rand() % (int)val);
	call	rand		#
	mov.w	r6, r0	# _80,
# basic.c:741: 				return(rand() % (int)val);
...
# basic.c:753: 				return(sqrtf(val));
	...
	j	.L87		#
.L113:
# basic.c:755: 				return(powf(val, val2));
	mov.w	r0, sp	# tmp238,
...
# basic.c:769: 		a = expression();
	call	expression		#
	st.w	[r13 + (-32)], r0	# a,
# basic.c:770: 		if (*txtpos != ')')
...
# basic.c:774: 		return a;
	ld.w	r1, [r13 + (-32)]	# _98, a
	j	.L87		#
.L128:
# basic.c:682: 			goto expr4_error;
	nop	
	j	.L98		#
.L129:
# basic.c:688: 				goto expr4_error;
	nop	
	j	.L98		#
.L130:
...
# basic.c:725: 					goto expr4_error;
	...
	j	.L98		#
.L135:
# basic.c:777: expr4_error:
	nop	
	j	.L98		#
.L136:
# basic.c:771: 			goto expr4_error;
	nop	
.L98:
# basic.c:778: 	expression_error = 1;
	mov.b	r0, 1	# tmp251,
	st.b	[expression_error], r0	# expression_error, tmp251
# basic.c:779: 	return 0;
	xor.w	r1, r1	# _98
.L87:
# basic.c:781: }
...
# basic.c:788: 	a = expr4();
	call	expr4		#
	st.w	[r13 + (-8)], r0	# a,
# basic.c:790: 	ignore_blanks(); // fix for eg:  100 a = a + 1
	call	ignore_blanks		#
.L147:
...
# basic.c:805: 				a /= b;
	...
	j	.L147		#
.L150:
# basic.c:807: 				expression_error = 1;
	mov.b	r0, 1	# tmp58,
	st.b	[expression_error], r0	# expression_error, tmp58
	j	.L147		#
.L140:
# basic.c:809: 		else if (*txtpos == '%')
...
# basic.c:816: 				a = x;
	...
	j	.L147		#
.L151:
# basic.c:818: 				expression_error = 1;
	mov.b	r0, 1	# tmp71,
	st.b	[expression_error], r0	# expression_error, tmp71
	j	.L147		#
.L143:
# basic.c:821: 			return a;
	ld.w	r0, [r13 + (-8)]	# _23, a
	mov.w	r1, r0	# <retval>, _23
# basic.c:823: }
	mov.w	r0, r1	#, <retval>
...
# basic.c:859: 	a = expr2();
	call	expr2		#
	st.w	[r13 + (-4)], r0	# a,
# basic.c:866: 	if (expression_error)	return a;
...
# basic.c:866: 	if (expression_error)	return a;
	...
	j	.L165		#
.L164:
# basic.c:868: 	scantable(relop_tab);
	mov.w	r1, sp	# tmp34,
	mov.w	r0, relop_tab	# tmp35,
	st.w	[r1], r0	#, tmp35
	call	scantable		#
# basic.c:874: 	if (table_index == RELOP_UNKNOWN)
...
# basic.c:874: 	if (table_index == RELOP_UNKNOWN)
	...
	cmp.w	r1, r0	# tmp36, tmp37
	jnz	.L166		#
# basic.c:875: 		return a;
	ld.w	r0, [r13 + (-4)]	# _5, a
	j	.L165		#
.L166:
# basic.c:877: 	switch (table_index)
...
assignment:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 32 #111	#,
# basic.c:921: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:924: 		return;
	j	.L202		#
.L204:
# basic.c:929: 	var = (VAR *)variables_begin + *txtpos - 'A';
...
# basic.c:935: 	txtpos++;
	...
	add.w	r0, 1 #111	# _12,
	st.w	[txtpos], r0	# txtpos, _12
# basic.c:937: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:939: 	if (*txtpos != '=')
...
# basic.c:945: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:946: 	expression_error = 0;
	xor.w	r0, r0	# tmp56
	st.b	[expression_error], r0	# expression_error, tmp56
# basic.c:947: 	value = expression();
	call	expression		#
	st.w	[r13 + (-8)], r0	# value,
# basic.c:948: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:955: 	if (expression_error)
...
# basic.c:958: 		return;
	j	.L202		#
.L207:
# basic.c:961: 	if (*txtpos != NL && *txtpos != ':')
...
# basic.c:983: 		ignore_blanks(txtpos);
	...
	call	ignore_blanks		#
# basic.c:984: 		if (print_quoted_string())
...
# basic.c:984: 		if (print_quoted_string())
	...
	cmp.w	r1, r0	# tmp64, tmp65
	jz	.L212		#
# basic.c:986: 			ignore_blanks(txtpos);
	...
	j	.L213		#
.L212:
# basic.c:988: 		else if (*txtpos == '"' || *txtpos == '\'')
...
# basic.c:991: 			return;
	j	.L209		#
.L215:
# basic.c:996: 			expression_error = 0;
	xor.w	r0, r0	# tmp71
	st.b	[expression_error], r0	# expression_error, tmp71
# basic.c:997: 			e = expression();
	call	expression		#
	st.w	[r13 + (-4)], r0	# e,
# basic.c:998: 			if (expression_error)
...
# basic.c:1001: 				return;
	j	.L209		#
.L216:
# basic.c:1003: 			printf("%f", roundf(e*10000.0f) / 10000.0f);
...
# basic.c:1007: 		if (*txtpos == ',')
	...
	jnz	.L217		#
# basic.c:1008: 			txtpos++;	// Skip the comma and move onto the next
	ld.w	r0, [txtpos]	# txtpos.157_17, txtpos
	add.w	r0, 1 #111	# _18,
	st.w	[txtpos], r0	# txtpos, _18
	j	.L210		#
.L217:
# basic.c:1009: 		else if (txtpos[0] == ';' && (txtpos[1] == NL || txtpos[1] == ':' || txtpos[1] == ' '))
...
# basic.c:1009: 		else if (txtpos[0] == ';' && (txtpos[1] == NL || txtpos[1] == ':' || txtpos[1] == ' '))
	...
	jnz	.L219		#
.L220:
# basic.c:1011: 			txtpos++; // This has to be the end of the print - no newline
...
# basic.c:1012: 			break;
	j	.L209		#
.L219:
# basic.c:1014: 		else if (*txtpos == NL || *txtpos == ':')
...
exec_list:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 32 #111	#,
# basic.c:1031: 	linenum = testnum(); // Retuns 0 if no line found.
	call	testnum		#
	mov.w	r1, r0	# _1,
# basic.c:1031: 	linenum = testnum(); // Retuns 0 if no line found.
...
# basic.c:1037: 		return;
	j	.L225		#
.L226:
# basic.c:1041: 	list_line = findline();
	call	findline		#
# basic.c:1041: 	list_line = findline();
...
# basic.c:1043: 	while (list_line < program_end)
	j	.L228		#
.L229:
# basic.c:1045: 		printline();
	call	printline		#
# basic.c:1046: 		i++;
	ld.w	r0, [r13 + (-4)]	# tmp38, i
	add.w	r0, 1 #111	# tmp37,
	st.w	[r13 + (-4)], r0	# i, tmp37
# basic.c:1047: 		if (i == 29)
...
exec_run:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 28 #111	#,
# basic.c:1061: 	while (current_line < program_end) // Out of lines to run
	j	.L232		#
.L237:
# basic.c:1063: 		txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	ld.w	r0, [current_line]	# current_line.168_1, current_line
	add.w	r0, 5 #111	# _2,
# basic.c:1063: 		txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	st.w	[txtpos], r0	# txtpos, _2
.L236:
# basic.c:1066: 			res = direct();
	call	direct		#
	st.w	[r13 + (-4)], r0	# res,
# basic.c:1067: 			if (res == 1)
	ld.w	r1, [r13 + (-4)]	# tmp42, res
	mov.w	r0, 1	# tmp43,
	cmp.w	r1, r0	# tmp42, tmp43
	jz	.L238		#
# basic.c:1069: 			ignore_blanks();
	call	ignore_blanks		#
# basic.c:1070: 			if (*txtpos == NL || *txtpos != ':')
...
# basic.c:1066: 			res = direct();
	j	.L236		#
.L235:
# basic.c:1076: 		if (res < 2)
	ld.w	r1, [r13 + (-4)]	# tmp48, res
	mov.w	r0, 1	# tmp49,
	cmp.w	r1, r0	# tmp48, tmp49
	jgs	.L232		#
# basic.c:1077: 			current_line += current_line[sizeof(LINENUM)];
...
exec_if:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 32 #111	#,
# basic.c:1090: 	expression_error = 0;
	xor.w	r0, r0	# tmp37
	st.b	[expression_error], r0	# expression_error, tmp37
# basic.c:1091: 	condition = expression();
	call	expression		#
	st.w	[r13 + (-4)], r0	# condition,
# basic.c:1092: 	if (expression_error || *txtpos == NL)
...
# basic.c:1115: 	return;
	j	.L250		#
.L248:
# basic.c:1100: 			res = direct();
	call	direct		#
	st.w	[r13 + (-8)], r0	# res,
# basic.c:1101: 			if (res == 1)
	ld.w	r1, [r13 + (-8)]	# tmp46, res
	mov.w	r0, 1	# tmp47,
	cmp.w	r1, r0	# tmp46, tmp47
	jz	.L249		#
# basic.c:1103: 			if (res == 2)
	ld.w	r1, [r13 + (-8)]	# tmp48, res
	mov.w	r0, 2	# tmp49,
	cmp.w	r1, r0	# tmp48, tmp49
	jnz	.L246		#
# basic.c:1105: 				txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	ld.w	r0, [current_line]	# current_line.178_4, current_line
	add.w	r0, 5 #111	# _5,
# basic.c:1105: 				txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	st.w	[txtpos], r0	# txtpos, _5
# basic.c:1106: 				continue;
	j	.L247		#
.L246:
# basic.c:1108: 			ignore_blanks();
	call	ignore_blanks		#
# basic.c:1109: 			if (*txtpos == NL || *txtpos != ':')
...
exec_for:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 44 #111	#,
# basic.c:1123: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1124: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:1137: 	txtpos++;
	...
	add.w	r0, 1 #111	# _11,
	st.w	[txtpos], r0	# txtpos, _11
# basic.c:1138: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1140: 	expression_error = 0;
	xor.w	r0, r0	# tmp71
	st.b	[expression_error], r0	# expression_error, tmp71
# basic.c:1141: 	initial = expression();
	call	expression		#
	st.w	[r13 + (-12)], r0	# initial,
# basic.c:1142: 	if (expression_error)
...
# basic.c:1145: 		return;
	j	.L251		#
.L256:
# basic.c:1148: 	scantable(to_tab);
	mov.w	r1, sp	# tmp74,
	mov.w	r0, to_tab	# tmp75,
	st.w	[r1], r0	#, tmp75
	call	scantable		#
# basic.c:1149: 	if (table_index != 0)
...
# basic.c:1152: 		return;
	j	.L251		#
.L257:
# basic.c:1155: 	terminal = expression();
	call	expression		#
	st.w	[r13 + (-16)], r0	# terminal,
# basic.c:1156: 	if (expression_error)
...
# basic.c:1159: 		return;
	j	.L251		#
.L258:
# basic.c:1162: 	scantable(step_tab);
	mov.w	r1, sp	# tmp80,
	mov.w	r0, step_tab	# tmp81,
	st.w	[r1], r0	#, tmp81
	call	scantable		#
# basic.c:1163: 	if (table_index == 0)
...
# basic.c:1163: 	if (table_index == 0)
	...
	jnz	.L259		#
# basic.c:1165: 		step = expression();
	call	expression		#
	st.w	[r13 + (-4)], r0	# step,
# basic.c:1166: 		if (expression_error)
...
.L260:
# basic.c:1175: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1176: 	if (*txtpos != NL && *txtpos != ':')
...
# basic.c:1179: 		return;
	j	.L251		#
.L261:
# basic.c:1182: 	if (!expression_error && ((*txtpos == NL) || (*txtpos == ':')))
...
# basic.c:1182: 	if (!expression_error && ((*txtpos == NL) || (*txtpos == ':')))
	...
	jnz	.L262		#
.L263:
# basic.c:1185: 		if (bsp + sizeof(struct stack_for_frame) < stack_limit)
...
# basic.c:1188: 			return;
	j	.L251		#
.L264:
# basic.c:1191: 		bsp -= sizeof(struct stack_for_frame);
	ld.w	r0, [bsp]	# bsp.200_29, bsp
	add.w	r0, -20 #111	# _30,
	st.w	[bsp], r0	# bsp, _30
# basic.c:1192: 		f = (struct stack_for_frame *)bsp;
	ld.w	r0, [bsp]	# tmp97, bsp
	st.w	[r13 + (-20)], r0	# f, tmp97
# basic.c:1193: 		((VAR *)variables_begin)[var - 'A'] = initial;
...
exec_return:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 44 #111	#,
# basic.c:1218: 	tempsp = bsp;
	ld.w	r0, [bsp]	# bsp.205_1, bsp
	st.w	[tempsp], r0	# tempsp, bsp.205_1
# basic.c:1219: 	while (tempsp < program + kRamSize - 1)
	j	.L266		#
.L280:
# basic.c:1225: 		switch (tempsp[0])
...
# basic.c:1225: 		switch (tempsp[0])
	...
	jnz	.L268		#
# basic.c:1228: 			if (table_index == KW_RETURN)
...
# basic.c:1228: 			if (table_index == KW_RETURN)
	...
	cmp.w	r1, r0	# tmp72, tmp73
	jnz	.L269		#
# basic.c:1230: 				struct stack_gosub_frame *f = (struct stack_gosub_frame *)tempsp;
	ld.w	r0, [tempsp]	# tmp74, tempsp
	st.w	[r13 + (-12)], r0	# f, tmp74
# basic.c:1231: 				current_line = f->current_line;
	ld.w	r0, [r13 + (-12)]	# tmp75, f
	ld.w	r0, [r0 + (4)]	# _6, f_53->current_line
# basic.c:1231: 				current_line = f->current_line;
	st.w	[current_line], r0	# current_line, _6
# basic.c:1232: 				txtpos = f->txtpos;
	ld.w	r0, [r13 + (-12)]	# tmp76, f
	ld.w	r0, [r0 + (8)]	# _7, f_53->txtpos
# basic.c:1232: 				txtpos = f->txtpos;
	st.w	[txtpos], r0	# txtpos, _7
# basic.c:1233: 				bsp += sizeof(struct stack_gosub_frame);
	ld.w	r0, [bsp]	# bsp.208_8, bsp
	add.w	r0, 12 #111	# _9,
	st.w	[bsp], r0	# bsp, _9
# basic.c:1234: 				return 0;
	xor.w	r0, r0	# _45
	j	.L270		#
.L269:
# basic.c:1237: 			tempsp += sizeof(struct stack_gosub_frame);
...
# basic.c:1238: 			break;
	j	.L266		#
.L267:
# basic.c:1241: 			if (table_index == KW_NEXT)
...
# basic.c:1241: 			if (table_index == KW_NEXT)
	...
	jnz	.L271		#
# basic.c:1243: 				struct stack_for_frame *f = (struct stack_for_frame *)tempsp;
	ld.w	r0, [tempsp]	# tmp79, tempsp
	st.w	[r13 + (-16)], r0	# f, tmp79
# basic.c:1245: 				var = txtpos[-1];
...
# basic.c:1247: 				while (var == ' ') 
	j	.L272		#
.L273:
# basic.c:1249: 					var = txtpos[i];
...
# basic.c:1252: 				if (var == f->for_var)
	...
	jnz	.L271		#
# basic.c:1254: 					VAR *varaddr = ((VAR *)variables_begin) + var - 'A';
...
# basic.c:1255: 					*varaddr = *varaddr + f->step;
...
# basic.c:1257: 					if ((f->step > 0 && *varaddr <= f->terminal) || (f->step < 0 && *varaddr >= f->terminal))
...
# basic.c:1257: 					if ((f->step > 0 && *varaddr <= f->terminal) || (f->step < 0 && *varaddr >= f->terminal))
	...
	jss	.L277		#
.L276:
# basic.c:1260: 						txtpos = f->txtpos;
	ld.w	r0, [r13 + (-16)]	# tmp120, f
	ld.w	r0, [r0 + (16)]	# _34, f_58->txtpos
# basic.c:1260: 						txtpos = f->txtpos;
	st.w	[txtpos], r0	# txtpos, _34
# basic.c:1261: 						current_line = f->current_line;
	ld.w	r0, [r13 + (-16)]	# tmp121, f
	ld.w	r0, [r0 + (12)]	# _35, f_58->current_line
# basic.c:1261: 						current_line = f->current_line;
	st.w	[current_line], r0	# current_line, _35
# basic.c:1262: 						return 0;
	xor.w	r0, r0	# _45
	j	.L270		#
.L277:
# basic.c:1265: 					bsp = tempsp + sizeof(struct stack_for_frame);
	ld.w	r0, [tempsp]	# tempsp.215_36, tempsp
	add.w	r0, 20 #111	# _37,
# basic.c:1265: 					bsp = tempsp + sizeof(struct stack_for_frame);
	st.w	[bsp], r0	# bsp, _37
# basic.c:1266: 					return 0;
	xor.w	r0, r0	# _45
	j	.L270		#
.L271:
# basic.c:1270: 			tempsp += sizeof(struct stack_for_frame);
...
# basic.c:1271: 			break;
	j	.L266		#
.L268:
# basic.c:1273: 			printf("Stack is stuffed!\n");
	mov.w	r1, sp	# tmp122,
	mov.w	r0, .LC8	# tmp123,
	st.w	[r1], r0	#, tmp123
	call	puts		#
# basic.c:1274: 			return 1;
	mov.w	r0, 1	# _45,
	j	.L270		#
.L266:
# basic.c:1219: 	while (tempsp < program + kRamSize - 1)
...
exec_next:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:1285: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1289: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:1298: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1299: 	if (*txtpos != ':' && *txtpos != NL)
...
exec_gosub:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 28 #111	#,
# basic.c:1308: 	expression_error = 0;
	xor.w	r0, r0	# tmp39
	st.b	[expression_error], r0	# expression_error, tmp39
# basic.c:1309: 	linenum = expression();
	call	expression		#
	mov.w	r1, r0	# _1,
# basic.c:1309: 	linenum = expression();
	...
	call	__fixsfsi		#
	st.w	[linenum], r0	# linenum, _2
# basic.c:1310: 	if (!expression_error && *txtpos == NL)
...
# basic.c:1310: 	if (!expression_error && *txtpos == NL)
	...
	cmp.w	r1, r0	# tmp43, tmp44
	jnz	.L289		#
# basic.c:1313: 		if (bsp + sizeof(struct stack_gosub_frame) < stack_limit)
...
# basic.c:1324: 		current_line = findline();
	call	findline		#
# basic.c:1324: 		current_line = findline();
	st.w	[current_line], r0	# current_line, _13
# basic.c:1325: 		exec_run();
	call	exec_run		#
# basic.c:1326: 		return;
	j	.L288		#
.L289:
...
# basic.c:1337: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1339: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:1346: 	txtpos++;
	...
	add.w	r0, 1 #111	# _7,
	st.w	[txtpos], r0	# txtpos, _7
# basic.c:1347: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1349: 	if (*txtpos != NL && *txtpos != ':')
...
# basic.c:1358: 		getln('?');
	...
	st.w	[r1], r0	#, tmp57
	call	getln		#
# basic.c:1359: 		toUppercaseBuffer();
	call	toUppercaseBuffer		#
# basic.c:1360: 		txtpos = program_end + sizeof(VAR);
	ld.w	r0, [program_end]	# program_end.238_13, program_end
	add.w	r0, 4 #111	# _14,
# basic.c:1360: 		txtpos = program_end + sizeof(VAR);
	st.w	[txtpos], r0	# txtpos, _14
# basic.c:1361: 		ignore_blanks();
	call	ignore_blanks		#
# basic.c:1362: 		expression_error = 0;
	xor.w	r0, r0	# tmp58
	st.b	[expression_error], r0	# expression_error, tmp58
# basic.c:1363: 		value = expression();
	call	expression		#
	st.w	[r13 + (-8)], r0	# value,
# basic.c:1364: 		if (!expression_error)
...
# basic.c:1365: 			break;
	nop	
# basic.c:1367: 	((VAR *)variables_begin)[var - 'A'] = value;
...
exec_edit:
	...
	push	r6		#
	sub.w	sp, 36 #111	#,
# basic.c:1377: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1378: 	expression_error = 0;
	xor.w	r0, r0	# tmp62
	st.b	[expression_error], r0	# expression_error, tmp62
# basic.c:1379: 	linenum = expression();
	call	expression		#
	mov.w	r1, r0	# _1,
# basic.c:1379: 	linenum = expression();
	...
	call	__fixsfsi		#
	st.w	[linenum], r0	# linenum, _2
# basic.c:1380: 	if (expression_error)
...
# basic.c:1382: 		qhow();
	call	qhow		#
# basic.c:1383: 		return 0;
	xor.w	r0, r0	# _33
	j	.L304		#
.L303:
# basic.c:1385: 	line = findline();
	call	findline		#
	st.w	[r13 + (-16)], r0	# line,
# basic.c:1386: 	if (line == program_end)
...
# basic.c:1388: 		qhow();
	call	qhow		#
# basic.c:1389: 		return 0;
	xor.w	r0, r0	# _33
	j	.L304		#
.L305:
# basic.c:1392: 	txtpos = program_end + sizeof(LINENUM);
	ld.w	r0, [program_end]	# program_end.244_5, program_end
	add.w	r0, 4 #111	# _6,
# basic.c:1392: 	txtpos = program_end + sizeof(LINENUM);
	st.w	[txtpos], r0	# txtpos, _6
# basic.c:1393: 	txtpos[0] = 0;
	ld.w	r0, [txtpos]	# txtpos.245_7, txtpos
# basic.c:1393: 	txtpos[0] = 0;
	xor.w	r1, r1	# tmp67
	st.b	[r0], r1	# *txtpos.245_7, tmp67
# basic.c:1394: 	sprintf(txtpos, "%d ", linenum);
	...
	call	sprintf		#
# basic.c:1395: 	j = strlen(txtpos);
	ld.w	r0, [txtpos]	# txtpos.248_10, txtpos
	mov.w	r1, sp	# tmp70,
	st.w	[r1], r0	#, txtpos.248_10
	call	strlen		#
	st.w	[r13 + (-12)], r0	# j,
# basic.c:1396: 	for (i = sizeof(VAR) + 1; i < line[sizeof(VAR)] - 1; i++)
	mov.w	r0, 5	# tmp71,
	st.w	[r13 + (-8)], r0	# i, tmp71
# basic.c:1396: 	for (i = sizeof(VAR) + 1; i < line[sizeof(VAR)] - 1; i++)
	j	.L306		#
.L307:
# basic.c:1399: 		txtpos[j++] = line[i];
...
# basic.c:1419: 	memcpy(to_print_buff, eth_buffer+off, len);
...
eth_read_file:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 40 #111	#,
# basic.c:1426: 	int len = 0;
	xor.w	r0, r0	# tmp44
	st.w	[r13 + (-4)], r0	# len, tmp44
# basic.c:1427: 	int init_offset = 0;
	xor.w	r0, r0	# tmp45
	st.w	[r13 + (-8)], r0	# init_offset, tmp45
# basic.c:1428: 	int size = 1000000;
	mov.w	r0, 1000000	# tmp46,
	st.w	[r13 + (-12)], r0	# size, tmp46
# basic.c:1429: 	int fail_count = 0;
	xor.w	r0, r0	# tmp47
	st.w	[r13 + (-16)], r0	# fail_count, tmp47
# basic.c:1430: 	printf("Loading file %s from the ethernet network drive\n", file_name);
	mov.w	r0, sp	# tmp48,
	...
	st.w	[r0], r1	#, tmp50
	call	printf		#
# basic.c:1431: 	to_print_len = 0;
	xor.w	r0, r0	# tmp51
	st.w	[to_print_len], r0	# to_print_len, tmp51
# basic.c:1432: 	asm ("irq 0\n"); // IRQ 0000, xxx0 <- turn off timer irq
# 1432 "basic.c" 1
	irq 0

# basic.c:1433: 	browseUrl("/load:", file_name, server_ip, 0, my_callback);
	mov.w	r0, sp	# tmp52,
...
# basic.c:1442: 				size |= to_print_buff[2];
...
# basic.c:1444: 				size |= to_print_buff[1];
...
# basic.c:1446: 				size |= to_print_buff[0];
...
# basic.c:1447: 				init_offset = 4;
	mov.w	r0, 4	# tmp79,
	st.w	[r13 + (-8)], r0	# init_offset, tmp79
# basic.c:1448: 				if (size == 0) {
	ld.w	r1, [r13 + (-12)]	# tmp80, size
	xor.w	r0, r0	# tmp81
	cmp.w	r1, r0	# tmp80, tmp81
	jnz	.L314		#
# basic.c:1449: 					printf("File %s does not exist\n", file_name);
	mov.w	r0, sp	# tmp82,
...
# basic.c:1456: 			printf("#");
	...
	st.w	[r1], r0	#, tmp90
	call	putchar		#
# basic.c:1457: 			fail_count = 0;
	xor.w	r0, r0	# tmp91
	st.w	[r13 + (-16)], r0	# fail_count, tmp91
# basic.c:1458: 			to_print_buff[to_print_len] = 0;
...
# basic.c:1459: 			memcpy(buffer + len, to_print_buff + init_offset, to_print_len);
...
# basic.c:1459: 			memcpy(buffer + len, to_print_buff + init_offset, to_print_len);
	...
	st.w	[r0], r1	#, _11
	call	memcpy		#
# basic.c:1460: 			len += to_print_len - init_offset;
...
# basic.c:1435: 	while (len < size) {
	...
	jss	.L317		#
.L315:
# basic.c:1475: 	asm ("irq 1\n"); // IRQ 0000, xxx1 <- turn on timer irq
# 1475 "basic.c" 1
	irq 1

# basic.c:1476: 	return len;
...
# basic.c:1493: 	if (eth)
	...
	jz	.L320		#
# basic.c:1494: 		mainLoop(eth_buffer);
	mov.w	r1, sp	# tmp28,
	mov.w	r0, eth_buffer	# tmp29,
	st.w	[r1], r0	#, tmp29
	call	mainLoop		#
.L320:
# basic.c:1497: 	asm("pop r13\npop r13\n");
# 1497 "basic.c" 1
	pop r13
pop r13
...
exec_load:
	...
	push	r6		#
	sub.w	sp, 168 #111	#,
# basic.c:1524: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1525: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:1528: 		return;
	j	.L323		#
.L325:
# basic.c:1532: 	for (i = 0; txtpos[i] != NL && txtpos[i] != CR && txtpos[i] != SPACE && txtpos[i] != TAB && i < 32; i++)
	xor.w	r0, r0	# tmp120
	st.w	[r13 + (-8)], r0	# i, tmp120
# basic.c:1532: 	for (i = 0; txtpos[i] != NL && txtpos[i] != CR && txtpos[i] != SPACE && txtpos[i] != TAB && i < 32; i++)
	j	.L327		#
.L329:
# basic.c:1535: 		s[i] = txtpos[i];
...
# basic.c:1537: 	s[i] = 0;
	...
	xor.w	r1, r1	# tmp139
	st.b	[r0], r1	# s, tmp139
# basic.c:1539: 	printf("Loading file: <%s>\n", s);
	mov.w	r0, sp	# tmp140,
	mov.w	r1, r13	# tmp141,
...
# basic.c:1540: 	if (drive == 2) {
	...
	jnz	.L330		#
# basic.c:1542: 		asm ("irq 0\n"); // IRQ 0000, xxx0 <- turn off timer irq
# 1542 "basic.c" 1
	irq 0

# basic.c:1543: 		delay(100);
	mov.w	r1, sp	# tmp145,
	mov.w	r0, 100	# tmp146,
	st.w	[r1], r0	#, tmp146
	call	delay		#
# basic.c:1544: 		i = uart_read_file(buffer, s);
	...
	call	uart_read_file		#
	st.w	[r13 + (-8)], r0	# i,
# basic.c:1545: 		asm ("irq 1\n");  // IRQ 0000, xxx1 <- turn on timer irq
# 1545 "basic.c" 1
	irq 1

	j	.L331		#
.L330:
# basic.c:1546: 	} else if (drive == 0)
...
# basic.c:1546: 	} else if (drive == 0)
	...
	jnz	.L332		#
# basic.c:1550: load_load_again:		
	nop	
.L333:
# basic.c:1551: 		if(file_open(s, &fd, O_READ))
	mov.w	r0, sp	# tmp151,
	xor.w	r1, r1	# tmp152
	st.w	[r0 + (8)], r1	#, tmp152
	mov.w	r1, r13	# tmp153,
...
# basic.c:1551: 		if(file_open(s, &fd, O_READ))
	...
	cmp.w	r1, r0	# tmp155, tmp156
	jz	.L334		#
# basic.c:1553: 			int len = fd.dir_entry.filesize;
	ld.w	r0, [r13 + (-116)]	# _30, fd.dir_entry.filesize
# basic.c:1553: 			int len = fd.dir_entry.filesize;
	st.w	[r13 + (-32)], r0	# len, _30
# basic.c:1554: 			int total = 0;
	xor.w	r0, r0	# tmp157
	st.w	[r13 + (-20)], r0	# total, tmp157
# basic.c:1556: 			while(total < len)
	j	.L335		#
.L338:
# basic.c:1558: 				current = file_read(&fd, &buffer[total], 512);
...
# basic.c:1562: 						printf("#");
	...
	j	.L335		#
.L336:
# basic.c:1564: 					printf("Error reading file!\n");
	mov.w	r1, sp	# tmp172,
...
# basic.c:1574: 			strcpy(fileName, s);
	mov.w	r0, sp	# tmp178,
	mov.w	r1, r13	# tmp179,
	...
	st.w	[r0], r1	#, tmp180
	call	strcpy		#
# basic.c:1575: 			int sum = 0;
	xor.w	r0, r0	# tmp181
	st.w	[r13 + (-24)], r0	# sum, tmp181
# basic.c:1576: 			for (int j = 0; j < i; j++) {
	xor.w	r0, r0	# tmp182
	st.w	[r13 + (-28)], r0	# j, tmp182
# basic.c:1576: 			for (int j = 0; j < i; j++) {
	j	.L339		#
.L340:
# basic.c:1577: 				sum += buffer[j];
...
# basic.c:1579: 			printf("\nSum: %d\n", sum);
	...
	j	.L331		#
.L334:
# basic.c:1582: 			printf("SD card file open failed\n");
	mov.w	r1, sp	# tmp192,
...
# basic.c:1583: 			return;
	j	.L323		#
.L332:
# basic.c:1588: 		i = eth_read_file(buffer, s);
...
# basic.c:1591: 	if (i > 0)
	...
	jses	.L341		#
# basic.c:1593: 		printf("File size: %d\n", i);
	mov.w	r0, sp	# tmp198,
	...
	st.w	[r0], r1	#, tmp200
	call	printf		#
# basic.c:1594: 		if (strstr(s, ".BIN") != (char *)0) 
	mov.w	r0, sp	# tmp201,
...
# basic.c:1594: 		if (strstr(s, ".BIN") != (char *)0) 
	...
	jz	.L342		#
# basic.c:1596: 			printf("Loaded executable file. Run it using: SYS 0\n");
	mov.w	r1, sp	# tmp205,
...
# basic.c:1597: 			return;
	j	.L323		#
.L342:
# basic.c:1598: 		} else if (strstr(s, ".BAS") == (char *)0) 
	mov.w	r0, sp	# tmp207,
...
# basic.c:1598: 		} else if (strstr(s, ".BAS") == (char *)0) 
	...
	jnz	.L343		#
# basic.c:1600: 			printf("Loaded successfuly at address 0 (reachable by PEEK and POKE).\n");
	mov.w	r1, sp	# tmp211,
...
# basic.c:1601: 			return;
	j	.L323		#
.L343:
# basic.c:1603: 		program_end = program_start;
...
# basic.c:1605: 		for (j = 0; j <= i; j++)
	xor.w	r0, r0	# tmp214
	st.w	[r13 + (-12)], r0	# j, tmp214
# basic.c:1605: 		for (j = 0; j <= i; j++)
	j	.L344		#
.L349:
# basic.c:1607: 			if (buffer[j] == CR)
...
.L345:
# basic.c:1611: 			if (buffer[j] == NL || buffer[j] == 0)
...
# basic.c:1611: 			if (buffer[j] == NL || buffer[j] == 0)
	...
	jnz	.L347		#
.L346:
# basic.c:1613: 				txtpos = program_end + sizeof(LINENUM);
	ld.w	r0, [program_end]	# program_end.306_67, program_end
	add.w	r0, 4 #111	# _68,
# basic.c:1613: 				txtpos = program_end + sizeof(LINENUM);
	st.w	[txtpos], r0	# txtpos, _68
# basic.c:1614: 				strncpy(txtpos, &buffer[k], j);
...
.L348:
# basic.c:1621: 				toUppercaseBuffer();
	call	toUppercaseBuffer		#
# basic.c:1622: 				skip_to_end();
	call	skip_to_end		#
# basic.c:1623: 				linenum = testnum();
	call	testnum		#
	mov.w	r1, r0	# _86,
# basic.c:1623: 				linenum = testnum();
...
# basic.c:1624: 				if (linenum > 0)
	ld.w	r1, [linenum]	# linenum.315_88, linenum
# basic.c:1624: 				if (linenum > 0)
	xor.w	r0, r0	# tmp240
	cmp.w	r1, r0	# linenum.315_88, tmp240
	jses	.L347		#
# basic.c:1628: 					ignore_blanks();
	call	ignore_blanks		#
# basic.c:1629: 					entered_with_line_num();
...
# basic.c:1605: 		for (j = 0; j <= i; j++)
	...
	jses	.L349		#
# basic.c:1633: 		printf("OK loading file %s\n", s);
	mov.w	r0, sp	# tmp245,
	mov.w	r1, r13	# tmp246,
	...
	j	.L323		#
.L341:
# basic.c:1637: 		printf("Error loading file %s\n", s);
	mov.w	r0, sp	# tmp248,
	mov.w	r1, r13	# tmp249,
...
# basic.c:1650: 	sprintf(s, "%d ", line_num);
	...
	st.w	[r0], r1	#, tmp54
	call	sprintf		#
# basic.c:1651: 	strcpy(&buffer[i], s);
...
# basic.c:1653: 	while (*list_line != NL)
	j	.L353		#
.L354:
# basic.c:1655: 		buffer[i] = *list_line;
...
# basic.c:1669: 	printf("\nSaving to SD card...\n");
	...
	st.w	[r1], r0	#, tmp37
	call	puts		#
# basic.c:1670: 	int res = file_open(file_name, &fd, O_WRITE);
	mov.w	r0, sp	# tmp38,
	mov.w	r1, 1	# tmp39,
	st.w	[r0 + (8)], r1	#, tmp39
	mov.w	r1, r13	# tmp40,
...
# basic.c:1671: 	if (res)
	...
	cmp.w	r1, r0	# tmp43, tmp44
	jz	.L357		#
# basic.c:1673: 		int i, curr, total = 0, count = len /512 + 1;
	xor.w	r0, r0	# tmp45
...
# basic.c:1674: 		for (i = 0; i < count; i++)
	xor.w	r0, r0	# tmp53
	st.w	[r13 + (-4)], r0	# i, tmp53
# basic.c:1674: 		for (i = 0; i < count; i++)
	j	.L359		#
.L364:
# basic.c:1676: 			curr = file_write(&fd, &buff[total], len > 512 ? 512 : len);
...
# basic.c:1686: 		printf("\n");
	...
	j	.L365		#
.L357:
# basic.c:1690: 		printf("Could not open file for save.\n");
	mov.w	r1, sp	# tmp75,
	mov.w	r0, .LC26	# tmp76,
	st.w	[r1], r0	#, tmp76
	call	puts		#
.L365:
# basic.c:1692: 	return 1;	
	mov.w	r0, 1	# _33,
# basic.c:1693: }
	mov.w	sp, r13	#,
	pop	r13		#
...
eth_write_file:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:1697: 	printf("Saving file %s of %d bytes to the ethernet network drive\n", file_name, len);
	mov.w	r0, sp	# tmp27,
...
exec_save:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 64 #111	#,
# basic.c:1705: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1706: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:1708: 		qwhat();
	...
	j	.L369		#
.L371:
# basic.c:1712: 	int spi = 0;
	xor.w	r0, r0	# tmp59
	st.w	[r13 + (-8)], r0	# spi, tmp59
# basic.c:1713: 	for (i = 0; txtpos[i] != NL && txtpos[i] != SPACE && txtpos[i] != TAB; i++)
	xor.w	r0, r0	# tmp60
	st.w	[r13 + (-4)], r0	# i, tmp60
# basic.c:1713: 	for (i = 0; txtpos[i] != NL && txtpos[i] != SPACE && txtpos[i] != TAB; i++)
	j	.L373		#
.L375:
# basic.c:1715: 		s[i] = txtpos[i];
...
# basic.c:1717: 	s[i] = 0;
	...
	xor.w	r1, r1	# tmp75
	st.b	[r0], r1	# s, tmp75
# basic.c:1718: 	printf("Filename: <%s>\n", s);
	mov.w	r0, sp	# tmp76,
	mov.w	r1, r13	# tmp77,
	...
	st.w	[r0], r1	#, tmp78
	call	printf		#
# basic.c:1721: 	list_line = findline();
	call	findline		#
# basic.c:1721: 	list_line = findline();
...
# basic.c:1723: 	while (list_line < program_end)
	j	.L376		#
.L377:
# basic.c:1725: 		i = sprintline(i);
	mov.w	r1, sp	# tmp80,
...
# basic.c:1727: 	if (drive == 0) {
	...
	cmp.w	r1, r0	# tmp82, tmp83
	jnz	.L378		#
# basic.c:1729: 		sd_write_file(buffer, i, s);
...
# basic.c:1730: 	} else if (drive == 2) {
	...
	cmp.w	r1, r0	# tmp87, tmp88
	jnz	.L380		#
# basic.c:1732: 		asm ("irq 0\n"); // IRQ 0000, xxx0 <- turn OFF timer irq
# 1732 "basic.c" 1
	irq 0

# basic.c:1733: 		uart_write_file(buffer, i, s);
...
# basic.c:1734: 		asm ("irq 1\n"); // IRQ 0000, xxx1 <- turn ON timer irq
# 1734 "basic.c" 1
	irq 1

	j	.L379		#
.L380:
# basic.c:1738: 		eth_write_file(buffer, i, s);
	...
	call	eth_write_file		#
.L379:
# basic.c:1740: 	printf("OK saving file %s, length: %d\n", s, i);
	mov.w	r0, sp	# tmp95,
...
# basic.c:1747: 	if (drive == 2)
	...
	cmp.w	r1, r0	# tmp39, tmp40
	jnz	.L382		#
# basic.c:1750: 		asm ("irq 0\n"); // IRQ 0000, xxx0 <- turn OFF timer irq
# 1750 "basic.c" 1
	irq 0

# basic.c:1751: 		uart_ls_files(buffer);
	ld.w	r0, [buffer]	# buffer.347_2, buffer
	mov.w	r1, sp	# tmp41,
	st.w	[r1], r0	#, buffer.347_2
	call	uart_ls_files		#
# basic.c:1752: 		asm ("irq 1\n"); // IRQ 0000, xxx1 <- turn ON timer irq
# 1752 "basic.c" 1
	irq 1

# basic.c:1753: 		printf("%s\n", buffer);
...
# basic.c:1760: 		while ((next = getDirEntry(&fd, next)) != 0)
	...
	j	.L381		#
.L384:
# basic.c:1767: 		to_print_len = 0;
	xor.w	r0, r0	# tmp53
	st.w	[to_print_len], r0	# to_print_len, tmp53
# basic.c:1768: 		browseUrl("/dir", "", server_ip, 0, my_callback);
	mov.w	r0, sp	# tmp54,
	...
	st.w	[r0], r1	#, tmp59
	call	browseUrl		#
# basic.c:1769: 		delay(100);
	mov.w	r1, sp	# tmp60,
	mov.w	r0, 100	# tmp61,
	st.w	[r1], r0	#, tmp61
	call	delay		#
# basic.c:1770: 		for (i = 0; i < 1000; i++) {
	xor.w	r0, r0	# tmp62
	st.w	[r13 + (-4)], r0	# i, tmp62
# basic.c:1770: 		for (i = 0; i < 1000; i++) {
	j	.L387		#
.L389:
# basic.c:1773: 			if (to_print_len > 0) {
	ld.w	r1, [to_print_len]	# to_print_len.351_12, to_print_len
# basic.c:1773: 			if (to_print_len > 0) {
	xor.w	r0, r0	# tmp63
	cmp.w	r1, r0	# to_print_len.351_12, tmp63
	jses	.L388		#
# basic.c:1774: 				to_print_buff[to_print_len] = 0;
...
# basic.c:1775: 				printf("%s\n", to_print_buff);
	mov.w	r1, sp	# tmp67,
	mov.w	r0, to_print_buff	# tmp68,
	st.w	[r1], r0	#, tmp68
	call	puts		#
# basic.c:1776: 				to_print_len = 0;
	xor.w	r0, r0	# tmp69
	st.w	[to_print_len], r0	# to_print_len, tmp69
# basic.c:1777: 				return;
	j	.L381		#
.L388:
# basic.c:1779: 			  delay(10);
	mov.w	r1, sp	# tmp70,
	mov.w	r0, 10	# tmp71,
	st.w	[r1], r0	#, tmp71
	call	delay		#
...
# basic.c:1770: 		for (i = 0; i < 1000; i++) {
	...
	jses	.L389		#
# basic.c:1781: 		printf("NETWORK TIMEOUT\n");
	mov.w	r1, sp	# tmp76,
	mov.w	r0, .LC33	# tmp77,
	st.w	[r1], r0	#, tmp77
	call	puts		#
...
exec_mode:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 28 #111	#,
# basic.c:1789: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1790: 	expression_error = 0;
	xor.w	r0, r0	# tmp29
	st.b	[expression_error], r0	# expression_error, tmp29
# basic.c:1791: 	value = expression();	
	call	expression		#
	st.w	[r13 + (-4)], r0	# value,
# basic.c:1792: 	if (expression_error)
...
# basic.c:1811: 			break;
	j	.L390		#
.L394:
# basic.c:1813: 			video_mode(0);
	mov.w	r1, sp	# tmp43,
	xor.w	r0, r0	# tmp44
	st.w	[r1], r0	#, tmp44
	call	video_mode		#
# basic.c:1815: 			printf("Invalid video mode: %d\n", value);
...
# basic.c:1823: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1824: 	expression_error = 0;
	xor.w	r0, r0	# tmp40
	st.b	[expression_error], r0	# expression_error, tmp40
# basic.c:1825: 	x = expression();	
	call	expression		#
	st.w	[r13 + (-12)], r0	# x,
# basic.c:1826: 	if (expression_error)
...
# basic.c:1829: 		return;
	j	.L397		#
.L398:
# basic.c:1831: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1832: 	if (*txtpos != ',')
...
# basic.c:1841: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1842: 	expression_error = 0;
	xor.w	r0, r0	# tmp45
	st.b	[expression_error], r0	# expression_error, tmp45
# basic.c:1843: 	y = expression();	
	call	expression		#
	st.w	[r13 + (-16)], r0	# y,
# basic.c:1844: 	if (expression_error)
...
# basic.c:1847: 		return;
	j	.L397		#
.L401:
# basic.c:1849: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1850: 	if (*txtpos != ',')
...
# basic.c:1859: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1860: 	expression_error = 0;
	xor.w	r0, r0	# tmp50
	st.b	[expression_error], r0	# expression_error, tmp50
# basic.c:1861: 	c = expression();	
	call	expression		#
	st.w	[r13 + (-20)], r0	# c,
# basic.c:1862: 	if (expression_error)
...
# basic.c:1865: 		return;
	j	.L397		#
.L403:
# basic.c:1868: 	pixel((int)x, (int)y, (int)c);
...
# basic.c:1875: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1876: 	expression_error = 0;
	xor.w	r0, r0	# tmp52
	st.b	[expression_error], r0	# expression_error, tmp52
# basic.c:1877: 	x1 = expression();	
	call	expression		#
	st.w	[r13 + (-20)], r0	# x1,
# basic.c:1878: 	if (expression_error)
...
# basic.c:1881: 		return;
	j	.L404		#
.L405:
# basic.c:1883: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1884: 	if (*txtpos != ',')
...
# basic.c:1893: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1894: 	expression_error = 0;
	xor.w	r0, r0	# tmp57
	st.b	[expression_error], r0	# expression_error, tmp57
# basic.c:1895: 	y1 = expression();	
	call	expression		#
	st.w	[r13 + (-24)], r0	# y1,
# basic.c:1896: 	if (expression_error)
...
# basic.c:1899: 		return;
	j	.L404		#
.L408:
# basic.c:1902: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1903: 	if (*txtpos != ',')
...
# basic.c:1949: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1950: 	expression_error = 0;
	xor.w	r0, r0	# tmp72
	st.b	[expression_error], r0	# expression_error, tmp72
# basic.c:1951: 	c = expression();	
	call	expression		#
	st.w	[r13 + (-36)], r0	# c,
# basic.c:1952: 	if (expression_error)
...
# basic.c:1955: 		return;
	j	.L404		#
.L414:
# basic.c:1958: 	line((int)x1, (int)y1, (int)x2, (int)y2, (int)c);
...
# basic.c:2026: 		return;
	j	.L415		#
.L423:
# basic.c:2029: 	circle((int)x, (int)y, (int)r, (int)c);
...
# basic.c:2038: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2039: 	expression_error = 0;
	xor.w	r0, r0	# tmp63
	st.b	[expression_error], r0	# expression_error, tmp63
# basic.c:2040: 	x = expression();	
	call	expression		#
	st.w	[r13 + (-16)], r0	# x,
# basic.c:2041: 	if (expression_error)
...
# basic.c:2044: 		return;
	j	.L424		#
.L425:
# basic.c:2046: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2047: 	if (*txtpos != ',')
...
# basic.c:2054: 		txtpos++;
	...
	add.w	r0, 1 #111	# _5,
	st.w	[txtpos], r0	# txtpos, _5
# basic.c:2056: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2057: 	expression_error = 0;
	xor.w	r0, r0	# tmp68
	st.b	[expression_error], r0	# expression_error, tmp68
# basic.c:2058: 	y = expression();	
	call	expression		#
	st.w	[r13 + (-20)], r0	# y,
# basic.c:2059: 	if (expression_error)
...
# basic.c:2062: 		return;
	j	.L424		#
.L428:
# basic.c:2064: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2065: 	if (*txtpos != ',')
...
# basic.c:2072: 		txtpos++;
	...
	add.w	r0, 1 #111	# _10,
	st.w	[txtpos], r0	# txtpos, _10
# basic.c:2074: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2075: 	expression_error = 0;
	xor.w	r0, r0	# tmp73
	st.b	[expression_error], r0	# expression_error, tmp73
# basic.c:2076: 	c = expression();	
	call	expression		#
	st.w	[r13 + (-24)], r0	# c,
# basic.c:2077: 	if (expression_error)
...
# basic.c:2080: 		return;
	j	.L424		#
.L430:
# basic.c:2082: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2083: 	if (*txtpos != ',')
...
# basic.c:2090: 		txtpos++;
	...
	add.w	r0, 1 #111	# _15,
	st.w	[txtpos], r0	# txtpos, _15
# basic.c:2092: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2093: 	if (*txtpos != '"' && *txtpos != '\'')
...
# basic.c:2100: 	while (*txtpos != NL && *txtpos != 0)
	j	.L433		#
.L437:
# basic.c:2102: 		if (*txtpos == '"' || *txtpos == '\'')
...
# basic.c:2100: 	while (*txtpos != NL && *txtpos != 0)
	...
	jnz	.L437		#
.L436:
# basic.c:2111: 	draw((int)x, (int)y, (int)c, s);
...
exec_help:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:2116: 	printf("END\n");
	mov.w	r1, sp	# tmp26,
	mov.w	r0, .LC35	# tmp27,
	st.w	[r1], r0	#, tmp27
	call	puts		#
# basic.c:2117: 	printf("MEM\n");
	mov.w	r1, sp	# tmp28,
	mov.w	r0, .LC36	# tmp29,
	st.w	[r1], r0	#, tmp29
	call	puts		#
# basic.c:2118: 	printf("LET I = 5\n");
	mov.w	r1, sp	# tmp30,
	mov.w	r0, .LC37	# tmp31,
	st.w	[r1], r0	#, tmp31
	call	puts		#
# basic.c:2119: 	printf("I = 5\n");
	mov.w	r1, sp	# tmp32,
	mov.w	r0, .LC38	# tmp33,
	st.w	[r1], r0	#, tmp33
	call	puts		#
# basic.c:2120: 	printf("INPUT A\n");
	mov.w	r1, sp	# tmp34,
	mov.w	r0, .LC39	# tmp35,
	st.w	[r1], r0	#, tmp35
	call	puts		#
# basic.c:2121: 	printf("PRINT A\n");
	mov.w	r1, sp	# tmp36,
	mov.w	r0, .LC40	# tmp37,
	st.w	[r1], r0	#, tmp37
	call	puts		#
# basic.c:2122: 	printf("? A\n");
	mov.w	r1, sp	# tmp38,
	mov.w	r0, .LC41	# tmp39,
	st.w	[r1], r0	#, tmp39
	call	puts		#
# basic.c:2123: 	printf("FOR I = 1 TO 10 STEP 2\n");
	mov.w	r1, sp	# tmp40,
	mov.w	r0, .LC42	# tmp41,
	st.w	[r1], r0	#, tmp41
	call	puts		#
# basic.c:2124: 	printf("NEXT I\n");
	mov.w	r1, sp	# tmp42,
	mov.w	r0, .LC43	# tmp43,
	st.w	[r1], r0	#, tmp43
	call	puts		#
# basic.c:2125: 	printf("IF I = 5 GOTO 100\n");
	mov.w	r1, sp	# tmp44,
	mov.w	r0, .LC44	# tmp45,
	st.w	[r1], r0	#, tmp45
	call	puts		#
# basic.c:2126: 	printf("GOTO 100\n");
	mov.w	r1, sp	# tmp46,
	mov.w	r0, .LC45	# tmp47,
	st.w	[r1], r0	#, tmp47
	call	puts		#
# basic.c:2127: 	printf("GOSUB 100\n");
	mov.w	r1, sp	# tmp48,
	mov.w	r0, .LC46	# tmp49,
	st.w	[r1], r0	#, tmp49
	call	puts		#
# basic.c:2128: 	printf("RETURN\n");
	mov.w	r1, sp	# tmp50,
	mov.w	r0, .LC47	# tmp51,
	st.w	[r1], r0	#, tmp51
	call	puts		#
# basic.c:2129: 	printf("LOAD P1.BAS\n");
	mov.w	r1, sp	# tmp52,
	mov.w	r0, .LC48	# tmp53,
	st.w	[r1], r0	#, tmp53
	call	puts		#
# basic.c:2130: 	printf("SAVE P2.BAS\n");
	mov.w	r1, sp	# tmp54,
	mov.w	r0, .LC49	# tmp55,
	st.w	[r1], r0	#, tmp55
	call	puts		#
# basic.c:2131: 	printf("MODE 0 (MODE 1, MODE 2)\n");
	mov.w	r1, sp	# tmp56,
	mov.w	r0, .LC50	# tmp57,
	st.w	[r1], r0	#, tmp57
	call	puts		#
# basic.c:2132: 	printf("PLOT 100, 100, color\n");
	mov.w	r1, sp	# tmp58,
	mov.w	r0, .LC51	# tmp59,
	st.w	[r1], r0	#, tmp59
	call	puts		#
# basic.c:2133: 	printf("LINE 100, 100, 200, 200, color\n");
	mov.w	r1, sp	# tmp60,
	mov.w	r0, .LC52	# tmp61,
	st.w	[r1], r0	#, tmp61
	call	puts		#
# basic.c:2134: 	printf("CIRCLE 100, 100, 50, color\n");
	mov.w	r1, sp	# tmp62,
	mov.w	r0, .LC53	# tmp63,
	st.w	[r1], r0	#, tmp63
	call	puts		#
# basic.c:2135: 	printf("DRAW 100, 100, color, 'TEXT'\n");
	mov.w	r1, sp	# tmp64,
	mov.w	r0, .LC54	# tmp65,
	st.w	[r1], r0	#, tmp65
	call	puts		#
# basic.c:2136: 	printf("A = KEY()\n");
	mov.w	r1, sp	# tmp66,
	mov.w	r0, .LC55	# tmp67,
	st.w	[r1], r0	#, tmp67
	call	puts		#
# basic.c:2137: 	printf("A = ISKEY()\n");
	mov.w	r1, sp	# tmp68,
	mov.w	r0, .LC56	# tmp69,
	st.w	[r1], r0	#, tmp69
	call	puts		#
# basic.c:2138: 	printf("DELAY 1000\n");
	mov.w	r1, sp	# tmp70,
	mov.w	r0, .LC57	# tmp71,
	st.w	[r1], r0	#, tmp71
	call	puts		#
# basic.c:2139: 	printf("CURSOR 10, 10\n");
	mov.w	r1, sp	# tmp72,
	mov.w	r0, .LC58	# tmp73,
	st.w	[r1], r0	#, tmp73
	call	puts		#
# basic.c:2140: 	printf("EXEC TEST.BIN\n");
	mov.w	r1, sp	# tmp74,
	mov.w	r0, .LC59	# tmp75,
	st.w	[r1], r0	#, tmp75
	call	puts		#
# basic.c:2141: 	printf("SYS 0\n");
	mov.w	r1, sp	# tmp76,
	mov.w	r0, .LC60	# tmp77,
	st.w	[r1], r0	#, tmp77
	call	puts		#
# basic.c:2142: 	printf("DRIVE 0 (SD) or DRIVE 1 (ETHERNET) or DRIVE 2 (UART)\n");
	mov.w	r1, sp	# tmp78,
	mov.w	r0, .LC61	# tmp79,
	st.w	[r1], r0	#, tmp79
	call	puts		#
# basic.c:2143: 	printf("TIME\n");
	mov.w	r1, sp	# tmp80,
	mov.w	r0, .LC62	# tmp81,
	st.w	[r1], r0	#, tmp81
	call	puts		#
# basic.c:2144: 	printf("ETH 1 or ETH 0\n");
	mov.w	r1, sp	# tmp82,
	mov.w	r0, .LC63	# tmp83,
	st.w	[r1], r0	#, tmp83
	call	puts		#
...
exec_delay:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 28 #111	#,
# basic.c:2151: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2152: 	expression_error = 0;
	xor.w	r0, r0	# tmp28
	st.b	[expression_error], r0	# expression_error, tmp28
# basic.c:2153: 	d = expression();	
	call	expression		#
	st.w	[r13 + (-4)], r0	# d,
# basic.c:2154: 	if (expression_error)
...
exec_cursor:
	...
	push	r6		#
	sub.w	sp, 32 #111	#,
# basic.c:2166: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2167: 	expression_error = 0;
	xor.w	r0, r0	# tmp34
	st.b	[expression_error], r0	# expression_error, tmp34
# basic.c:2168: 	x = expression();	
	call	expression		#
	st.w	[r13 + (-8)], r0	# x,
# basic.c:2169: 	if (expression_error)
...
# basic.c:2172: 		return;
	j	.L443		#
.L444:
# basic.c:2174: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2175: 	if (*txtpos != ',')
...
exec_poke:
	...
	push	r7		#
	sub.w	sp, 32 #111	#,
# basic.c:2200: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2201: 	expression_error = 0;
	xor.w	r0, r0	# tmp38
	st.b	[expression_error], r0	# expression_error, tmp38
# basic.c:2202: 	addr = expression();	
	call	expression		#
	st.w	[r13 + (-12)], r0	# addr,
# basic.c:2203: 	if (expression_error)
...
# basic.c:2206: 		return;
	j	.L448		#
.L449:
# basic.c:2208: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2209: 	if (*txtpos != ',')
...
# basic.c:2216: 		txtpos++;
	...
	add.w	r0, 1 #111	# _5,
	st.w	[txtpos], r0	# txtpos, _5
# basic.c:2218: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2219: 	expression_error = 0;
	xor.w	r0, r0	# tmp43
	st.b	[expression_error], r0	# expression_error, tmp43
# basic.c:2220: 	value = expression();	
	call	expression		#
	st.w	[r13 + (-16)], r0	# value,
# basic.c:2221: 	if (expression_error)
...
# basic.c:2224: 		return;
	j	.L448		#
.L452:
# basic.c:2227: 	buffer[(int)addr] = (int)value & 0XFF;
...
# basic.c:2232: 	if(!sdcard_init())
	...
	jnz	.L454		#
# basic.c:2234: 		printf("SD card init failed!\n");
	mov.w	r1, sp	# tmp30,
	mov.w	r0, .LC64	# tmp31,
	st.w	[r1], r0	#, tmp31
	call	puts		#
...
# basic.c:2237: 	if (!volume_init(1))
	...
	cmp.w	r1, r0	# tmp34, tmp35
	jnz	.L453		#
# basic.c:2239: 		printf("SD card volume failed!\n");
	mov.w	r1, sp	# tmp36,
	mov.w	r0, .LC65	# tmp37,
	st.w	[r1], r0	#, tmp37
	call	puts		#
...
exec_exec:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 160 #111	#,
# basic.c:2248: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2249: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:2252: 		return;
	j	.L456		#
.L458:
# basic.c:2256: 	for (i = 0; txtpos[i] != NL && txtpos[i] != CR && txtpos[i] != SPACE && txtpos[i] != TAB &&  i < 32; i++)
	xor.w	r0, r0	# tmp79
	st.w	[r13 + (-4)], r0	# i, tmp79
# basic.c:2256: 	for (i = 0; txtpos[i] != NL && txtpos[i] != CR && txtpos[i] != SPACE && txtpos[i] != TAB &&  i < 32; i++)
	j	.L460		#
.L462:
# basic.c:2259: 		s[i] = txtpos[i];
...
# basic.c:2264: 	printf("Loading program: [%s]\n", s);
	mov.w	r0, sp	# tmp100,
	mov.w	r1, r13	# tmp101,
...
# basic.c:2265: 	if (drive == 0)
	...
	jnz	.L463		#
# basic.c:2269: load_again:		
	nop	
.L464:
# basic.c:2270: 		if(file_open(s, &fd, O_READ))
	mov.w	r0, sp	# tmp105,
	xor.w	r1, r1	# tmp106
	st.w	[r0 + (8)], r1	#, tmp106
	mov.w	r1, r13	# tmp107,
...
# basic.c:2270: 		if(file_open(s, &fd, O_READ))
	...
	jz	.L465		#
# basic.c:2272: 			int len = fd.dir_entry.filesize;
	ld.w	r0, [r13 + (-104)]	# _28, fd.dir_entry.filesize
# basic.c:2272: 			int len = fd.dir_entry.filesize;
	st.w	[r13 + (-20)], r0	# len, _28
# basic.c:2273: 			int total = 0;
	xor.w	r0, r0	# tmp111
	st.w	[r13 + (-8)], r0	# total, tmp111
# basic.c:2275: 			while(total < len)
	j	.L466		#
.L469:
# basic.c:2277: 				current = file_read(&fd, &buffer[total], 512);
...
# basic.c:2281: 						printf("#");
	...
	j	.L466		#
.L467:
# basic.c:2284: 					printf("Error reading file!\n");
	mov.w	r1, sp	# tmp126,
...
# basic.c:2294: 			strcpy(fileName, s);
	mov.w	r0, sp	# tmp132,
	mov.w	r1, r13	# tmp133,
	...
	st.w	[r0], r1	#, tmp134
	call	strcpy		#
# basic.c:2295: 			int sum = 0;
	xor.w	r0, r0	# tmp135
	st.w	[r13 + (-12)], r0	# sum, tmp135
# basic.c:2296: 			for (int j = 0; j < i; j++) {
	xor.w	r0, r0	# tmp136
	st.w	[r13 + (-16)], r0	# j, tmp136
# basic.c:2296: 			for (int j = 0; j < i; j++) {
	j	.L470		#
.L471:
# basic.c:2297: 				sum += buffer[j];
...
# basic.c:2299: 			printf("\nSum: %d\n", sum);
	...
	j	.L472		#
.L465:
# basic.c:2303: 			printf("File open failed for file: [%s]\n", s);
	mov.w	r0, sp	# tmp146,
	mov.w	r1, r13	# tmp147,
...
# basic.c:2307: 	else if (drive == 2)
	...
	cmp.w	r1, r0	# tmp149, tmp150
	jnz	.L473		#
# basic.c:2310: 		asm ("irq\t0\n"); // IRQ 0000, xxx0 <- turn off timer irq
# 2310 "basic.c" 1
	irq	0

# basic.c:2311: 		delay(100);
	mov.w	r1, sp	# tmp151,
	mov.w	r0, 100	# tmp152,
	st.w	[r1], r0	#, tmp152
	call	delay		#
# basic.c:2312: 		i = uart_read_file(buffer, s);
	...
	call	uart_read_file		#
	st.w	[r13 + (-4)], r0	# i,
# basic.c:2313: 		asm ("irq\t1\n"); // IRQ 0000, xxx0 <- turn on timer irq
# 2313 "basic.c" 1
	irq	1

	j	.L472		#
.L473:
# basic.c:2316: 		i = eth_read_file(buffer, s);
...
# basic.c:2318: 	if (i > 0) 
	...
	cmp.w	r1, r0	# tmp157, tmp158
	jses	.L474		#
# basic.c:2321: 		int old_color = color;
	ld.w	r0, [color]	# tmp159, color
	st.w	[r13 + (-28)], r0	# old_color, tmp159
# basic.c:2322: 		asm("mov.w r0, 197632\ncallr r0\n"); //asm("call 197632\n");
# 2322 "basic.c" 1
	mov.w r0, 197632
callr r0

# basic.c:2323: 		init_stdio();
	call	init_stdio		#
# basic.c:2324: 		video_mode(0);
	mov.w	r1, sp	# tmp160,
	xor.w	r0, r0	# tmp161
	st.w	[r1], r0	#, tmp161
	call	video_mode		#
# basic.c:2325: 		color = old_color;
	ld.w	r0, [r13 + (-28)]	# tmp162, old_color
	st.w	[color], r0	# color, tmp162
# basic.c:2328: 		uart_init_files();
...
# basic.c:2329: 		if (eth)
	...
	jz	.L456		#
# basic.c:2331: 			init_spi();
	call	init_spi		#
# basic.c:2332: 			init_net();
	call	init_net		#
# basic.c:2333: 			init_sd();
	call	init_sd		#
	j	.L456		#
.L474:
# basic.c:2338: 		printf("Error loading program %s\n", s);
	mov.w	r0, sp	# tmp164,
	mov.w	r1, r13	# tmp165,
...
# basic.c:2347: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2348: 	expression_error = 0;
	xor.w	r0, r0	# tmp29
	st.b	[expression_error], r0	# expression_error, tmp29
# basic.c:2349: 	addr = (int)expression();	
	call	expression		#
	mov.w	r1, r0	# _1,
# basic.c:2349: 	addr = (int)expression();	
...
# basic.c:2350: 	if (expression_error)
...
# basic.c:2365: 	if (eth)
	...
	jz	.L477		#
# basic.c:2367: 		init_spi();
	call	init_spi		#
# basic.c:2368: 		init_net();
	call	init_net		#
# basic.c:2369: 		init_sd();
	call	init_sd		#
.L477:
# basic.c:2371: }
	mov.w	sp, r13	#,
...
exec_drive:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:2375: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2376: 	if (*txtpos == NL)
...
# basic.c:2379: 		return;
	j	.L481		#
.L482:
# basic.c:2381: 	if (*txtpos < '0' || *txtpos > '9')
...
# basic.c:2387: 	if (drive >= 0 && drive <= 2)
...
# basic.c:2388: 		printf("DRIVE: %d\n", drive);
	...
	j	.L481		#
.L486:
# basic.c:2391: 		printf("Invalid drive number: %d. Can be from 0 to 2.\n", drive);
...
exec_eth:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:2398: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2399: 	if (*txtpos == NL)
...
# basic.c:2399: 	if (*txtpos == NL)
	...
	cmp.w	r1, r0	# tmp42, tmp43
	jnz	.L488		#
# basic.c:2401: 		printf("ETHERNET: %d\n", eth);
...
# basic.c:2402: 		return;
	j	.L487		#
.L488:
# basic.c:2404: 	if (*txtpos < '0' || *txtpos > '9')
...
# basic.c:2410: 	if (eth >= 0 && eth <= 1) 
	...
	jgs	.L492		#
# basic.c:2412: 		printf("ETHERNET: %d\n", eth);
	...
	st.w	[r0], r1	#, tmp53
	call	printf		#
# basic.c:2414: 		if (eth == 1) 
	ld.w	r1, [eth]	# eth.455_15, eth
# basic.c:2414: 		if (eth == 1) 
	mov.w	r0, 1	# tmp54,
	cmp.w	r1, r0	# eth.455_15, tmp54
	jnz	.L493		#
# basic.c:2416: 			asm ("irq 1\n"); // IRQ 0000, xxx1 <- turn ON timer irq
# 2416 "basic.c" 1
	irq 1

# basic.c:2417: 			init_net();
	call	init_net		#
# basic.c:2414: 		if (eth == 1) 
	j	.L487		#
.L493:
# basic.c:2421: 			asm ("irq 0\n"); // IRQ 0000, xxx0 <- turn OFF timer irq
# 2421 "basic.c" 1
	irq 0

# basic.c:2422: 			de_init_timer();
	call	de_init_timer		#
# basic.c:2414: 		if (eth == 1) 
	j	.L487		#
.L492:
# basic.c:2429: 		printf("Invalid ethernet value: %d. Can be 0 or 1.\n", eth);
...
# basic.c:2444: 	int c = (int)expression();	
	call	expression		#
	mov.w	r1, r0	# _4,
# basic.c:2444: 	int c = (int)expression();	
...
# basic.c:2456: 	if (init_tcpip()) 
	...
	jz	.L501		#
# basic.c:2458: 		init_timer();
	call	init_timer		#
# basic.c:2459: 		return true;
	mov.w	r0, 1	# _2,
	j	.L502		#
.L501:
# basic.c:2461: 		printf("No ethernet link available\n.");
	mov.w	r1, sp	# tmp30,
	mov.w	r0, .LC75	# tmp31,
	st.w	[r1], r0	#, tmp31
	call	printf		#
...
# basic.c:2472: 	if (*txtpos == NL)
	...
	cmp.w	r1, r0	# tmp49, tmp50
	jnz	.L504		#
# basic.c:2473: 		return 0;
	xor.w	r0, r0	# _20
	j	.L505		#
.L504:
# basic.c:2475: 	scantable(keywords);
	mov.w	r1, sp	# tmp51,
	mov.w	r0, keywords	# tmp52,
	st.w	[r1], r0	#, tmp52
	call	scantable		#
# basic.c:2481: 	if (should_break())
	call	should_break		#
	mov.w	r1, r0	# _3,
# basic.c:2481: 	if (should_break())
	xor.w	r0, r0	# tmp53
	...
	jz	.L506		#
# basic.c:2483: 		return 0;
	xor.w	r0, r0	# _20
	j	.L505		#
.L506:
# basic.c:2486: 	switch (table_index)
	...
	j	.L551		#
.L543:
# basic.c:2490: 		exec_mem();
	call	exec_mem		#
# basic.c:2491: 		return 0;
	xor.w	r0, r0	# _20
	j	.L505		#
.L551:
# basic.c:2495: 		printf("I cannot exit. I am the boss.\n");
	mov.w	r1, sp	# tmp127,
...
# basic.c:2520: 		if (expression_error || *txtpos != NL)
...
# basic.c:2521: 			qhow();
	call	qhow		#
.L547:
# basic.c:2522: 		current_line = findline();
	call	findline		#
# basic.c:2522: 		current_line = findline();
	st.w	[current_line], r0	# current_line, _13
# basic.c:2523: 		return 2;
	mov.w	r0, 2	# _20,
	j	.L505		#
.L535:
# basic.c:2525: 		exec_for();
	call	exec_for		#
# basic.c:2526: 		break;
	j	.L545		#
.L534:
# basic.c:2528: 		exec_next();
	call	exec_next		#
# basic.c:2529: 		break;
	j	.L545		#
.L532:
# basic.c:2531: 		exec_gosub();
	call	exec_gosub		#
# basic.c:2532: 		break;
	j	.L545		#
.L533:
# basic.c:2534: 		if (!exec_return())
	call	exec_return		#
	mov.w	r1, r0	# _14,
# basic.c:2534: 		if (!exec_return())
	xor.w	r0, r0	# tmp135
	...
	jnz	.L553		#
# basic.c:2535: 			return 1;
	mov.w	r0, 1	# _20,
	j	.L505		#
.L531:
# basic.c:2540: 		if (txtpos[0] != NL)
...
# basic.c:2552: 		break;
	j	.L545		#
.L528:
# basic.c:2554: 		return exec_edit();
	call	exec_edit		#
	j	.L505		#
.L527:
# basic.c:2556: 		exec_load();
	call	exec_load		#
# basic.c:2557: 		break;
	j	.L545		#
.L526:
# basic.c:2559: 		exec_save();
	call	exec_save		#
# basic.c:2560: 		break;
	j	.L545		#
.L525:
# basic.c:2562: 		exec_dir();
	call	exec_dir		#
# basic.c:2563: 		break;
	j	.L545		#
.L524:
# basic.c:2565: 		exec_mode();
	call	exec_mode		#
# basic.c:2566: 		break;
	j	.L545		#
.L523:
# basic.c:2568: 		exec_plot();
	call	exec_plot		#
# basic.c:2569: 		break;
	j	.L545		#
.L522:
# basic.c:2571: 		exec_line();
	call	exec_line		#
# basic.c:2572: 		break;
	j	.L545		#
.L521:
# basic.c:2574: 		exec_circle();
	call	exec_circle		#
# basic.c:2575: 		break;
	j	.L545		#
.L520:
# basic.c:2577: 		exec_draw();
	call	exec_draw		#
# basic.c:2578: 		break;
	j	.L545		#
.L519:
# basic.c:2580: 		exec_help();
	call	exec_help		#
# basic.c:2581: 		break;
	j	.L545		#
.L518:
# basic.c:2583: 		exec_delay();
	call	exec_delay		#
# basic.c:2584: 		break;
	j	.L545		#
.L517:
# basic.c:2586: 		exec_cursor();
	call	exec_cursor		#
# basic.c:2587: 		break;
	j	.L545		#
.L516:
# basic.c:2589: 		exec_poke();
	call	exec_poke		#
# basic.c:2590: 		break;
	j	.L545		#
.L515:
# basic.c:2592: 		exec_exec();
	call	exec_exec		#
# basic.c:2593: 		break;
	j	.L545		#
.L514:
# basic.c:2595: 		exec_sys();
	call	exec_sys		#
# basic.c:2596: 		break;
	j	.L545		#
.L513:
# basic.c:2598: 		exec_drive();
	call	exec_drive		#
# basic.c:2599: 		break;
	j	.L545		#
.L512:
# basic.c:2601: 		printf("Current millis: %d\n", get_millis());
	call	get_millis		#
	mov.w	r1, r0	# _19,
	mov.w	r0, sp	# tmp139,
	st.w	[r0 + (4)], r1	#, _19
...
# basic.c:2602: 	break;
	j	.L545		#
.L510:
# basic.c:2607: 		exec_eth();
	call	exec_eth		#
# basic.c:2608: 		break;
	j	.L545		#
.L509:
# basic.c:2610: 		exec_color();
	call	exec_color		#
# basic.c:2611: 		break;
	j	.L545		#
.L507:
# basic.c:2613: 		assignment();
	call	assignment		#
# basic.c:2614: 		break;
	j	.L545		#
.L508:
# basic.c:2616: 		return 0;
	xor.w	r0, r0	# _20
	j	.L505		#
.L552:
# basic.c:2605: 		break;
...
init_K_API:
	push	r13		#
	mov.w	r13, sp	#,
# basic.c:2622: 	K_API_STDIO[K_CLS] 				= ((int)cls) + 4;               // 190000 
...
# basic.c:2623: 	K_API_STDIO[K_PUT_CHAR] 		= ((int)put_char) + 4;          // 190004 
...
# basic.c:2623: 	K_API_STDIO[K_PUT_CHAR] 		= ((int)put_char) + 4;          // 190004 
	st.w	[r0], r1	# *_6, _7
# basic.c:2624: 	K_API_STDIO[K_PRINTF] 			= ((int)printf) + 4;            // 190008 
...
# basic.c:2624: 	K_API_STDIO[K_PRINTF] 			= ((int)printf) + 4;            // 190008 
	st.w	[r0], r1	# *_10, _11
# basic.c:2625: 	K_API_STDIO[K_PUTS] 			= ((int)puts) + 4;              // 190012 
...
# basic.c:2625: 	K_API_STDIO[K_PUTS] 			= ((int)puts) + 4;              // 190012 
	st.w	[r0], r1	# *_14, _15
# basic.c:2626: 	K_API_STDIO[K_RAND] 			= ((int)rand) + 4;              // 190016 
...
# basic.c:2626: 	K_API_STDIO[K_RAND] 			= ((int)rand) + 4;              // 190016 
	st.w	[r0], r1	# *_18, _19
# basic.c:2627: 	K_API_STDIO[K_SHOULD_BREAK] 	= ((int)should_break) + 4;      // 190020 
...
# basic.c:2627: 	K_API_STDIO[K_SHOULD_BREAK] 	= ((int)should_break) + 4;      // 190020 
	st.w	[r0], r1	# *_22, _23
# basic.c:2628: 	K_API_STDIO[K_GETC] 			= ((int)getc) + 4;              // 190024 
...
# basic.c:2628: 	K_API_STDIO[K_GETC] 			= ((int)getc) + 4;              // 190024 
	st.w	[r0], r1	# *_26, _27
# basic.c:2629: 	K_API_STDIO[K_GETS] 			= ((int)gets) + 4;              // 190028 
...
# basic.c:2629: 	K_API_STDIO[K_GETS] 			= ((int)gets) + 4;              // 190028 
	st.w	[r0], r1	# *_30, _31
# basic.c:2630: 	K_API_STDIO[K_INIT_STDIO] 		= ((int)init_stdio) + 4;        // 190032 
...
# basic.c:2630: 	K_API_STDIO[K_INIT_STDIO] 		= ((int)init_stdio) + 4;        // 190032 
	st.w	[r0], r1	# *_34, _35
# basic.c:2631: 	K_API_STDIO[K_DELAY] 			= ((int)delay) + 4;             // 190036 
...
# basic.c:2631: 	K_API_STDIO[K_DELAY] 			= ((int)delay) + 4;             // 190036 
	st.w	[r0], r1	# *_38, _39
# basic.c:2632: 	K_API_STDIO[K_XY] 				= ((int)xy) + 4;                // 190040 
...
# basic.c:2632: 	K_API_STDIO[K_XY] 				= ((int)xy) + 4;                // 190040 
	st.w	[r0], r1	# *_42, _43
# basic.c:2633: 	K_API_STDIO[K_GET_MILLIS]		= ((int)get_millis) + 4;        // 190044 
...
# basic.c:2633: 	K_API_STDIO[K_GET_MILLIS]		= ((int)get_millis) + 4;        // 190044 
	st.w	[r0], r1	# *_46, _47
# basic.c:2634: 	K_API_STDIO[K_IS_KEY_PRESSED]	= ((int)is_key_pressed) + 4;    // 190048 
...
# basic.c:2634: 	K_API_STDIO[K_IS_KEY_PRESSED]	= ((int)is_key_pressed) + 4;    // 190048 
	st.w	[r0], r1	# *_50, _51
# basic.c:2635: 	K_API_STDIO[K_IS_KEY_RELEASED]	= ((int)is_key_released) + 4;   // 190052 
...
# basic.c:2635: 	K_API_STDIO[K_IS_KEY_RELEASED]	= ((int)is_key_released) + 4;   // 190052 
	st.w	[r0], r1	# *_54, _55
# basic.c:2636: 	K_API_STDIO[K_TOGGLE_CURSOR] 	= ((int)toggle_cursor) + 4;     // 190056 
...
# basic.c:2636: 	K_API_STDIO[K_TOGGLE_CURSOR] 	= ((int)toggle_cursor) + 4;     // 190056 
	st.w	[r0], r1	# *_58, _59
# basic.c:2637: 	K_API_STDIO[K_PUTCHAR]			= ((int)putchar) + 4;           // 190060 
...
# basic.c:2637: 	K_API_STDIO[K_PUTCHAR]			= ((int)putchar) + 4;           // 190060 
	st.w	[r0], r1	# *_62, _63
# basic.c:2638: 	K_API_STDIO[K_VIDEO_MODE]		= ((int)video_mode) + 4;        // 190064 
...
# basic.c:2638: 	K_API_STDIO[K_VIDEO_MODE]		= ((int)video_mode) + 4;        // 190064 
	st.w	[r0], r1	# *_66, _67
# basic.c:2639: 	K_API_GRAPHICS[K_SCROLL_UP]	    = ((int)scroll_up) + 4;			// 190068
...
# basic.c:2639: 	K_API_GRAPHICS[K_SCROLL_UP]	    = ((int)scroll_up) + 4;			// 190068
	st.w	[r0], r1	# *_70, _71
# basic.c:2641: 	K_API_STRING[K_STRLEN] =        ((int)strlen) + 4;				// 190100 
...
# basic.c:2642: 	K_API_STRING[K_STRCMP] =        ((int)strcmp) + 4;				// 190104 
...
# basic.c:2642: 	K_API_STRING[K_STRCMP] =        ((int)strcmp) + 4;				// 190104 
	st.w	[r0], r1	# *_77, _78
# basic.c:2643: 	K_API_STRING[K_STRNCMP] =       ((int)strncmp) + 4;				// 190108 
...
# basic.c:2643: 	K_API_STRING[K_STRNCMP] =       ((int)strncmp) + 4;				// 190108 
	st.w	[r0], r1	# *_81, _82
# basic.c:2644: 	K_API_STRING[K_MEMCPY] =        ((int)memcpy) + 4; 				// 190112 
...
# basic.c:2644: 	K_API_STRING[K_MEMCPY] =        ((int)memcpy) + 4; 				// 190112 
	st.w	[r0], r1	# *_85, _86
# basic.c:2645: 	K_API_STRING[K_MEMSET] =        ((int)memset) + 4; 				// 190116 
...
# basic.c:2645: 	K_API_STRING[K_MEMSET] =        ((int)memset) + 4; 				// 190116 
	st.w	[r0], r1	# *_89, _90
# basic.c:2646: 	K_API_STRING[K_MEMMOVE] =       ((int)memmove) + 4; 			// 190120 
...
# basic.c:2646: 	K_API_STRING[K_MEMMOVE] =       ((int)memmove) + 4; 			// 190120 
	st.w	[r0], r1	# *_93, _94
# basic.c:2647: 	K_API_STRING[K_STRCPY] =        ((int)strcpy) + 4; 				// 190124 
...
# basic.c:2647: 	K_API_STRING[K_STRCPY] =        ((int)strcpy) + 4; 				// 190124 
	st.w	[r0], r1	# *_97, _98
# basic.c:2648: 	K_API_STRING[K_STRNCPY] =       ((int)strncpy) + 4; 			// 190128 
...
# basic.c:2649: 	K_API_STRING[K_STRCAT] =        ((int)strcat) + 4;				// 190132 
...
# basic.c:2650: 	K_API_STRING[K_STRSTR] =        ((int)strstr) + 4;				// 190136 
...
# basic.c:2651: 	K_API_STRING[K_TOLOWER] =       ((int)tolower) + 4;				// 190140 
...
# basic.c:2652: 	K_API_STRING[K_TOUPPER] =       ((int)toupper) + 4;				// 190144 
...
# basic.c:2653: 	K_API_STRING[K_STR_TOUPPER] =   ((int)str_toupper) + 4;			// 190148 
...
# basic.c:2654: 	K_API_STRING[K_STR_N_TOUPPER] = ((int)str_n_toupper) + 4;		// 190152 
...
# basic.c:2655: 	K_API_STRING[K_ISDIGIT] =       ((int)isdigit) + 4;				// 190156 
...
# basic.c:2656: 	K_API_STRING[K_ISLOWER] =       ((int)islower) + 4;				// 190160 
...
# basic.c:2657: 	K_API_STRING[K_ISUPPER] =       ((int)isupper) + 4;				// 190164 
...
# basic.c:2658: 	K_API_STRING[K_ISALPHA] =       ((int)isalpha) + 4;				// 190168 
...
# basic.c:2659: 	K_API_STRING[K_ISALNUM] =       ((int)isalnum) + 4;				// 190172 
...
# basic.c:2660: 	K_API_STRING[K_ATOI] =          ((int)atoi) + 4;				// 190176 
...
# basic.c:2661: 	K_API_STRING[K_ISSPACE] =       ((int)isspace) + 4;				// 190180 
...
# basic.c:2662: 	K_API_STRING[K_MEMCMP] =        ((int)memcmp) + 4;		 	 	// 190184 
...
# basic.c:2663: 	K_API_STRING[K_STRTOK] =        ((int)strtok) + 4;				// 190188 
...
# basic.c:2664: 	K_API_STRING[K_STRCHR] =        ((int)strchr) + 4; 				// 190192 
...
# basic.c:2665: 	K_API_STRING[K_STRRRCHR] =      ((int)strrchr) + 4; 			// 190196 
...
# basic.c:2666: 	K_API_STRING[K_STRNCASECMP] =   ((int)strncasecmp) + 4; 		// 190200 
...
# basic.c:2668: 	K_API_SPRINTF[K_SPRINTF]	= 	((int)sprintf) + 4;				// 190300
...
# basic.c:2669: 	K_API_SPRINTF[K_VSPRINTF]	= 	((int)vsprintf) + 4;			// 190304
...
# basic.c:2671: 	K_API_GRAPHICS[K_PIXEL]		=	((int)pixel) + 4;				// 190400
...
# basic.c:2672: 	K_API_GRAPHICS[K_LINE]		=	((int)line) + 4;				// 190404
...
# basic.c:2673: 	K_API_GRAPHICS[K_CIRCLE]	=	((int)circle) + 4;				// 190408
...
# basic.c:2674: 	K_API_GRAPHICS[K_DRAW]		=	((int)draw) + 4;				// 190412
...
# basic.c:2676: 	K_API_SPI[K_INIT_SPI]		=    ((int)init_spi) + 4; 			// 190500
...
# basic.c:2677: 	K_API_SPI[K_DEINIT_SPI]		=    ((int)deinit_spi) + 4; 		// 190504
...
# basic.c:2678: 	K_API_SPI[K_SEND_SPI]		=    ((int)send_spi) + 4; 			// 190508
...
# basic.c:2679: 	K_API_SPI[K_READ_SPI]		=    ((int)read_spi) + 4; 			// 190512
...
# basic.c:2680: 	K_API_SPI[K_SPI_BYTE]		=    ((int)SPI_Byte) + 4; 			// 190516
...
# basic.c:2682: 	K_API_TCPIP[K_INIT_TCPIP]	= 	 ((int)init_tcpip) + 4;			// 190600
...
# basic.c:2683: 	K_API_TCPIP[K_BROWSE_URL]	= 	 ((int)browseUrl) + 4;			// 190604
...
# basic.c:2684: 	K_API_TCPIP[K_HTTP_POST]	= 	 ((int)httpPost) + 4;			// 190608
...
# basic.c:2685: 	K_API_TCPIP[K_MAIN_LOOP]	= 	 ((int)mainLoop) + 4;			// 190612
...
# basic.c:2688: 	K_API_FAT[K_SDCARD_INIT]	= 	 ((int)sdcard_init) + 4;		// 190700
...
# basic.c:2689: 	K_API_FAT[K_VOLUME_INIT]	= 	 ((int)volume_init) + 4;		// 190704
...
# basic.c:2690: 	K_API_FAT[K_FILE_OPEN]		= 	 ((int)file_open) + 4;			// 190708
...
# basic.c:2691: 	K_API_FAT[K_FILE_READ]		= 	 ((int)file_read) + 4;			// 190712
...
# basic.c:2692: 	K_API_FAT[K_GET_DIR_ENTRY]	= 	 ((int)getDirEntry) + 4;		// 190716
...
# basic.c:2693: 	K_API_FAT[K_FILE_SEEK]		= 	 ((int)file_seek) + 4;			// 190720
...
# basic.c:2694: 	K_API_FAT[K_FILE_WRITE]		= 	 ((int)file_write) + 4;			// 190724
...
# basic.c:2695: 	K_API_FAT[K_FILE_DELETE]	= 	 ((int)file_delete) + 4;		// 190728
...
# basic.c:2738: 			toUppercaseBuffer();
	call	toUppercaseBuffer		#
.L557:
# basic.c:2741: 		linenum = testnum();
	call	testnum		#
	mov.w	r1, r0	# _10,
# basic.c:2741: 		linenum = testnum();
...
# basic.c:2743: 		ignore_blanks();
	call	ignore_blanks		#
# basic.c:2745: 		if (linenum == 0)
...
# basic.c:2745: 		if (linenum == 0)
	...
	jnz	.L558		#
.L564:
# basic.c:2748: 				res = direct();
	call	direct		#
	st.w	[r13 + (-4)], r0	# res,
# basic.c:2749: 				if (res == 1)
	ld.w	r1, [r13 + (-4)]	# tmp64, res
	mov.w	r0, 1	# tmp65,
	cmp.w	r1, r0	# tmp64, tmp65
	jnz	.L559		#
# basic.c:2750: 					return 0;
	xor.w	r0, r0	# _64
	j	.L567		#
.L559:
# basic.c:2751: 				if (res == 2)
	ld.w	r1, [r13 + (-4)]	# tmp66, res
	mov.w	r0, 2	# tmp67,
	cmp.w	r1, r0	# tmp66, tmp67
	jnz	.L561		#
# basic.c:2753: 					txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	ld.w	r0, [current_line]	# current_line.610_13, current_line
	add.w	r0, 5 #111	# _14,
# basic.c:2753: 					txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	st.w	[txtpos], r0	# txtpos, _14
# basic.c:2754: 					continue;
	j	.L562		#
.L561:
# basic.c:2756: 				ignore_blanks();
	call	ignore_blanks		#
# basic.c:2757: 				if (*txtpos == NL || *txtpos != ':')
...
# basic.c:2759: 				txtpos++;
	...
	add.w	r0, 1 #111	# _20,
	st.w	[txtpos], r0	# txtpos, _20
# basic.c:2760: 				ignore_blanks();
	call	ignore_blanks		#
.L562:
# basic.c:2748: 				res = direct();
	j	.L564		#
.L558:
# basic.c:2763: 		else if (linenum == 0xFFFF)
...
# basic.c:2765: 			qhow();
	...
	j	.L566		#
.L565:
# basic.c:2769: 			entered_with_line_num();
	call	entered_with_line_num		#
# basic.c:2729: 		if (res != 3)
	j	.L566		#
.L567:
