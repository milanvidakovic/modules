...
sprintf:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/sprintf.c:207:    	asm("ld.w r0, [190300]\njr r0\n");
# 207 "/mnt/c/Prj/Altera/C/moxiebox/modules/lib/sprintf.c" 1
	ld.w r0, [190300]
jr r0

# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/sprintf.c:208: }
	nop	
	mov.w	sp, r13	#,
	pop	r13		#
	ret	
...
vsprintf:
	push	r13		#
	mov.w	r13, sp	#,
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/sprintf.c:212:    	asm("ld.w r0, [190304]\njr r0\n");
# 212 "/mnt/c/Prj/Altera/C/moxiebox/modules/lib/sprintf.c" 1
	ld.w r0, [190304]
jr r0

# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/sprintf.c:213: }
	nop	
	mov.w	sp, r13	#,
	pop	r13		#
	ret	
