...
toUppercaseBuffer:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 8 #111	#,
# basic.c:271: 	char *c = txtpos;
	ld.w	r0, [txtpos]	# tmp36, txtpos
	st.w	[r13 + (-4)], r0	# c, tmp36
# basic.c:272: 	char quote = 0;
	xor.w	r0, r0	# tmp37
	st.b	[r13 + (-5)], r0	# quote, tmp37
# basic.c:274: 	while (*c != NL)
	j	.L4		#
.L9:
# basic.c:277: 		if (*c == quote)
...
# basic.c:280: 			quote = *c;
	...
	j	.L6		#
.L8:
# basic.c:281: 		else if (quote == 0 && *c >= 'a' && *c <= 'z')
	ld.b	r0, [r13 + (-5)]	#, quote
	sex.b	r1, r0	# tmp50,
	xor.w	r0, r0	# tmp51
...
ignore_blanks:
	push	r13		#
	mov.w	r13, sp	#,
# basic.c:289: 	while (*txtpos == SPACE || *txtpos == TAB)
	j	.L11		#
.L12:
# basic.c:290: 		txtpos++;
...
skip_to_end:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 4 #111	#,
# basic.c:295: 	txtpos = program_end + sizeof(LINENUM);
	ld.w	r0, [program_end]	# program_end.10_1, program_end
	add.w	r0, 4 #111	# _2,
# basic.c:295: 	txtpos = program_end + sizeof(LINENUM);
	st.w	[txtpos], r0	# txtpos, _2
# basic.c:298: 	while (*txtpos != NL)
	j	.L14		#
.L15:
# basic.c:299: 		txtpos++;
...
# basic.c:325: 		if (((LINENUM *)line)[0] >= linenum)
	...
	js	.L24		#
# basic.c:326: 			return line;
	ld.w	r0, [r13 + (-4)]	# _9, line
	j	.L23		#
.L24:
# basic.c:329: 		line += line[sizeof(LINENUM)];
...
# basic.c:341: 	printf("%d ", line_num);
	...
	st.w	[r0], r1	#, tmp41
	call	printf		#
# basic.c:342: 	while (*list_line != NL)
	j	.L27		#
.L28:
# basic.c:344: 		put_char(*list_line);
...
testnum:
	...
	push	r6		#
	sub.w	sp, 28 #111	#,
# basic.c:353: 	VAR num = 0;
	xor.w	r0, r0	# tmp41
	st.w	[r13 + (-8)], r0	# num, tmp41
# basic.c:354: 	ignore_blanks(txtpos);
	ld.w	r0, [txtpos]	# txtpos.27_1, txtpos
	mov.w	r1, sp	# tmp42,
	st.w	[r1], r0	#, txtpos.27_1
	call	ignore_blanks		#
# basic.c:356: 	while (*txtpos >= '0' && *txtpos <= '9')
	j	.L30		#
.L34:
# basic.c:359: 		if (num >= 0xFFFFFFFF / 10)
	...
	jss	.L37		#
# basic.c:361: 			num = 0xFFFFFFFF;
	mov.w	r0, 1333788672	# tmp47,
	st.w	[r13 + (-8)], r0	# num, tmp47
# basic.c:362: 			break;
	j	.L33		#
.L37:
# basic.c:365: 		num = num * 10 + *txtpos - '0';
...
entered_with_line_num:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 84 #111	#,
# basic.c:381: 	linelen = 0;
	xor.w	r0, r0	# tmp98
	st.b	[r13 + (-1)], r0	# linelen, tmp98
# basic.c:382: 	while (txtpos[linelen] != NL)
	j	.L39		#
.L40:
# basic.c:383: 		linelen++;
...
# basic.c:395: 		txtpos[sizeof(LINENUM) + sizeof(char)] = ' ';
...
# basic.c:407: 	if (start != program_end && *((LINENUM *)start) == linenum)
	...
	jnz	.L43		#
# basic.c:412: 		from = start + start[sizeof(LINENUM)];
...
# basic.c:413: 		dest = start;
	ld.w	r0, [r13 + (-8)]	# tmp123, start
	st.w	[r13 + (-20)], r0	# dest, tmp123
# basic.c:415: 		tomove = program_end - from;
...
# basic.c:416: 		while (tomove > 0)
	j	.L44		#
.L45:
# basic.c:418: 			*dest = *from;
...
# basic.c:416: 		while (tomove > 0)
	...
	jnz	.L45		#
# basic.c:423: 		program_end = dest;
	ld.w	r0, [r13 + (-20)]	# tmp135, dest
	st.w	[program_end], r0	# program_end, tmp135
.L43:
# basic.c:426: 	if (txtpos[sizeof(LINENUM) + sizeof(char)] == NL)
...
# basic.c:426: 	if (txtpos[sizeof(LINENUM) + sizeof(char)] == NL)
	...
	jz	.L58		#
# basic.c:433: 	first_time = 1; // odd address hack
	mov.w	r0, 1	# tmp138,
	st.w	[r13 + (-16)], r0	# first_time, tmp138
# basic.c:435: 	while (linelen > 0)
	j	.L48		#
.L57:
# basic.c:441: 		space_to_make = txtpos - program_end;
...
# basic.c:446: 		tomove = program_end - start;
...
# basic.c:461: 		if(first_time && (txtpos[sizeof(LINENUM) + sizeof(char)] == ' '))
...
# basic.c:461: 		if(first_time && (txtpos[sizeof(LINENUM) + sizeof(char)] == ' '))
	...
	jnz	.L52		#
# basic.c:466: 			k = txtpos[sizeof(LINENUM)];
	ld.w	r0, [txtpos]	# txtpos.54_45, txtpos
	add.w	r0, 4 #111	# _46,
	ld.b	r0, [r0]	# _47, *_46
# basic.c:466: 			k = txtpos[sizeof(LINENUM)];
	st.b	[r13 + (-49)], r0	# k, _47
# basic.c:467: 			k -= sizeof(LINENUM) + sizeof(char); // actual length of line
	ld.b	r0, [r13 + (-49)]	# k.55_48, k
	add.w	r0, -5 #111	# tmp161,
	st.b	[r13 + (-49)], r0	# k, _49
# basic.c:468: 			for (l = 0; l < k; l++)
	xor.w	r0, r0	# tmp162
	st.w	[r13 + (-12)], r0	# l, tmp162
# basic.c:468: 			for (l = 0; l < k; l++)
	j	.L53		#
.L54:
# basic.c:470: 				txtpos[sizeof(LINENUM) + sizeof(char) + l] = txtpos[sizeof(LINENUM) + sizeof(char) + l + 1];
...
# basic.c:468: 			for (l = 0; l < k; l++)
	...
	jss	.L54		#
# basic.c:472: 			txtpos[k + sizeof(LINENUM) + sizeof(char) - 2] = 32;
...
# basic.c:473: 			txtpos[k + sizeof(LINENUM) + sizeof(char) - 1] = NL;
...
.L52:
# basic.c:478: 		for (tomove = 0; tomove < space_to_make; tomove++)
	xor.w	r0, r0	# tmp168
	st.w	[r13 + (-32)], r0	# tomove, tmp168
# basic.c:478: 		for (tomove = 0; tomove < space_to_make; tomove++)
	j	.L55		#
.L56:
# basic.c:480: 			*start = *txtpos;
...
# basic.c:478: 		for (tomove = 0; tomove < space_to_make; tomove++)
	...
	js	.L56		#
# basic.c:487: 		program_end = newEnd;
	ld.w	r0, [r13 + (-48)]	# tmp178, newEnd
	st.w	[program_end], r0	# program_end, tmp178
# basic.c:488: 		first_time = 0;  // odd address hack
	xor.w	r0, r0	# tmp179
...
exec_mem:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:510: 	printf("TinyBasic %s\n", kVersion);
	mov.w	r0, sp	# tmp29,
	mov.w	r1, .LC4	# tmp30,
	st.w	[r0 + (4)], r1	#, tmp30
	mov.w	r1, .LC5	# tmp31,
	st.w	[r0], r1	#, tmp31
	call	printf		#
# basic.c:511: 	printf("%d bytes free\n", variables_begin - program_end);
...
# basic.c:517: 	table_index = 0;
	xor.w	r0, r0	# tmp46
	st.b	[table_index], r0	# table_index, tmp46
.L71:
# basic.c:521: 		if (*table == 0)
...
# basic.c:538: 			if (*table == 0x01)
	...
	cmp.w	r1, r0	# tmp56, tmp57
	jnz	.L69		#
# basic.c:540: 				txtpos += i;  // Advance the pointer to following the keyword
	ld.w	r0, [txtpos]	# txtpos.69_10, txtpos
	ld.w	r1, [r13 + (-4)]	# i.70_11, i
	add.w	r0, r1 #222	# _12, i.70_11
	st.w	[txtpos], r0	# txtpos, _12
# basic.c:541: 				ignore_blanks(txtpos);
...
# basic.c:567: 	txtpos++;
	...
	add.w	r0, 1 #111	# _4,
	st.w	[txtpos], r0	# txtpos, _4
# basic.c:570: 	while (txtpos[i] != delim)
	j	.L76		#
.L78:
# basic.c:572: 		if (txtpos[i] == NL)
...
# basic.c:570: 	while (txtpos[i] != delim)
	cmp.w	r1, r0	# _13, _14
	jnz	.L78		#
# basic.c:578: 	while (*txtpos != delim)
	j	.L79		#
.L80:
# basic.c:580: 		put_char(*txtpos);
...
# basic.c:578: 	while (*txtpos != delim)
	cmp.w	r1, r0	# _22, _23
	jnz	.L80		#
# basic.c:583: 	txtpos++; // Skip over the last delimiter
...
check_no_arg_func:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:590: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:591: 	if (*txtpos != '(')
...
# basic.c:593: 	txtpos++;
	...
	add.w	r0, 1 #111	# _4,
	st.w	[txtpos], r0	# txtpos, _4
# basic.c:594: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:595: 	if (*txtpos != ')')
...
expr4:
	...
	push	r6		#
	sub.w	sp, 52 #111	#,
# basic.c:603: 	unsigned char f = table_index;
	ld.b	r0, [table_index]	# table_index.90_1, table_index
	st.b	[r13 + (-21)], r0	# f, table_index.90_1
# basic.c:606: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:612: 	if (*txtpos == '-') {
...
# basic.c:614: 		return -expr4();
	...
	j	.L87		#
.L86:
# basic.c:625: 	if (*txtpos >= '0' && *txtpos <= '9')
...
# basic.c:646: 		} while ((*txtpos >= '0' && *txtpos <= '9') || (*txtpos == '.'));
...
# basic.c:646: 		} while ((*txtpos >= '0' && *txtpos <= '9') || (*txtpos == '.'));
	...
	jz	.L93		#
# basic.c:650: 		return a;
	ld.w	r1, [r13 + (-8)]	# _98, a
	j	.L87		#
.L88:
# basic.c:657: 	if (txtpos[0] >= 'A' && txtpos[0] <= 'Z')
...
# basic.c:657: 	if (txtpos[0] >= 'A' && txtpos[0] <= 'Z')
	...
	cmp.w	r1, r0	# tmp159, tmp160
	jg	.L94		#
# basic.c:661: 		if (txtpos[1] < 'A' || txtpos[1] > 'Z')
...
# basic.c:661: 		if (txtpos[1] < 'A' || txtpos[1] > 'Z')
	...
	jse	.L96		#
.L95:
# basic.c:667: 			val = ((VAR *)variables_begin)[*txtpos - 'A'];
...
# basic.c:669: 			return val;
	ld.w	r1, [r13 + (-28)]	# _98, val
	j	.L87		#
.L96:
# basic.c:673: 		scantable(func_tab);
	mov.w	r1, sp	# tmp168,
	mov.w	r0, func_tab	# tmp169,
	st.w	[r1], r0	#, tmp169
	call	scantable		#
# basic.c:679: 		if (table_index == FUNC_UNKNOWN)
...
# basic.c:679: 		if (table_index == FUNC_UNKNOWN)
	...
	jz	.L128		#
# basic.c:682: 		switch(table_index)
	...
	j	.L100		#
.L102:
# basic.c:685: 			if (check_no_arg_func())
...
# basic.c:687: 			return getc();
	...
	j	.L87		#
.L103:
# basic.c:689: 			if (check_no_arg_func())
	call	check_no_arg_func		#
	mov.w	r1, r0	# _57,
# basic.c:689: 			if (check_no_arg_func())
	xor.w	r0, r0	# tmp179
	...
	jnz	.L130		#
# basic.c:691: 			return is_key_pressed();
	call	is_key_pressed		#
	st.w	[sp], r0	#, _58
	call	__floatsisf		#
	mov.w	r1, r0	# _98,
	j	.L87		#
.L101:
# basic.c:693: 			return M_PI;
	mov.w	r1, 1078530011	# _98,
	j	.L87		#
.L99:
# basic.c:695: 			return M_E;
	mov.w	r1, 1076754516	# _98,
	j	.L87		#
.L100:
# basic.c:698: 		f = table_index;
...
# basic.c:704: 		expression_error = 0;
	xor.w	r0, r0	# tmp182
	st.b	[expression_error], r0	# expression_error, tmp182
# basic.c:705: 		val = expression();
	call	expression		#
	st.w	[r13 + (-28)], r0	# val,
# basic.c:706: 		if (expression_error)
...
# basic.c:706: 		if (expression_error)
	...
	jnz	.L132		#
# basic.c:709: 		ignore_blanks();
	call	ignore_blanks		#
# basic.c:714: 		VAR val2 = 0;
	xor.w	r0, r0	# tmp185
	st.w	[r13 + (-20)], r0	# val2, tmp185
# basic.c:715: 		if (*txtpos != ')')
...
# basic.c:720: 				expression_error = 0;
	xor.w	r0, r0	# tmp190
	st.b	[expression_error], r0	# expression_error, tmp190
# basic.c:721: 				val2 = expression();
	call	expression		#
	st.w	[r13 + (-20)], r0	# val2,
# basic.c:722: 				if (expression_error)
...
# basic.c:730: 		switch (f)
	...
	j	.L94		#
.L121:
# basic.c:733: 				return buffer[(int)val];
...
# basic.c:736: 					return -val;
	...
	j	.L87		#
.L127:
# basic.c:737: 				return val;
	ld.w	r1, [r13 + (-28)]	# _98, val
	j	.L87		#
.L120:
# basic.c:739: 				return(rand() % (int)val);
	call	rand		#
	mov.w	r6, r0	# _80,
# basic.c:739: 				return(rand() % (int)val);
...
# basic.c:751: 				return(sqrtf(val));
	...
	j	.L87		#
.L113:
# basic.c:753: 				return(powf(val, val2));
	mov.w	r0, sp	# tmp238,
...
# basic.c:772: 		return a;
	ld.w	r1, [r13 + (-32)]	# _98, a
	j	.L87		#
.L128:
# basic.c:680: 			goto expr4_error;
	nop	
	j	.L98		#
.L129:
...
# basic.c:690: 				goto expr4_error;
	...
	j	.L98		#
.L131:
# basic.c:701: 			goto expr4_error;
	nop	
	j	.L98		#
.L132:
# basic.c:707: 			goto expr4_error;
	nop	
	j	.L98		#
.L133:
# basic.c:725: 				goto expr4_error;
	nop	
	j	.L98		#
.L134:
# basic.c:723: 					goto expr4_error;
	nop	
	j	.L98		#
.L135:
# basic.c:775: expr4_error:
	nop	
	j	.L98		#
.L136:
# basic.c:769: 			goto expr4_error;
	nop	
.L98:
# basic.c:776: 	expression_error = 1;
	mov.b	r0, 1	# tmp251,
	st.b	[expression_error], r0	# expression_error, tmp251
# basic.c:777: 	return 0;
	xor.w	r1, r1	# _98
.L87:
# basic.c:779: }
...
# basic.c:786: 	a = expr4();
	call	expr4		#
	st.w	[r13 + (-8)], r0	# a,
# basic.c:788: 	ignore_blanks(); // fix for eg:  100 a = a + 1
	call	ignore_blanks		#
.L147:
# basic.c:792: 		if (*txtpos == '*')
...
# basic.c:803: 				a /= b;
	...
	j	.L147		#
.L150:
# basic.c:805: 				expression_error = 1;
	mov.b	r0, 1	# tmp58,
	st.b	[expression_error], r0	# expression_error, tmp58
	j	.L147		#
.L140:
# basic.c:807: 		else if (*txtpos == '%')
...
# basic.c:814: 				a = x;
	...
	j	.L147		#
.L151:
# basic.c:816: 				expression_error = 1;
	mov.b	r0, 1	# tmp71,
	st.b	[expression_error], r0	# expression_error, tmp71
	j	.L147		#
.L143:
# basic.c:819: 			return a;
	ld.w	r0, [r13 + (-8)]	# _23, a
	mov.w	r1, r0	# <retval>, _23
# basic.c:821: }
	mov.w	r0, r1	#, <retval>
...
# basic.c:857: 	a = expr2();
	call	expr2		#
	st.w	[r13 + (-4)], r0	# a,
# basic.c:864: 	if (expression_error)	return a;
...
# basic.c:864: 	if (expression_error)	return a;
	...
	j	.L165		#
.L164:
# basic.c:866: 	scantable(relop_tab);
	mov.w	r1, sp	# tmp34,
	mov.w	r0, relop_tab	# tmp35,
	st.w	[r1], r0	#, tmp35
	call	scantable		#
# basic.c:872: 	if (table_index == RELOP_UNKNOWN)
...
# basic.c:872: 	if (table_index == RELOP_UNKNOWN)
	...
	cmp.w	r1, r0	# tmp36, tmp37
	jnz	.L166		#
# basic.c:873: 		return a;
	ld.w	r0, [r13 + (-4)]	# _5, a
	j	.L165		#
.L166:
# basic.c:875: 	switch (table_index)
...
assignment:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 32 #111	#,
# basic.c:919: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:922: 		return;
	j	.L202		#
.L204:
# basic.c:927: 	var = (VAR *)variables_begin + *txtpos - 'A';
...
# basic.c:933: 	txtpos++;
	...
	add.w	r0, 1 #111	# _12,
	st.w	[txtpos], r0	# txtpos, _12
# basic.c:935: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:937: 	if (*txtpos != '=')
...
# basic.c:943: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:944: 	expression_error = 0;
	xor.w	r0, r0	# tmp56
	st.b	[expression_error], r0	# expression_error, tmp56
# basic.c:945: 	value = expression();
	call	expression		#
	st.w	[r13 + (-8)], r0	# value,
# basic.c:946: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:953: 	if (expression_error)
...
# basic.c:956: 		return;
	j	.L202		#
.L207:
# basic.c:959: 	if (*txtpos != NL && *txtpos != ':')
...
# basic.c:974: 	if (*txtpos == NL)
	...
	jz	.L224		#
.L210:
# basic.c:981: 		ignore_blanks(txtpos);
	ld.w	r0, [txtpos]	# txtpos.151_3, txtpos
	mov.w	r1, sp	# tmp63,
	st.w	[r1], r0	#, txtpos.151_3
	call	ignore_blanks		#
# basic.c:982: 		if (print_quoted_string())
...
# basic.c:982: 		if (print_quoted_string())
	...
	cmp.w	r1, r0	# tmp64, tmp65
	jz	.L212		#
# basic.c:984: 			ignore_blanks(txtpos);
	...
	j	.L213		#
.L212:
# basic.c:986: 		else if (*txtpos == '"' || *txtpos == '\'')
...
# basic.c:989: 			return;
	j	.L209		#
.L215:
# basic.c:994: 			expression_error = 0;
	xor.w	r0, r0	# tmp71
	st.b	[expression_error], r0	# expression_error, tmp71
# basic.c:995: 			e = expression();
	call	expression		#
	st.w	[r13 + (-4)], r0	# e,
# basic.c:996: 			if (expression_error)
...
# basic.c:999: 				return;
	j	.L209		#
.L216:
# basic.c:1001: 			printf("%f", roundf(e*10000.0f) / 10000.0f);
...
# basic.c:1005: 		if (*txtpos == ',')
	...
	jnz	.L217		#
# basic.c:1006: 			txtpos++;	// Skip the comma and move onto the next
	ld.w	r0, [txtpos]	# txtpos.157_17, txtpos
	add.w	r0, 1 #111	# _18,
	st.w	[txtpos], r0	# txtpos, _18
	j	.L210		#
.L217:
# basic.c:1007: 		else if (txtpos[0] == ';' && (txtpos[1] == NL || txtpos[1] == ':' || txtpos[1] == ' '))
...
# basic.c:1007: 		else if (txtpos[0] == ';' && (txtpos[1] == NL || txtpos[1] == ':' || txtpos[1] == ' '))
	...
	jnz	.L219		#
.L220:
# basic.c:1009: 			txtpos++; // This has to be the end of the print - no newline
...
# basic.c:1010: 			break;
	j	.L209		#
.L219:
# basic.c:1012: 		else if (*txtpos == NL || *txtpos == ':')
...
exec_list:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 32 #111	#,
# basic.c:1029: 	linenum = testnum(); // Retuns 0 if no line found.
	call	testnum		#
	mov.w	r1, r0	# _1,
# basic.c:1029: 	linenum = testnum(); // Retuns 0 if no line found.
...
# basic.c:1035: 		return;
	j	.L225		#
.L226:
# basic.c:1039: 	list_line = findline();
	call	findline		#
# basic.c:1039: 	list_line = findline();
...
# basic.c:1041: 	while (list_line < program_end)
	j	.L228		#
.L229:
# basic.c:1043: 		printline();
	call	printline		#
# basic.c:1044: 		i++;
	ld.w	r0, [r13 + (-4)]	# tmp38, i
	add.w	r0, 1 #111	# tmp37,
	st.w	[r13 + (-4)], r0	# i, tmp37
# basic.c:1045: 		if (i == 29)
...
exec_run:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 28 #111	#,
# basic.c:1059: 	while (current_line < program_end) // Out of lines to run
	j	.L232		#
.L237:
# basic.c:1061: 		txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	ld.w	r0, [current_line]	# current_line.168_1, current_line
	add.w	r0, 5 #111	# _2,
# basic.c:1061: 		txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	st.w	[txtpos], r0	# txtpos, _2
.L236:
# basic.c:1064: 			res = direct();
	call	direct		#
	st.w	[r13 + (-4)], r0	# res,
# basic.c:1065: 			if (res == 1)
	ld.w	r1, [r13 + (-4)]	# tmp42, res
	mov.w	r0, 1	# tmp43,
	cmp.w	r1, r0	# tmp42, tmp43
	jz	.L238		#
# basic.c:1067: 			ignore_blanks();
	call	ignore_blanks		#
# basic.c:1068: 			if (*txtpos == NL || *txtpos != ':')
...
# basic.c:1070: 			txtpos++;
	...
	add.w	r0, 1 #111	# _8,
	st.w	[txtpos], r0	# txtpos, _8
# basic.c:1071: 			ignore_blanks();
	call	ignore_blanks		#
# basic.c:1064: 			res = direct();
	j	.L236		#
.L235:
# basic.c:1074: 		if (res < 2)
	ld.w	r1, [r13 + (-4)]	# tmp48, res
	mov.w	r0, 1	# tmp49,
	cmp.w	r1, r0	# tmp48, tmp49
	jgs	.L232		#
# basic.c:1075: 			current_line += current_line[sizeof(LINENUM)];
...
exec_if:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 32 #111	#,
# basic.c:1088: 	expression_error = 0;
	xor.w	r0, r0	# tmp37
	st.b	[expression_error], r0	# expression_error, tmp37
# basic.c:1089: 	condition = expression();
	call	expression		#
	st.w	[r13 + (-4)], r0	# condition,
# basic.c:1090: 	if (expression_error || *txtpos == NL)
...
# basic.c:1113: 	return;
	j	.L250		#
.L248:
# basic.c:1098: 			res = direct();
	call	direct		#
	st.w	[r13 + (-8)], r0	# res,
# basic.c:1099: 			if (res == 1)
	ld.w	r1, [r13 + (-8)]	# tmp46, res
	mov.w	r0, 1	# tmp47,
	cmp.w	r1, r0	# tmp46, tmp47
	jz	.L249		#
# basic.c:1101: 			if (res == 2)
	ld.w	r1, [r13 + (-8)]	# tmp48, res
	mov.w	r0, 2	# tmp49,
	cmp.w	r1, r0	# tmp48, tmp49
	jnz	.L246		#
# basic.c:1103: 				txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	ld.w	r0, [current_line]	# current_line.178_4, current_line
	add.w	r0, 5 #111	# _5,
# basic.c:1103: 				txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	st.w	[txtpos], r0	# txtpos, _5
# basic.c:1104: 				continue;
	j	.L247		#
.L246:
# basic.c:1106: 			ignore_blanks();
	call	ignore_blanks		#
# basic.c:1107: 			if (*txtpos == NL || *txtpos != ':')
...
exec_for:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 44 #111	#,
# basic.c:1121: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1122: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:1129: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1130: 	if (*txtpos != '=')
...
# basic.c:1135: 	txtpos++;
	...
	add.w	r0, 1 #111	# _11,
	st.w	[txtpos], r0	# txtpos, _11
# basic.c:1136: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1138: 	expression_error = 0;
	xor.w	r0, r0	# tmp71
	st.b	[expression_error], r0	# expression_error, tmp71
# basic.c:1139: 	initial = expression();
	call	expression		#
	st.w	[r13 + (-12)], r0	# initial,
# basic.c:1140: 	if (expression_error)
...
# basic.c:1143: 		return;
	j	.L251		#
.L256:
# basic.c:1146: 	scantable(to_tab);
	mov.w	r1, sp	# tmp74,
	mov.w	r0, to_tab	# tmp75,
	st.w	[r1], r0	#, tmp75
	call	scantable		#
# basic.c:1147: 	if (table_index != 0)
...
# basic.c:1150: 		return;
	j	.L251		#
.L257:
# basic.c:1153: 	terminal = expression();
	call	expression		#
	st.w	[r13 + (-16)], r0	# terminal,
# basic.c:1154: 	if (expression_error)
...
# basic.c:1157: 		return;
	j	.L251		#
.L258:
# basic.c:1160: 	scantable(step_tab);
	mov.w	r1, sp	# tmp80,
	mov.w	r0, step_tab	# tmp81,
	st.w	[r1], r0	#, tmp81
	call	scantable		#
# basic.c:1161: 	if (table_index == 0)
...
# basic.c:1161: 	if (table_index == 0)
	...
	jnz	.L259		#
# basic.c:1163: 		step = expression();
	call	expression		#
	st.w	[r13 + (-4)], r0	# step,
# basic.c:1164: 		if (expression_error)
...
# basic.c:1173: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1174: 	if (*txtpos != NL && *txtpos != ':')
...
# basic.c:1177: 		return;
	j	.L251		#
.L261:
# basic.c:1180: 	if (!expression_error && ((*txtpos == NL) || (*txtpos == ':')))
...
# basic.c:1180: 	if (!expression_error && ((*txtpos == NL) || (*txtpos == ':')))
	...
	jnz	.L262		#
.L263:
# basic.c:1183: 		if (bsp + sizeof(struct stack_for_frame) < stack_limit)
...
# basic.c:1186: 			return;
	j	.L251		#
.L264:
# basic.c:1189: 		bsp -= sizeof(struct stack_for_frame);
	ld.w	r0, [bsp]	# bsp.200_29, bsp
	add.w	r0, -20 #111	# _30,
	st.w	[bsp], r0	# bsp, _30
# basic.c:1190: 		f = (struct stack_for_frame *)bsp;
	ld.w	r0, [bsp]	# tmp97, bsp
	st.w	[r13 + (-20)], r0	# f, tmp97
# basic.c:1191: 		((VAR *)variables_begin)[var - 'A'] = initial;
...
exec_return:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 44 #111	#,
# basic.c:1216: 	tempsp = bsp;
	ld.w	r0, [bsp]	# bsp.205_1, bsp
	st.w	[tempsp], r0	# tempsp, bsp.205_1
# basic.c:1217: 	while (tempsp < program + kRamSize - 1)
	j	.L266		#
.L280:
# basic.c:1223: 		switch (tempsp[0])
...
# basic.c:1223: 		switch (tempsp[0])
	...
	jnz	.L268		#
# basic.c:1226: 			if (table_index == KW_RETURN)
...
# basic.c:1226: 			if (table_index == KW_RETURN)
	...
	cmp.w	r1, r0	# tmp72, tmp73
	jnz	.L269		#
# basic.c:1228: 				struct stack_gosub_frame *f = (struct stack_gosub_frame *)tempsp;
	ld.w	r0, [tempsp]	# tmp74, tempsp
	st.w	[r13 + (-12)], r0	# f, tmp74
# basic.c:1229: 				current_line = f->current_line;
	ld.w	r0, [r13 + (-12)]	# tmp75, f
	ld.w	r0, [r0 + (4)]	# _6, f_53->current_line
# basic.c:1229: 				current_line = f->current_line;
	st.w	[current_line], r0	# current_line, _6
# basic.c:1230: 				txtpos = f->txtpos;
	ld.w	r0, [r13 + (-12)]	# tmp76, f
	ld.w	r0, [r0 + (8)]	# _7, f_53->txtpos
# basic.c:1230: 				txtpos = f->txtpos;
	st.w	[txtpos], r0	# txtpos, _7
# basic.c:1231: 				bsp += sizeof(struct stack_gosub_frame);
	ld.w	r0, [bsp]	# bsp.208_8, bsp
	add.w	r0, 12 #111	# _9,
	st.w	[bsp], r0	# bsp, _9
# basic.c:1232: 				return 0;
	xor.w	r0, r0	# _45
	j	.L270		#
.L269:
# basic.c:1235: 			tempsp += sizeof(struct stack_gosub_frame);
...
# basic.c:1236: 			break;
	j	.L266		#
.L267:
# basic.c:1239: 			if (table_index == KW_NEXT)
...
# basic.c:1239: 			if (table_index == KW_NEXT)
	...
	jnz	.L271		#
# basic.c:1241: 				struct stack_for_frame *f = (struct stack_for_frame *)tempsp;
	ld.w	r0, [tempsp]	# tmp79, tempsp
	st.w	[r13 + (-16)], r0	# f, tmp79
# basic.c:1243: 				var = txtpos[-1];
...
# basic.c:1245: 				while (var == ' ') 
	j	.L272		#
.L273:
# basic.c:1247: 					var = txtpos[i];
...
# basic.c:1250: 				if (var == f->for_var)
	...
	jnz	.L271		#
# basic.c:1252: 					VAR *varaddr = ((VAR *)variables_begin) + var - 'A';
...
# basic.c:1253: 					*varaddr = *varaddr + f->step;
...
# basic.c:1255: 					if ((f->step > 0 && *varaddr <= f->terminal) || (f->step < 0 && *varaddr >= f->terminal))
...
# basic.c:1255: 					if ((f->step > 0 && *varaddr <= f->terminal) || (f->step < 0 && *varaddr >= f->terminal))
	...
	jss	.L277		#
.L276:
# basic.c:1258: 						txtpos = f->txtpos;
	ld.w	r0, [r13 + (-16)]	# tmp120, f
	ld.w	r0, [r0 + (16)]	# _34, f_58->txtpos
# basic.c:1258: 						txtpos = f->txtpos;
	st.w	[txtpos], r0	# txtpos, _34
# basic.c:1259: 						current_line = f->current_line;
	ld.w	r0, [r13 + (-16)]	# tmp121, f
	ld.w	r0, [r0 + (12)]	# _35, f_58->current_line
# basic.c:1259: 						current_line = f->current_line;
	st.w	[current_line], r0	# current_line, _35
# basic.c:1260: 						return 0;
	xor.w	r0, r0	# _45
	j	.L270		#
.L277:
# basic.c:1263: 					bsp = tempsp + sizeof(struct stack_for_frame);
	ld.w	r0, [tempsp]	# tempsp.215_36, tempsp
	add.w	r0, 20 #111	# _37,
# basic.c:1263: 					bsp = tempsp + sizeof(struct stack_for_frame);
	st.w	[bsp], r0	# bsp, _37
# basic.c:1264: 					return 0;
	xor.w	r0, r0	# _45
	j	.L270		#
.L271:
# basic.c:1268: 			tempsp += sizeof(struct stack_for_frame);
...
# basic.c:1269: 			break;
	j	.L266		#
.L268:
# basic.c:1271: 			printf("Stack is stuffed!\n");
	mov.w	r1, sp	# tmp122,
	mov.w	r0, .LC8	# tmp123,
	st.w	[r1], r0	#, tmp123
	call	puts		#
# basic.c:1272: 			return 1;
	mov.w	r0, 1	# _45,
	j	.L270		#
.L266:
# basic.c:1217: 	while (tempsp < program + kRamSize - 1)
...
exec_next:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:1283: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1287: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:1296: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1297: 	if (*txtpos != ':' && *txtpos != NL)
...
exec_gosub:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 28 #111	#,
# basic.c:1306: 	expression_error = 0;
	xor.w	r0, r0	# tmp39
	st.b	[expression_error], r0	# expression_error, tmp39
# basic.c:1307: 	linenum = expression();
	call	expression		#
	mov.w	r1, r0	# _1,
# basic.c:1307: 	linenum = expression();
	...
	call	__fixsfsi		#
	st.w	[linenum], r0	# linenum, _2
# basic.c:1308: 	if (!expression_error && *txtpos == NL)
...
# basic.c:1308: 	if (!expression_error && *txtpos == NL)
	...
	cmp.w	r1, r0	# tmp43, tmp44
	jnz	.L289		#
# basic.c:1311: 		if (bsp + sizeof(struct stack_gosub_frame) < stack_limit)
...
# basic.c:1322: 		current_line = findline();
	call	findline		#
# basic.c:1322: 		current_line = findline();
	st.w	[current_line], r0	# current_line, _13
# basic.c:1323: 		exec_run();
	call	exec_run		#
# basic.c:1324: 		return;
	j	.L288		#
.L289:
...
exec_input:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 32 #111	#,
# basic.c:1335: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1337: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:1344: 	txtpos++;
	...
	add.w	r0, 1 #111	# _7,
	st.w	[txtpos], r0	# txtpos, _7
# basic.c:1345: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1347: 	if (*txtpos != NL && *txtpos != ':')
...
# basic.c:1356: 		getln('?');
	...
	st.w	[r1], r0	#, tmp57
	call	getln		#
# basic.c:1357: 		toUppercaseBuffer();
	call	toUppercaseBuffer		#
# basic.c:1358: 		txtpos = program_end + sizeof(VAR);
	ld.w	r0, [program_end]	# program_end.238_13, program_end
	add.w	r0, 4 #111	# _14,
# basic.c:1358: 		txtpos = program_end + sizeof(VAR);
	st.w	[txtpos], r0	# txtpos, _14
# basic.c:1359: 		ignore_blanks();
	call	ignore_blanks		#
# basic.c:1360: 		expression_error = 0;
	xor.w	r0, r0	# tmp58
	st.b	[expression_error], r0	# expression_error, tmp58
# basic.c:1361: 		value = expression();
	call	expression		#
	st.w	[r13 + (-8)], r0	# value,
# basic.c:1362: 		if (!expression_error)
...
# basic.c:1363: 			break;
	nop	
# basic.c:1365: 	((VAR *)variables_begin)[var - 'A'] = value;
...
# basic.c:1375: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1376: 	expression_error = 0;
	xor.w	r0, r0	# tmp62
	st.b	[expression_error], r0	# expression_error, tmp62
# basic.c:1377: 	linenum = expression();
	call	expression		#
	mov.w	r1, r0	# _1,
# basic.c:1377: 	linenum = expression();
	...
	call	__fixsfsi		#
	st.w	[linenum], r0	# linenum, _2
# basic.c:1378: 	if (expression_error)
...
# basic.c:1380: 		qhow();
	call	qhow		#
# basic.c:1381: 		return 0;
	xor.w	r0, r0	# _33
	j	.L304		#
.L303:
# basic.c:1383: 	line = findline();
	call	findline		#
	st.w	[r13 + (-16)], r0	# line,
# basic.c:1384: 	if (line == program_end)
...
# basic.c:1386: 		qhow();
	call	qhow		#
# basic.c:1387: 		return 0;
	xor.w	r0, r0	# _33
	j	.L304		#
.L305:
# basic.c:1390: 	txtpos = program_end + sizeof(LINENUM);
	ld.w	r0, [program_end]	# program_end.244_5, program_end
	add.w	r0, 4 #111	# _6,
# basic.c:1390: 	txtpos = program_end + sizeof(LINENUM);
	st.w	[txtpos], r0	# txtpos, _6
# basic.c:1391: 	txtpos[0] = 0;
	ld.w	r0, [txtpos]	# txtpos.245_7, txtpos
# basic.c:1391: 	txtpos[0] = 0;
	xor.w	r1, r1	# tmp67
	st.b	[r0], r1	# *txtpos.245_7, tmp67
# basic.c:1392: 	sprintf(txtpos, "%d ", linenum);
	...
	call	sprintf		#
# basic.c:1393: 	j = strlen(txtpos);
	ld.w	r0, [txtpos]	# txtpos.248_10, txtpos
	mov.w	r1, sp	# tmp70,
	st.w	[r1], r0	#, txtpos.248_10
	call	strlen		#
	st.w	[r13 + (-12)], r0	# j,
# basic.c:1394: 	for (i = sizeof(VAR) + 1; i < line[sizeof(VAR)] - 1; i++)
	mov.w	r0, 5	# tmp71,
	st.w	[r13 + (-8)], r0	# i, tmp71
# basic.c:1394: 	for (i = sizeof(VAR) + 1; i < line[sizeof(VAR)] - 1; i++)
	j	.L306		#
.L307:
# basic.c:1397: 		txtpos[j++] = line[i];
...
# basic.c:1417: 	memcpy(to_print_buff, eth_buffer+off, len);
...
eth_read_file:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 40 #111	#,
# basic.c:1424: 	int len = 0;
	xor.w	r0, r0	# tmp44
	st.w	[r13 + (-4)], r0	# len, tmp44
# basic.c:1425: 	int init_offset = 0;
	xor.w	r0, r0	# tmp45
	st.w	[r13 + (-8)], r0	# init_offset, tmp45
# basic.c:1426: 	int size = 1000000;
	mov.w	r0, 1000000	# tmp46,
	st.w	[r13 + (-12)], r0	# size, tmp46
# basic.c:1427: 	int fail_count = 0;
	xor.w	r0, r0	# tmp47
	st.w	[r13 + (-16)], r0	# fail_count, tmp47
# basic.c:1428: 	printf("Loading file %s from the ethernet network drive\n", file_name);
	mov.w	r0, sp	# tmp48,
	...
	st.w	[r0], r1	#, tmp50
	call	printf		#
# basic.c:1429: 	to_print_len = 0;
	xor.w	r0, r0	# tmp51
	st.w	[to_print_len], r0	# to_print_len, tmp51
# basic.c:1430: 	asm ("irq 0\n"); // IRQ 0000, xxx0 <- turn off timer irq
# 1430 "basic.c" 1
	irq 0

# basic.c:1431: 	browseUrl("/load:", file_name, server_ip, 0, my_callback);
	mov.w	r0, sp	# tmp52,
...
# basic.c:1440: 				size |= to_print_buff[2];
...
# basic.c:1442: 				size |= to_print_buff[1];
...
# basic.c:1444: 				size |= to_print_buff[0];
...
# basic.c:1445: 				init_offset = 4;
	mov.w	r0, 4	# tmp79,
	st.w	[r13 + (-8)], r0	# init_offset, tmp79
# basic.c:1446: 				if (size == 0) {
	ld.w	r1, [r13 + (-12)]	# tmp80, size
	xor.w	r0, r0	# tmp81
	cmp.w	r1, r0	# tmp80, tmp81
	jnz	.L314		#
# basic.c:1447: 					printf("File %s does not exist\n", file_name);
	mov.w	r0, sp	# tmp82,
...
# basic.c:1454: 			printf("#");
	...
	st.w	[r1], r0	#, tmp90
	call	putchar		#
# basic.c:1455: 			fail_count = 0;
	xor.w	r0, r0	# tmp91
	st.w	[r13 + (-16)], r0	# fail_count, tmp91
# basic.c:1456: 			to_print_buff[to_print_len] = 0;
...
# basic.c:1457: 			memcpy(buffer + len, to_print_buff + init_offset, to_print_len);
...
# basic.c:1457: 			memcpy(buffer + len, to_print_buff + init_offset, to_print_len);
	...
	st.w	[r0], r1	#, _11
	call	memcpy		#
# basic.c:1458: 			len += to_print_len - init_offset;
...
# basic.c:1433: 	while (len < size) {
	...
	jss	.L317		#
.L315:
# basic.c:1473: 	asm ("irq 1\n"); // IRQ 0000, xxx1 <- turn on timer irq
# 1473 "basic.c" 1
	irq 1

# basic.c:1474: 	return len;
...
# basic.c:1491: 	if (eth)
	...
	jz	.L320		#
# basic.c:1492: 		mainLoop(eth_buffer);
	mov.w	r1, sp	# tmp28,
	mov.w	r0, eth_buffer	# tmp29,
	st.w	[r1], r0	#, tmp29
	call	mainLoop		#
.L320:
# basic.c:1495: 	asm("pop r13\npop r13\n");
# 1495 "basic.c" 1
	pop r13
pop r13
...
exec_load:
	...
	push	r6		#
	sub.w	sp, 168 #111	#,
# basic.c:1522: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1523: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:1526: 		return;
	j	.L323		#
.L325:
# basic.c:1530: 	for (i = 0; txtpos[i] != NL && txtpos[i] != CR && txtpos[i] != SPACE && txtpos[i] != TAB && i < 32; i++)
	xor.w	r0, r0	# tmp120
	st.w	[r13 + (-8)], r0	# i, tmp120
# basic.c:1530: 	for (i = 0; txtpos[i] != NL && txtpos[i] != CR && txtpos[i] != SPACE && txtpos[i] != TAB && i < 32; i++)
	j	.L327		#
.L329:
# basic.c:1533: 		s[i] = txtpos[i];
...
# basic.c:1535: 	s[i] = 0;
	...
	xor.w	r1, r1	# tmp139
	st.b	[r0], r1	# s, tmp139
# basic.c:1537: 	printf("Loading file: <%s>\n", s);
	mov.w	r0, sp	# tmp140,
	mov.w	r1, r13	# tmp141,
...
# basic.c:1538: 	if (drive == 2) {
	...
	jnz	.L330		#
# basic.c:1541: 		delay(100);
	mov.w	r1, sp	# tmp145,
	mov.w	r0, 100	# tmp146,
	st.w	[r1], r0	#, tmp146
	call	delay		#
# basic.c:1542: 		i = uart_read_file(buffer, s);
...
# basic.c:1544: 	} else if (drive == 0)
	...
	jnz	.L332		#
# basic.c:1548: load_load_again:		
	nop	
.L333:
# basic.c:1549: 		if(file_open(s, &fd, O_READ))
	mov.w	r0, sp	# tmp151,
	xor.w	r1, r1	# tmp152
	st.w	[r0 + (8)], r1	#, tmp152
	mov.w	r1, r13	# tmp153,
...
# basic.c:1549: 		if(file_open(s, &fd, O_READ))
	...
	cmp.w	r1, r0	# tmp155, tmp156
	jz	.L334		#
# basic.c:1551: 			int len = fd.dir_entry.filesize;
	ld.w	r0, [r13 + (-116)]	# _30, fd.dir_entry.filesize
# basic.c:1551: 			int len = fd.dir_entry.filesize;
	st.w	[r13 + (-32)], r0	# len, _30
# basic.c:1552: 			int total = 0;
	xor.w	r0, r0	# tmp157
	st.w	[r13 + (-20)], r0	# total, tmp157
# basic.c:1554: 			while(total < len)
	j	.L335		#
.L338:
# basic.c:1556: 				current = file_read(&fd, &buffer[total], 512);
...
# basic.c:1560: 						printf("#");
	...
	j	.L335		#
.L336:
# basic.c:1562: 					printf("Error reading file!\n");
	mov.w	r1, sp	# tmp172,
...
# basic.c:1572: 			strcpy(fileName, s);
	mov.w	r0, sp	# tmp178,
	mov.w	r1, r13	# tmp179,
	...
	st.w	[r0], r1	#, tmp180
	call	strcpy		#
# basic.c:1573: 			int sum = 0;
	xor.w	r0, r0	# tmp181
	st.w	[r13 + (-24)], r0	# sum, tmp181
# basic.c:1574: 			for (int j = 0; j < i; j++) {
	xor.w	r0, r0	# tmp182
	st.w	[r13 + (-28)], r0	# j, tmp182
# basic.c:1574: 			for (int j = 0; j < i; j++) {
	j	.L339		#
.L340:
# basic.c:1575: 				sum += buffer[j];
...
# basic.c:1577: 			printf("\nSum: %d\n", sum);
	...
	j	.L331		#
.L334:
# basic.c:1580: 			printf("SD card file open failed\n");
	mov.w	r1, sp	# tmp192,
...
# basic.c:1581: 			return;
	j	.L323		#
.L332:
# basic.c:1586: 		i = eth_read_file(buffer, s);
...
# basic.c:1589: 	if (i > 0)
	...
	jses	.L341		#
# basic.c:1591: 		printf("File size: %d\n", i);
	mov.w	r0, sp	# tmp198,
	...
	st.w	[r0], r1	#, tmp200
	call	printf		#
# basic.c:1592: 		if (strstr(s, ".BIN") != (char *)0) 
	mov.w	r0, sp	# tmp201,
...
# basic.c:1592: 		if (strstr(s, ".BIN") != (char *)0) 
	...
	jz	.L342		#
# basic.c:1594: 			printf("Loaded executable file. Run it using: SYS 0\n");
	mov.w	r1, sp	# tmp205,
...
# basic.c:1595: 			return;
	j	.L323		#
.L342:
# basic.c:1596: 		} else if (strstr(s, ".BAS") == (char *)0) 
	mov.w	r0, sp	# tmp207,
...
# basic.c:1596: 		} else if (strstr(s, ".BAS") == (char *)0) 
	...
	jnz	.L343		#
# basic.c:1598: 			printf("Loaded successfuly at address 0 (reachable by PEEK and POKE).\n");
	mov.w	r1, sp	# tmp211,
...
# basic.c:1599: 			return;
	j	.L323		#
.L343:
# basic.c:1601: 		program_end = program_start;
...
# basic.c:1603: 		for (j = 0; j <= i; j++)
	xor.w	r0, r0	# tmp214
	st.w	[r13 + (-12)], r0	# j, tmp214
# basic.c:1603: 		for (j = 0; j <= i; j++)
	j	.L344		#
.L349:
# basic.c:1605: 			if (buffer[j] == CR)
...
.L345:
# basic.c:1609: 			if (buffer[j] == NL || buffer[j] == 0)
...
# basic.c:1609: 			if (buffer[j] == NL || buffer[j] == 0)
	...
	jnz	.L347		#
.L346:
# basic.c:1611: 				txtpos = program_end + sizeof(LINENUM);
	ld.w	r0, [program_end]	# program_end.306_67, program_end
	add.w	r0, 4 #111	# _68,
# basic.c:1611: 				txtpos = program_end + sizeof(LINENUM);
	st.w	[txtpos], r0	# txtpos, _68
# basic.c:1612: 				strncpy(txtpos, &buffer[k], j);
...
.L348:
# basic.c:1619: 				toUppercaseBuffer();
	call	toUppercaseBuffer		#
# basic.c:1620: 				skip_to_end();
	call	skip_to_end		#
# basic.c:1621: 				linenum = testnum();
	call	testnum		#
	mov.w	r1, r0	# _86,
# basic.c:1621: 				linenum = testnum();
...
# basic.c:1622: 				if (linenum > 0)
	ld.w	r1, [linenum]	# linenum.315_88, linenum
# basic.c:1622: 				if (linenum > 0)
	xor.w	r0, r0	# tmp240
	cmp.w	r1, r0	# linenum.315_88, tmp240
	jses	.L347		#
# basic.c:1626: 					ignore_blanks();
	call	ignore_blanks		#
# basic.c:1627: 					entered_with_line_num();
...
# basic.c:1603: 		for (j = 0; j <= i; j++)
	...
	jses	.L349		#
# basic.c:1631: 		printf("OK loading file %s\n", s);
	mov.w	r0, sp	# tmp245,
	mov.w	r1, r13	# tmp246,
	...
	j	.L323		#
.L341:
# basic.c:1635: 		printf("Error loading file %s\n", s);
	mov.w	r0, sp	# tmp248,
	mov.w	r1, r13	# tmp249,
...
# basic.c:1648: 	sprintf(s, "%d ", line_num);
	...
	st.w	[r0], r1	#, tmp54
	call	sprintf		#
# basic.c:1649: 	strcpy(&buffer[i], s);
...
# basic.c:1651: 	while (*list_line != NL)
	j	.L353		#
.L354:
# basic.c:1653: 		buffer[i] = *list_line;
...
# basic.c:1667: 	printf("\nSaving to SD card...\n");
	...
	st.w	[r1], r0	#, tmp37
	call	puts		#
# basic.c:1668: 	int res = file_open(file_name, &fd, O_WRITE);
	mov.w	r0, sp	# tmp38,
	mov.w	r1, 1	# tmp39,
	st.w	[r0 + (8)], r1	#, tmp39
	mov.w	r1, r13	# tmp40,
...
# basic.c:1669: 	if (res)
	...
	cmp.w	r1, r0	# tmp43, tmp44
	jz	.L357		#
# basic.c:1671: 		int i, curr, total = 0, count = len /512 + 1;
	xor.w	r0, r0	# tmp45
...
# basic.c:1672: 		for (i = 0; i < count; i++)
	xor.w	r0, r0	# tmp53
	st.w	[r13 + (-4)], r0	# i, tmp53
# basic.c:1672: 		for (i = 0; i < count; i++)
	j	.L359		#
.L364:
# basic.c:1674: 			curr = file_write(&fd, &buff[total], len > 512 ? 512 : len);
...
# basic.c:1684: 		printf("\n");
	...
	j	.L365		#
.L357:
# basic.c:1688: 		printf("Could not open file for save.\n");
	mov.w	r1, sp	# tmp75,
	mov.w	r0, .LC26	# tmp76,
	st.w	[r1], r0	#, tmp76
	call	puts		#
.L365:
# basic.c:1690: 	return 1;	
	mov.w	r0, 1	# _33,
# basic.c:1691: }
	mov.w	sp, r13	#,
	pop	r13		#
...
eth_write_file:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:1695: 	printf("Saving file %s of %d bytes to the ethernet network drive\n", file_name, len);
	mov.w	r0, sp	# tmp27,
...
exec_save:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 64 #111	#,
# basic.c:1703: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1704: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:1706: 		qwhat();
	...
	j	.L369		#
.L371:
# basic.c:1710: 	int spi = 0;
	xor.w	r0, r0	# tmp59
	st.w	[r13 + (-8)], r0	# spi, tmp59
# basic.c:1711: 	for (i = 0; txtpos[i] != NL && txtpos[i] != SPACE && txtpos[i] != TAB; i++)
	xor.w	r0, r0	# tmp60
	st.w	[r13 + (-4)], r0	# i, tmp60
# basic.c:1711: 	for (i = 0; txtpos[i] != NL && txtpos[i] != SPACE && txtpos[i] != TAB; i++)
	j	.L373		#
.L375:
# basic.c:1713: 		s[i] = txtpos[i];
...
# basic.c:1715: 	s[i] = 0;
	...
	xor.w	r1, r1	# tmp75
	st.b	[r0], r1	# s, tmp75
# basic.c:1716: 	printf("Filename: <%s>\n", s);
	mov.w	r0, sp	# tmp76,
	mov.w	r1, r13	# tmp77,
	...
	st.w	[r0], r1	#, tmp78
	call	printf		#
# basic.c:1719: 	list_line = findline();
	call	findline		#
# basic.c:1719: 	list_line = findline();
...
# basic.c:1721: 	while (list_line < program_end)
	j	.L376		#
.L377:
# basic.c:1723: 		i = sprintline(i);
	mov.w	r1, sp	# tmp80,
...
# basic.c:1725: 	if (drive == 0) {
	...
	cmp.w	r1, r0	# tmp82, tmp83
	jnz	.L378		#
# basic.c:1727: 		sd_write_file(buffer, i, s);
...
# basic.c:1728: 	} else if (drive == 2) {
	...
	cmp.w	r1, r0	# tmp87, tmp88
	jnz	.L380		#
# basic.c:1730: 		uart_write_file(buffer, i, s);
	...
	j	.L379		#
.L380:
# basic.c:1734: 		eth_write_file(buffer, i, s);
	...
	call	eth_write_file		#
.L379:
# basic.c:1736: 	printf("OK saving file %s, length: %d\n", s, i);
	mov.w	r0, sp	# tmp95,
...
# basic.c:1754: 		while ((next = getDirEntry(&fd, next)) != 0)
	...
	j	.L381		#
.L384:
# basic.c:1761: 		to_print_len = 0;
	xor.w	r0, r0	# tmp53
	st.w	[to_print_len], r0	# to_print_len, tmp53
# basic.c:1762: 		browseUrl("/dir", "", server_ip, 0, my_callback);
	mov.w	r0, sp	# tmp54,
	...
	st.w	[r0], r1	#, tmp59
	call	browseUrl		#
# basic.c:1763: 		delay(100);
	mov.w	r1, sp	# tmp60,
	mov.w	r0, 100	# tmp61,
	st.w	[r1], r0	#, tmp61
	call	delay		#
# basic.c:1764: 		for (i = 0; i < 1000; i++) {
	xor.w	r0, r0	# tmp62
	st.w	[r13 + (-4)], r0	# i, tmp62
# basic.c:1764: 		for (i = 0; i < 1000; i++) {
	j	.L387		#
.L389:
# basic.c:1767: 			if (to_print_len > 0) {
	ld.w	r1, [to_print_len]	# to_print_len.351_12, to_print_len
# basic.c:1767: 			if (to_print_len > 0) {
	xor.w	r0, r0	# tmp63
	cmp.w	r1, r0	# to_print_len.351_12, tmp63
	jses	.L388		#
# basic.c:1768: 				to_print_buff[to_print_len] = 0;
...
# basic.c:1769: 				printf("%s\n", to_print_buff);
	mov.w	r1, sp	# tmp67,
	mov.w	r0, to_print_buff	# tmp68,
	st.w	[r1], r0	#, tmp68
	call	puts		#
# basic.c:1770: 				to_print_len = 0;
	xor.w	r0, r0	# tmp69
	st.w	[to_print_len], r0	# to_print_len, tmp69
# basic.c:1771: 				return;
	j	.L381		#
.L388:
# basic.c:1773: 			  delay(10);
	mov.w	r1, sp	# tmp70,
	mov.w	r0, 10	# tmp71,
	st.w	[r1], r0	#, tmp71
	call	delay		#
...
# basic.c:1764: 		for (i = 0; i < 1000; i++) {
	...
	jses	.L389		#
# basic.c:1775: 		printf("NETWORK TIMEOUT\n");
	mov.w	r1, sp	# tmp76,
	mov.w	r0, .LC33	# tmp77,
	st.w	[r1], r0	#, tmp77
	call	puts		#
...
exec_mode:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 28 #111	#,
# basic.c:1783: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1784: 	expression_error = 0;
	xor.w	r0, r0	# tmp29
	st.b	[expression_error], r0	# expression_error, tmp29
# basic.c:1785: 	value = expression();	
	call	expression		#
	st.w	[r13 + (-4)], r0	# value,
# basic.c:1786: 	if (expression_error)
...
# basic.c:1805: 			break;
	j	.L390		#
.L394:
# basic.c:1807: 			video_mode(0);
	mov.w	r1, sp	# tmp43,
	xor.w	r0, r0	# tmp44
	st.w	[r1], r0	#, tmp44
	call	video_mode		#
# basic.c:1809: 			printf("Invalid video mode: %d\n", value);
...
exec_plot:
	...
	push	r7		#
	sub.w	sp, 36 #111	#,
# basic.c:1817: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1818: 	expression_error = 0;
	xor.w	r0, r0	# tmp40
	st.b	[expression_error], r0	# expression_error, tmp40
# basic.c:1819: 	x = expression();	
	call	expression		#
	st.w	[r13 + (-12)], r0	# x,
# basic.c:1820: 	if (expression_error)
...
# basic.c:1823: 		return;
	j	.L397		#
.L398:
# basic.c:1825: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1826: 	if (*txtpos != ',')
...
# basic.c:1833: 		txtpos++;
	...
	add.w	r0, 1 #111	# _5,
	st.w	[txtpos], r0	# txtpos, _5
# basic.c:1835: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1836: 	expression_error = 0;
	xor.w	r0, r0	# tmp45
	st.b	[expression_error], r0	# expression_error, tmp45
# basic.c:1837: 	y = expression();	
	call	expression		#
	st.w	[r13 + (-16)], r0	# y,
# basic.c:1838: 	if (expression_error)
...
# basic.c:1841: 		return;
	j	.L397		#
.L401:
# basic.c:1843: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1844: 	if (*txtpos != ',')
...
# basic.c:1853: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1854: 	expression_error = 0;
	xor.w	r0, r0	# tmp50
	st.b	[expression_error], r0	# expression_error, tmp50
# basic.c:1855: 	c = expression();	
	call	expression		#
	st.w	[r13 + (-20)], r0	# c,
# basic.c:1856: 	if (expression_error)
...
# basic.c:1859: 		return;
	j	.L397		#
.L403:
# basic.c:1862: 	pixel((int)x, (int)y, (int)c);
...
# basic.c:1904: 		txtpos++;
	...
	add.w	r0, 1 #111	# _10,
	st.w	[txtpos], r0	# txtpos, _10
# basic.c:1906: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1907: 	expression_error = 0;
	xor.w	r0, r0	# tmp62
	st.b	[expression_error], r0	# expression_error, tmp62
# basic.c:1908: 	x2 = expression();	
	call	expression		#
	st.w	[r13 + (-28)], r0	# x2,
# basic.c:1909: 	if (expression_error)
...
# basic.c:1924: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1925: 	expression_error = 0;
	xor.w	r0, r0	# tmp67
	st.b	[expression_error], r0	# expression_error, tmp67
# basic.c:1926: 	y2 = expression();	
	call	expression		#
	st.w	[r13 + (-32)], r0	# y2,
# basic.c:1927: 	if (expression_error)
...
# basic.c:1943: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1944: 	expression_error = 0;
	xor.w	r0, r0	# tmp72
	st.b	[expression_error], r0	# expression_error, tmp72
# basic.c:1945: 	c = expression();	
	call	expression		#
	st.w	[r13 + (-36)], r0	# c,
# basic.c:1946: 	if (expression_error)
...
# basic.c:1949: 		return;
	j	.L404		#
.L414:
# basic.c:1952: 	line((int)x1, (int)y1, (int)x2, (int)y2, (int)c);
...
exec_circle:
	...
	push	r8		#
	sub.w	sp, 40 #111	#,
# basic.c:1960: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1961: 	expression_error = 0;
	xor.w	r0, r0	# tmp46
	st.b	[expression_error], r0	# expression_error, tmp46
# basic.c:1962: 	x = expression();	
	call	expression		#
	st.w	[r13 + (-16)], r0	# x,
# basic.c:1963: 	if (expression_error)
...
# basic.c:1976: 		txtpos++;
	...
	add.w	r0, 1 #111	# _5,
	st.w	[txtpos], r0	# txtpos, _5
# basic.c:1978: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1979: 	expression_error = 0;
	xor.w	r0, r0	# tmp51
	st.b	[expression_error], r0	# expression_error, tmp51
# basic.c:1980: 	y = expression();	
	call	expression		#
	st.w	[r13 + (-20)], r0	# y,
# basic.c:1981: 	if (expression_error)
...
# basic.c:1994: 		txtpos++;
	...
	add.w	r0, 1 #111	# _10,
	st.w	[txtpos], r0	# txtpos, _10
# basic.c:1996: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1997: 	expression_error = 0;
	xor.w	r0, r0	# tmp56
	st.b	[expression_error], r0	# expression_error, tmp56
# basic.c:1998: 	r = expression();	
	call	expression		#
	st.w	[r13 + (-24)], r0	# r,
# basic.c:1999: 	if (expression_error)
...
# basic.c:2012: 		txtpos++;
	...
	add.w	r0, 1 #111	# _15,
	st.w	[txtpos], r0	# txtpos, _15
# basic.c:2014: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2015: 	expression_error = 0;
	xor.w	r0, r0	# tmp61
	st.b	[expression_error], r0	# expression_error, tmp61
# basic.c:2016: 	c = expression();	
	call	expression		#
	st.w	[r13 + (-28)], r0	# c,
# basic.c:2017: 	if (expression_error)
...
# basic.c:2020: 		return;
	j	.L415		#
.L423:
# basic.c:2023: 	circle((int)x, (int)y, (int)r, (int)c);
...
exec_draw:
	...
	push	r7		#
	sub.w	sp, 140 #111	#,
# basic.c:2032: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2033: 	expression_error = 0;
	xor.w	r0, r0	# tmp63
	st.b	[expression_error], r0	# expression_error, tmp63
# basic.c:2034: 	x = expression();	
	call	expression		#
	st.w	[r13 + (-16)], r0	# x,
# basic.c:2035: 	if (expression_error)
...
# basic.c:2048: 		txtpos++;
	...
	add.w	r0, 1 #111	# _5,
	st.w	[txtpos], r0	# txtpos, _5
# basic.c:2050: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2051: 	expression_error = 0;
	xor.w	r0, r0	# tmp68
	st.b	[expression_error], r0	# expression_error, tmp68
# basic.c:2052: 	y = expression();	
	call	expression		#
	st.w	[r13 + (-20)], r0	# y,
# basic.c:2053: 	if (expression_error)
...
# basic.c:2066: 		txtpos++;
	...
	add.w	r0, 1 #111	# _10,
	st.w	[txtpos], r0	# txtpos, _10
# basic.c:2068: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2069: 	expression_error = 0;
	xor.w	r0, r0	# tmp73
	st.b	[expression_error], r0	# expression_error, tmp73
# basic.c:2070: 	c = expression();	
	call	expression		#
	st.w	[r13 + (-24)], r0	# c,
# basic.c:2071: 	if (expression_error)
...
# basic.c:2094: 	while (*txtpos != NL && *txtpos != 0)
	j	.L433		#
.L437:
# basic.c:2096: 		if (*txtpos == '"' || *txtpos == '\'')
...
# basic.c:2094: 	while (*txtpos != NL && *txtpos != 0)
	...
	jnz	.L437		#
.L436:
# basic.c:2105: 	draw((int)x, (int)y, (int)c, s);
...
exec_help:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:2110: 	printf("END\n");
	mov.w	r1, sp	# tmp26,
	mov.w	r0, .LC35	# tmp27,
	st.w	[r1], r0	#, tmp27
	call	puts		#
# basic.c:2111: 	printf("MEM\n");
	mov.w	r1, sp	# tmp28,
	mov.w	r0, .LC36	# tmp29,
	st.w	[r1], r0	#, tmp29
	call	puts		#
# basic.c:2112: 	printf("LET I = 5\n");
	mov.w	r1, sp	# tmp30,
	mov.w	r0, .LC37	# tmp31,
	st.w	[r1], r0	#, tmp31
	call	puts		#
# basic.c:2113: 	printf("I = 5\n");
	mov.w	r1, sp	# tmp32,
	mov.w	r0, .LC38	# tmp33,
	st.w	[r1], r0	#, tmp33
	call	puts		#
# basic.c:2114: 	printf("INPUT A\n");
	mov.w	r1, sp	# tmp34,
	mov.w	r0, .LC39	# tmp35,
	st.w	[r1], r0	#, tmp35
	call	puts		#
# basic.c:2115: 	printf("PRINT A\n");
	mov.w	r1, sp	# tmp36,
	mov.w	r0, .LC40	# tmp37,
	st.w	[r1], r0	#, tmp37
	call	puts		#
# basic.c:2116: 	printf("? A\n");
	mov.w	r1, sp	# tmp38,
	mov.w	r0, .LC41	# tmp39,
	st.w	[r1], r0	#, tmp39
	call	puts		#
# basic.c:2117: 	printf("FOR I = 1 TO 10 STEP 2\n");
	mov.w	r1, sp	# tmp40,
	mov.w	r0, .LC42	# tmp41,
	st.w	[r1], r0	#, tmp41
	call	puts		#
# basic.c:2118: 	printf("NEXT I\n");
	mov.w	r1, sp	# tmp42,
	mov.w	r0, .LC43	# tmp43,
	st.w	[r1], r0	#, tmp43
	call	puts		#
# basic.c:2119: 	printf("IF I = 5 GOTO 100\n");
	mov.w	r1, sp	# tmp44,
	mov.w	r0, .LC44	# tmp45,
	st.w	[r1], r0	#, tmp45
	call	puts		#
# basic.c:2120: 	printf("GOTO 100\n");
	mov.w	r1, sp	# tmp46,
	mov.w	r0, .LC45	# tmp47,
	st.w	[r1], r0	#, tmp47
	call	puts		#
# basic.c:2121: 	printf("GOSUB 100\n");
	mov.w	r1, sp	# tmp48,
	mov.w	r0, .LC46	# tmp49,
	st.w	[r1], r0	#, tmp49
	call	puts		#
# basic.c:2122: 	printf("RETURN\n");
	mov.w	r1, sp	# tmp50,
	mov.w	r0, .LC47	# tmp51,
	st.w	[r1], r0	#, tmp51
	call	puts		#
# basic.c:2123: 	printf("LOAD P1.BAS\n");
	mov.w	r1, sp	# tmp52,
	mov.w	r0, .LC48	# tmp53,
	st.w	[r1], r0	#, tmp53
	call	puts		#
# basic.c:2124: 	printf("SAVE P2.BAS\n");
	mov.w	r1, sp	# tmp54,
	mov.w	r0, .LC49	# tmp55,
	st.w	[r1], r0	#, tmp55
	call	puts		#
# basic.c:2125: 	printf("MODE 0 (MODE 1, MODE 2)\n");
	mov.w	r1, sp	# tmp56,
	mov.w	r0, .LC50	# tmp57,
	st.w	[r1], r0	#, tmp57
	call	puts		#
# basic.c:2126: 	printf("PLOT 100, 100, color\n");
	mov.w	r1, sp	# tmp58,
	mov.w	r0, .LC51	# tmp59,
	st.w	[r1], r0	#, tmp59
	call	puts		#
# basic.c:2127: 	printf("LINE 100, 100, 200, 200, color\n");
	mov.w	r1, sp	# tmp60,
	mov.w	r0, .LC52	# tmp61,
	st.w	[r1], r0	#, tmp61
	call	puts		#
# basic.c:2128: 	printf("CIRCLE 100, 100, 50, color\n");
	mov.w	r1, sp	# tmp62,
	mov.w	r0, .LC53	# tmp63,
	st.w	[r1], r0	#, tmp63
	call	puts		#
# basic.c:2129: 	printf("DRAW 100, 100, color, 'TEXT'\n");
	mov.w	r1, sp	# tmp64,
	mov.w	r0, .LC54	# tmp65,
	st.w	[r1], r0	#, tmp65
	call	puts		#
# basic.c:2130: 	printf("A = KEY()\n");
	mov.w	r1, sp	# tmp66,
	mov.w	r0, .LC55	# tmp67,
	st.w	[r1], r0	#, tmp67
	call	puts		#
# basic.c:2131: 	printf("A = ISKEY()\n");
	mov.w	r1, sp	# tmp68,
	mov.w	r0, .LC56	# tmp69,
	st.w	[r1], r0	#, tmp69
	call	puts		#
# basic.c:2132: 	printf("DELAY 1000\n");
	mov.w	r1, sp	# tmp70,
	mov.w	r0, .LC57	# tmp71,
	st.w	[r1], r0	#, tmp71
	call	puts		#
# basic.c:2133: 	printf("CURSOR 10, 10\n");
	mov.w	r1, sp	# tmp72,
	mov.w	r0, .LC58	# tmp73,
	st.w	[r1], r0	#, tmp73
	call	puts		#
# basic.c:2134: 	printf("EXEC TEST.BIN\n");
	mov.w	r1, sp	# tmp74,
	mov.w	r0, .LC59	# tmp75,
	st.w	[r1], r0	#, tmp75
	call	puts		#
# basic.c:2135: 	printf("SYS 0\n");
	mov.w	r1, sp	# tmp76,
	mov.w	r0, .LC60	# tmp77,
	st.w	[r1], r0	#, tmp77
	call	puts		#
# basic.c:2136: 	printf("DRIVE 0 (SD) or DRIVE 1 (ETHERNET) or DRIVE 2 (UART)\n");
	mov.w	r1, sp	# tmp78,
	mov.w	r0, .LC61	# tmp79,
	st.w	[r1], r0	#, tmp79
	call	puts		#
# basic.c:2137: 	printf("TIME\n");
	mov.w	r1, sp	# tmp80,
	mov.w	r0, .LC62	# tmp81,
	st.w	[r1], r0	#, tmp81
	call	puts		#
# basic.c:2138: 	printf("ETH 1 or ETH 0\n");
	mov.w	r1, sp	# tmp82,
	mov.w	r0, .LC63	# tmp83,
	st.w	[r1], r0	#, tmp83
	call	puts		#
...
exec_delay:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 28 #111	#,
# basic.c:2145: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2146: 	expression_error = 0;
	xor.w	r0, r0	# tmp28
	st.b	[expression_error], r0	# expression_error, tmp28
# basic.c:2147: 	d = expression();	
	call	expression		#
	st.w	[r13 + (-4)], r0	# d,
# basic.c:2148: 	if (expression_error)
...
# basic.c:2160: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2161: 	expression_error = 0;
	xor.w	r0, r0	# tmp34
	st.b	[expression_error], r0	# expression_error, tmp34
# basic.c:2162: 	x = expression();	
	call	expression		#
	st.w	[r13 + (-8)], r0	# x,
# basic.c:2163: 	if (expression_error)
...
# basic.c:2178: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2179: 	expression_error = 0;
	xor.w	r0, r0	# tmp39
	st.b	[expression_error], r0	# expression_error, tmp39
# basic.c:2180: 	y = expression();	
	call	expression		#
	st.w	[r13 + (-12)], r0	# y,
# basic.c:2181: 	if (expression_error)
...
exec_poke:
	...
	push	r7		#
	sub.w	sp, 32 #111	#,
# basic.c:2194: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2195: 	expression_error = 0;
	xor.w	r0, r0	# tmp38
	st.b	[expression_error], r0	# expression_error, tmp38
# basic.c:2196: 	addr = expression();	
	call	expression		#
	st.w	[r13 + (-12)], r0	# addr,
# basic.c:2197: 	if (expression_error)
...
# basic.c:2200: 		return;
	j	.L448		#
.L449:
# basic.c:2202: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2203: 	if (*txtpos != ',')
...
# basic.c:2210: 		txtpos++;
	...
	add.w	r0, 1 #111	# _5,
	st.w	[txtpos], r0	# txtpos, _5
# basic.c:2212: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2213: 	expression_error = 0;
	xor.w	r0, r0	# tmp43
	st.b	[expression_error], r0	# expression_error, tmp43
# basic.c:2214: 	value = expression();	
	call	expression		#
	st.w	[r13 + (-16)], r0	# value,
# basic.c:2215: 	if (expression_error)
...
# basic.c:2218: 		return;
	j	.L448		#
.L452:
# basic.c:2221: 	buffer[(int)addr] = (int)value & 0XFF;
...
# basic.c:2226: 	if(!sdcard_init())
	...
	jnz	.L454		#
# basic.c:2228: 		printf("SD card init failed!\n");
	mov.w	r1, sp	# tmp30,
	mov.w	r0, .LC64	# tmp31,
	st.w	[r1], r0	#, tmp31
	call	puts		#
...
# basic.c:2231: 	if (!volume_init(1))
	...
	cmp.w	r1, r0	# tmp34, tmp35
	jnz	.L453		#
# basic.c:2233: 		printf("SD card volume failed!\n");
	mov.w	r1, sp	# tmp36,
	mov.w	r0, .LC65	# tmp37,
	st.w	[r1], r0	#, tmp37
	call	puts		#
...
# basic.c:2242: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2243: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:2246: 		return;
	j	.L456		#
.L458:
# basic.c:2250: 	for (i = 0; txtpos[i] != NL && txtpos[i] != CR && txtpos[i] != SPACE && txtpos[i] != TAB &&  i < 32; i++)
	xor.w	r0, r0	# tmp79
	st.w	[r13 + (-4)], r0	# i, tmp79
# basic.c:2250: 	for (i = 0; txtpos[i] != NL && txtpos[i] != CR && txtpos[i] != SPACE && txtpos[i] != TAB &&  i < 32; i++)
	j	.L460		#
.L462:
# basic.c:2253: 		s[i] = txtpos[i];
...
# basic.c:2258: 	printf("Loading program: [%s]\n", s);
	mov.w	r0, sp	# tmp100,
	mov.w	r1, r13	# tmp101,
...
# basic.c:2259: 	if (drive == 0)
	...
	jnz	.L463		#
# basic.c:2263: load_again:		
	nop	
.L464:
# basic.c:2264: 		if(file_open(s, &fd, O_READ))
	mov.w	r0, sp	# tmp105,
	xor.w	r1, r1	# tmp106
	st.w	[r0 + (8)], r1	#, tmp106
	mov.w	r1, r13	# tmp107,
...
# basic.c:2264: 		if(file_open(s, &fd, O_READ))
	...
	jz	.L465		#
# basic.c:2266: 			int len = fd.dir_entry.filesize;
	ld.w	r0, [r13 + (-104)]	# _28, fd.dir_entry.filesize
# basic.c:2266: 			int len = fd.dir_entry.filesize;
	st.w	[r13 + (-20)], r0	# len, _28
# basic.c:2267: 			int total = 0;
	xor.w	r0, r0	# tmp111
	st.w	[r13 + (-8)], r0	# total, tmp111
# basic.c:2269: 			while(total < len)
	j	.L466		#
.L469:
# basic.c:2271: 				current = file_read(&fd, &buffer[total], 512);
...
# basic.c:2275: 						printf("#");
	...
	j	.L466		#
.L467:
# basic.c:2278: 					printf("Error reading file!\n");
	mov.w	r1, sp	# tmp126,
...
# basic.c:2288: 			strcpy(fileName, s);
	mov.w	r0, sp	# tmp132,
	mov.w	r1, r13	# tmp133,
	...
	st.w	[r0], r1	#, tmp134
	call	strcpy		#
# basic.c:2289: 			int sum = 0;
	xor.w	r0, r0	# tmp135
	st.w	[r13 + (-12)], r0	# sum, tmp135
# basic.c:2290: 			for (int j = 0; j < i; j++) {
	xor.w	r0, r0	# tmp136
	st.w	[r13 + (-16)], r0	# j, tmp136
# basic.c:2290: 			for (int j = 0; j < i; j++) {
	j	.L470		#
.L471:
# basic.c:2291: 				sum += buffer[j];
...
# basic.c:2293: 			printf("\nSum: %d\n", sum);
	...
	j	.L472		#
.L465:
# basic.c:2297: 			printf("File open failed for file: [%s]\n", s);
	mov.w	r0, sp	# tmp146,
	mov.w	r1, r13	# tmp147,
...
# basic.c:2301: 	else if (drive == 2)
	...
	cmp.w	r1, r0	# tmp149, tmp150
	jnz	.L473		#
# basic.c:2305: 		delay(100);
	mov.w	r1, sp	# tmp151,
	mov.w	r0, 100	# tmp152,
	st.w	[r1], r0	#, tmp152
	call	delay		#
# basic.c:2306: 		i = uart_read_file(buffer, s);
	...
	j	.L472		#
.L473:
# basic.c:2310: 		i = eth_read_file(buffer, s);
...
# basic.c:2312: 	if (i > 0) 
	...
	cmp.w	r1, r0	# tmp157, tmp158
	jses	.L474		#
# basic.c:2315: 		int old_color = color;
	ld.w	r0, [color]	# tmp159, color
	st.w	[r13 + (-28)], r0	# old_color, tmp159
# basic.c:2316: 		asm("mov.w r0, 197632\ncallr r0\n"); //asm("call 197632\n");
# 2316 "basic.c" 1
	mov.w r0, 197632
callr r0

# basic.c:2317: 		init_stdio();
	call	init_stdio		#
# basic.c:2318: 		video_mode(0);
	mov.w	r1, sp	# tmp160,
	xor.w	r0, r0	# tmp161
	st.w	[r1], r0	#, tmp161
	call	video_mode		#
# basic.c:2319: 		color = old_color;
	ld.w	r0, [r13 + (-28)]	# tmp162, old_color
	st.w	[color], r0	# color, tmp162
# basic.c:2322: 		uart_init_files();
...
# basic.c:2323: 		if (eth)
	...
	jz	.L456		#
# basic.c:2325: 			init_spi();
	call	init_spi		#
# basic.c:2326: 			init_net();
	call	init_net		#
# basic.c:2327: 			init_sd();
	call	init_sd		#
	j	.L456		#
.L474:
# basic.c:2332: 		printf("Error loading program %s\n", s);
	mov.w	r0, sp	# tmp164,
	mov.w	r1, r13	# tmp165,
...
# basic.c:2341: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2342: 	expression_error = 0;
	xor.w	r0, r0	# tmp29
	st.b	[expression_error], r0	# expression_error, tmp29
# basic.c:2343: 	addr = (int)expression();	
	call	expression		#
	mov.w	r1, r0	# _1,
# basic.c:2343: 	addr = (int)expression();	
...
# basic.c:2344: 	if (expression_error)
...
# basic.c:2359: 	if (eth)
	...
	jz	.L477		#
# basic.c:2361: 		init_spi();
	call	init_spi		#
# basic.c:2362: 		init_net();
	call	init_net		#
# basic.c:2363: 		init_sd();
	call	init_sd		#
.L477:
# basic.c:2365: }
	mov.w	sp, r13	#,
...
exec_drive:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:2369: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2370: 	if (*txtpos == NL)
...
# basic.c:2373: 		return;
	j	.L481		#
.L482:
# basic.c:2375: 	if (*txtpos < '0' || *txtpos > '9')
...
# basic.c:2381: 	if (drive >= 0 && drive <= 2)
...
# basic.c:2382: 		printf("DRIVE: %d\n", drive);
	...
	j	.L481		#
.L486:
# basic.c:2385: 		printf("Invalid drive number: %d. Can be from 0 to 2.\n", drive);
...
exec_eth:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:2392: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2393: 	if (*txtpos == NL)
...
# basic.c:2393: 	if (*txtpos == NL)
	...
	cmp.w	r1, r0	# tmp42, tmp43
	jnz	.L488		#
# basic.c:2395: 		printf("ETHERNET: %d\n", eth);
...
# basic.c:2396: 		return;
	j	.L487		#
.L488:
# basic.c:2398: 	if (*txtpos < '0' || *txtpos > '9')
...
# basic.c:2404: 	if (eth >= 0 && eth <= 1) 
	...
	jgs	.L492		#
# basic.c:2406: 		printf("ETHERNET: %d\n", eth);
	...
	st.w	[r0], r1	#, tmp53
	call	printf		#
# basic.c:2408: 		if (eth == 1) 
	ld.w	r1, [eth]	# eth.455_15, eth
# basic.c:2408: 		if (eth == 1) 
	mov.w	r0, 1	# tmp54,
	cmp.w	r1, r0	# eth.455_15, tmp54
	jnz	.L493		#
# basic.c:2410: 			asm ("irq 1\n"); // IRQ 0000, xxx1 <- turn ON timer irq
# 2410 "basic.c" 1
	irq 1

# basic.c:2411: 			init_net();
	call	init_net		#
# basic.c:2408: 		if (eth == 1) 
	j	.L487		#
.L493:
# basic.c:2415: 			asm ("irq 0\n"); // IRQ 0000, xxx0 <- turn OFF timer irq
# 2415 "basic.c" 1
	irq 0

# basic.c:2416: 			de_init_timer();
	call	de_init_timer		#
# basic.c:2408: 		if (eth == 1) 
	j	.L487		#
.L492:
# basic.c:2423: 		printf("Invalid ethernet value: %d. Can be 0 or 1.\n", eth);
...
exec_color:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 60 #111	#,
# basic.c:2431: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2432: 	if (*txtpos == NL)
...
# basic.c:2435: 		return;
	j	.L495		#
.L496:
# basic.c:2437: 	expression_error = 0;
	xor.w	r0, r0	# tmp35
	st.b	[expression_error], r0	# expression_error, tmp35
# basic.c:2438: 	int c = (int)expression();	
	call	expression		#
	mov.w	r1, r0	# _4,
# basic.c:2438: 	int c = (int)expression();	
...
# basic.c:2439: 	if (expression_error)
...
# basic.c:2450: 	if (init_tcpip()) 
	...
	jz	.L501		#
# basic.c:2452: 		init_timer();
	call	init_timer		#
# basic.c:2453: 		return true;
	mov.w	r0, 1	# _2,
	j	.L502		#
.L501:
# basic.c:2455: 		printf("No ethernet link available\n.");
	mov.w	r1, sp	# tmp30,
	mov.w	r0, .LC75	# tmp31,
	st.w	[r1], r0	#, tmp31
	call	printf		#
...
# basic.c:2466: 	if (*txtpos == NL)
	...
	cmp.w	r1, r0	# tmp49, tmp50
	jnz	.L504		#
# basic.c:2467: 		return 0;
	xor.w	r0, r0	# _20
	j	.L505		#
.L504:
# basic.c:2469: 	scantable(keywords);
	mov.w	r1, sp	# tmp51,
	mov.w	r0, keywords	# tmp52,
	st.w	[r1], r0	#, tmp52
	call	scantable		#
# basic.c:2475: 	if (should_break())
	call	should_break		#
	mov.w	r1, r0	# _3,
# basic.c:2475: 	if (should_break())
	xor.w	r0, r0	# tmp53
...
# basic.c:2477: 		return 0;
	...
	j	.L505		#
.L506:
# basic.c:2480: 	switch (table_index)
	...
	j	.L551		#
.L543:
# basic.c:2484: 		exec_mem();
	call	exec_mem		#
# basic.c:2485: 		return 0;
	xor.w	r0, r0	# _20
	j	.L505		#
.L551:
# basic.c:2489: 		printf("I cannot exit. I am the boss.\n");
	mov.w	r1, sp	# tmp127,
	mov.w	r0, .LC76	# tmp128,
	st.w	[r1], r0	#, tmp128
	call	puts		#
# basic.c:2490: 		break;
	j	.L545		#
.L542:
# basic.c:2493: 		exec_print();
	call	exec_print		#
# basic.c:2494: 		break;
	j	.L545		#
.L541:
# basic.c:2496: 		exec_list();
	call	exec_list		#
# basic.c:2497: 		break;
	j	.L545		#
.L540:
# basic.c:2499: 		current_line = program_start;
	ld.w	r0, [program_start]	# program_start.462_6, program_start
	st.w	[current_line], r0	# current_line, program_start.462_6
# basic.c:2500: 		exec_run();
	call	exec_run		#
# basic.c:2501: 		break;
	j	.L545		#
.L539:
# basic.c:2503: 		program_end = program_start;
	ld.w	r0, [program_start]	# program_start.463_7, program_start
	st.w	[program_end], r0	# program_end, program_start.463_7
# basic.c:2504: 		break;
	j	.L545		#
.L538:
# basic.c:2506: 		assignment();
	call	assignment		#
# basic.c:2507: 		break;
	j	.L545		#
.L537:
# basic.c:2509: 		exec_if();
	call	exec_if		#
# basic.c:2510: 		break;
	j	.L545		#
.L536:
# basic.c:2512: 		expression_error = 0;
	xor.w	r0, r0	# tmp129
	st.b	[expression_error], r0	# expression_error, tmp129
# basic.c:2513: 		linenum = expression();
	call	expression		#
	mov.w	r1, r0	# _8,
# basic.c:2513: 		linenum = expression();
...
# basic.c:2514: 		if (expression_error || *txtpos != NL)
...
# basic.c:2515: 			qhow();
	call	qhow		#
.L547:
# basic.c:2516: 		current_line = findline();
	call	findline		#
# basic.c:2516: 		current_line = findline();
	st.w	[current_line], r0	# current_line, _13
# basic.c:2517: 		return 2;
	mov.w	r0, 2	# _20,
	j	.L505		#
.L535:
# basic.c:2519: 		exec_for();
	call	exec_for		#
# basic.c:2520: 		break;
	j	.L545		#
.L534:
# basic.c:2522: 		exec_next();
	call	exec_next		#
# basic.c:2523: 		break;
	j	.L545		#
.L532:
# basic.c:2525: 		exec_gosub();
	call	exec_gosub		#
# basic.c:2526: 		break;
	j	.L545		#
.L533:
# basic.c:2528: 		if (!exec_return())
	call	exec_return		#
	mov.w	r1, r0	# _14,
# basic.c:2528: 		if (!exec_return())
	xor.w	r0, r0	# tmp135
	...
	jnz	.L553		#
# basic.c:2529: 			return 1;
	mov.w	r0, 1	# _20,
	j	.L505		#
.L531:
# basic.c:2534: 		if (txtpos[0] != NL)
...
# basic.c:2546: 		break;
	j	.L545		#
.L528:
# basic.c:2548: 		return exec_edit();
	call	exec_edit		#
	j	.L505		#
.L527:
# basic.c:2550: 		exec_load();
	call	exec_load		#
# basic.c:2551: 		break;
	j	.L545		#
.L526:
# basic.c:2553: 		exec_save();
	call	exec_save		#
# basic.c:2554: 		break;
	j	.L545		#
.L525:
# basic.c:2556: 		exec_dir();
	call	exec_dir		#
# basic.c:2557: 		break;
	j	.L545		#
.L524:
# basic.c:2559: 		exec_mode();
	call	exec_mode		#
# basic.c:2560: 		break;
	j	.L545		#
.L523:
# basic.c:2562: 		exec_plot();
	call	exec_plot		#
# basic.c:2563: 		break;
	j	.L545		#
.L522:
# basic.c:2565: 		exec_line();
	call	exec_line		#
# basic.c:2566: 		break;
	j	.L545		#
.L521:
# basic.c:2568: 		exec_circle();
	call	exec_circle		#
# basic.c:2569: 		break;
	j	.L545		#
.L520:
# basic.c:2571: 		exec_draw();
	call	exec_draw		#
# basic.c:2572: 		break;
	j	.L545		#
.L519:
# basic.c:2574: 		exec_help();
	call	exec_help		#
# basic.c:2575: 		break;
	j	.L545		#
.L518:
# basic.c:2577: 		exec_delay();
	call	exec_delay		#
# basic.c:2578: 		break;
	j	.L545		#
.L517:
# basic.c:2580: 		exec_cursor();
	call	exec_cursor		#
# basic.c:2581: 		break;
	j	.L545		#
.L516:
# basic.c:2583: 		exec_poke();
	call	exec_poke		#
# basic.c:2584: 		break;
	j	.L545		#
.L515:
# basic.c:2586: 		exec_exec();
	call	exec_exec		#
# basic.c:2587: 		break;
	j	.L545		#
.L514:
# basic.c:2589: 		exec_sys();
	call	exec_sys		#
# basic.c:2590: 		break;
	j	.L545		#
.L513:
# basic.c:2592: 		exec_drive();
	call	exec_drive		#
# basic.c:2593: 		break;
	j	.L545		#
.L512:
# basic.c:2595: 		printf("Current millis: %d\n", get_millis());
	call	get_millis		#
	mov.w	r1, r0	# _19,
	mov.w	r0, sp	# tmp139,
	st.w	[r0 + (4)], r1	#, _19
	mov.w	r1, .LC77	# tmp140,
	st.w	[r0], r1	#, tmp140
	call	printf		#
# basic.c:2596: 	break;
	j	.L545		#
.L510:
# basic.c:2601: 		exec_eth();
	call	exec_eth		#
# basic.c:2602: 		break;
	j	.L545		#
.L509:
# basic.c:2604: 		exec_color();
	call	exec_color		#
# basic.c:2605: 		break;
	j	.L545		#
.L507:
# basic.c:2607: 		assignment();
	call	assignment		#
# basic.c:2608: 		break;
	j	.L545		#
.L508:
...
init_K_API:
	push	r13		#
	mov.w	r13, sp	#,
# basic.c:2616: 	K_API_STDIO[K_CLS] 				= ((int)cls) + 4;               // 190000 
...
# basic.c:2617: 	K_API_STDIO[K_PUT_CHAR] 		= ((int)put_char) + 4;          // 190004 
...
# basic.c:2617: 	K_API_STDIO[K_PUT_CHAR] 		= ((int)put_char) + 4;          // 190004 
	st.w	[r0], r1	# *_6, _7
# basic.c:2618: 	K_API_STDIO[K_PRINTF] 			= ((int)printf) + 4;            // 190008 
...
# basic.c:2618: 	K_API_STDIO[K_PRINTF] 			= ((int)printf) + 4;            // 190008 
	st.w	[r0], r1	# *_10, _11
# basic.c:2619: 	K_API_STDIO[K_PUTS] 			= ((int)puts) + 4;              // 190012 
...
# basic.c:2619: 	K_API_STDIO[K_PUTS] 			= ((int)puts) + 4;              // 190012 
	st.w	[r0], r1	# *_14, _15
# basic.c:2620: 	K_API_STDIO[K_RAND] 			= ((int)rand) + 4;              // 190016 
...
# basic.c:2620: 	K_API_STDIO[K_RAND] 			= ((int)rand) + 4;              // 190016 
	st.w	[r0], r1	# *_18, _19
# basic.c:2621: 	K_API_STDIO[K_SHOULD_BREAK] 	= ((int)should_break) + 4;      // 190020 
...
# basic.c:2621: 	K_API_STDIO[K_SHOULD_BREAK] 	= ((int)should_break) + 4;      // 190020 
	st.w	[r0], r1	# *_22, _23
# basic.c:2622: 	K_API_STDIO[K_GETC] 			= ((int)getc) + 4;              // 190024 
...
# basic.c:2622: 	K_API_STDIO[K_GETC] 			= ((int)getc) + 4;              // 190024 
	st.w	[r0], r1	# *_26, _27
# basic.c:2623: 	K_API_STDIO[K_GETS] 			= ((int)gets) + 4;              // 190028 
...
# basic.c:2623: 	K_API_STDIO[K_GETS] 			= ((int)gets) + 4;              // 190028 
	st.w	[r0], r1	# *_30, _31
# basic.c:2624: 	K_API_STDIO[K_INIT_STDIO] 		= ((int)init_stdio) + 4;        // 190032 
...
# basic.c:2624: 	K_API_STDIO[K_INIT_STDIO] 		= ((int)init_stdio) + 4;        // 190032 
	st.w	[r0], r1	# *_34, _35
# basic.c:2625: 	K_API_STDIO[K_DELAY] 			= ((int)delay) + 4;             // 190036 
...
# basic.c:2625: 	K_API_STDIO[K_DELAY] 			= ((int)delay) + 4;             // 190036 
	st.w	[r0], r1	# *_38, _39
# basic.c:2626: 	K_API_STDIO[K_XY] 				= ((int)xy) + 4;                // 190040 
...
# basic.c:2626: 	K_API_STDIO[K_XY] 				= ((int)xy) + 4;                // 190040 
	st.w	[r0], r1	# *_42, _43
# basic.c:2627: 	K_API_STDIO[K_GET_MILLIS]		= ((int)get_millis) + 4;        // 190044 
...
# basic.c:2627: 	K_API_STDIO[K_GET_MILLIS]		= ((int)get_millis) + 4;        // 190044 
	st.w	[r0], r1	# *_46, _47
# basic.c:2628: 	K_API_STDIO[K_IS_KEY_PRESSED]	= ((int)is_key_pressed) + 4;    // 190048 
...
# basic.c:2628: 	K_API_STDIO[K_IS_KEY_PRESSED]	= ((int)is_key_pressed) + 4;    // 190048 
	st.w	[r0], r1	# *_50, _51
# basic.c:2629: 	K_API_STDIO[K_IS_KEY_RELEASED]	= ((int)is_key_released) + 4;   // 190052 
...
# basic.c:2629: 	K_API_STDIO[K_IS_KEY_RELEASED]	= ((int)is_key_released) + 4;   // 190052 
	st.w	[r0], r1	# *_54, _55
# basic.c:2630: 	K_API_STDIO[K_TOGGLE_CURSOR] 	= ((int)toggle_cursor) + 4;     // 190056 
...
# basic.c:2630: 	K_API_STDIO[K_TOGGLE_CURSOR] 	= ((int)toggle_cursor) + 4;     // 190056 
	st.w	[r0], r1	# *_58, _59
# basic.c:2631: 	K_API_STDIO[K_PUTCHAR]			= ((int)putchar) + 4;           // 190060 
...
# basic.c:2631: 	K_API_STDIO[K_PUTCHAR]			= ((int)putchar) + 4;           // 190060 
	st.w	[r0], r1	# *_62, _63
# basic.c:2632: 	K_API_STDIO[K_VIDEO_MODE]		= ((int)video_mode) + 4;        // 190064 
...
# basic.c:2632: 	K_API_STDIO[K_VIDEO_MODE]		= ((int)video_mode) + 4;        // 190064 
	st.w	[r0], r1	# *_66, _67
# basic.c:2633: 	K_API_GRAPHICS[K_SCROLL_UP]	    = ((int)scroll_up) + 4;			// 190068
...
# basic.c:2633: 	K_API_GRAPHICS[K_SCROLL_UP]	    = ((int)scroll_up) + 4;			// 190068
	st.w	[r0], r1	# *_70, _71
# basic.c:2635: 	K_API_STRING[K_STRLEN] =        ((int)strlen) + 4;				// 190100 
...
# basic.c:2636: 	K_API_STRING[K_STRCMP] =        ((int)strcmp) + 4;				// 190104 
...
# basic.c:2636: 	K_API_STRING[K_STRCMP] =        ((int)strcmp) + 4;				// 190104 
	st.w	[r0], r1	# *_77, _78
# basic.c:2637: 	K_API_STRING[K_STRNCMP] =       ((int)strncmp) + 4;				// 190108 
...
# basic.c:2637: 	K_API_STRING[K_STRNCMP] =       ((int)strncmp) + 4;				// 190108 
	st.w	[r0], r1	# *_81, _82
# basic.c:2638: 	K_API_STRING[K_MEMCPY] =        ((int)memcpy) + 4; 				// 190112 
...
# basic.c:2638: 	K_API_STRING[K_MEMCPY] =        ((int)memcpy) + 4; 				// 190112 
	st.w	[r0], r1	# *_85, _86
# basic.c:2639: 	K_API_STRING[K_MEMSET] =        ((int)memset) + 4; 				// 190116 
...
# basic.c:2639: 	K_API_STRING[K_MEMSET] =        ((int)memset) + 4; 				// 190116 
	st.w	[r0], r1	# *_89, _90
# basic.c:2640: 	K_API_STRING[K_MEMMOVE] =       ((int)memmove) + 4; 			// 190120 
...
# basic.c:2640: 	K_API_STRING[K_MEMMOVE] =       ((int)memmove) + 4; 			// 190120 
	st.w	[r0], r1	# *_93, _94
# basic.c:2641: 	K_API_STRING[K_STRCPY] =        ((int)strcpy) + 4; 				// 190124 
...
# basic.c:2641: 	K_API_STRING[K_STRCPY] =        ((int)strcpy) + 4; 				// 190124 
	st.w	[r0], r1	# *_97, _98
# basic.c:2642: 	K_API_STRING[K_STRNCPY] =       ((int)strncpy) + 4; 			// 190128 
...
# basic.c:2643: 	K_API_STRING[K_STRCAT] =        ((int)strcat) + 4;				// 190132 
...
# basic.c:2644: 	K_API_STRING[K_STRSTR] =        ((int)strstr) + 4;				// 190136 
...
# basic.c:2645: 	K_API_STRING[K_TOLOWER] =       ((int)tolower) + 4;				// 190140 
...
# basic.c:2646: 	K_API_STRING[K_TOUPPER] =       ((int)toupper) + 4;				// 190144 
...
# basic.c:2647: 	K_API_STRING[K_STR_TOUPPER] =   ((int)str_toupper) + 4;			// 190148 
...
# basic.c:2648: 	K_API_STRING[K_STR_N_TOUPPER] = ((int)str_n_toupper) + 4;		// 190152 
...
# basic.c:2649: 	K_API_STRING[K_ISDIGIT] =       ((int)isdigit) + 4;				// 190156 
...
# basic.c:2650: 	K_API_STRING[K_ISLOWER] =       ((int)islower) + 4;				// 190160 
...
# basic.c:2651: 	K_API_STRING[K_ISUPPER] =       ((int)isupper) + 4;				// 190164 
...
# basic.c:2652: 	K_API_STRING[K_ISALPHA] =       ((int)isalpha) + 4;				// 190168 
...
# basic.c:2653: 	K_API_STRING[K_ISALNUM] =       ((int)isalnum) + 4;				// 190172 
...
# basic.c:2654: 	K_API_STRING[K_ATOI] =          ((int)atoi) + 4;				// 190176 
...
# basic.c:2655: 	K_API_STRING[K_ISSPACE] =       ((int)isspace) + 4;				// 190180 
...
# basic.c:2656: 	K_API_STRING[K_MEMCMP] =        ((int)memcmp) + 4;		 	 	// 190184 
...
# basic.c:2657: 	K_API_STRING[K_STRTOK] =        ((int)strtok) + 4;				// 190188 
...
# basic.c:2658: 	K_API_STRING[K_STRCHR] =        ((int)strchr) + 4; 				// 190192 
...
# basic.c:2659: 	K_API_STRING[K_STRRRCHR] =      ((int)strrchr) + 4; 			// 190196 
...
# basic.c:2660: 	K_API_STRING[K_STRNCASECMP] =   ((int)strncasecmp) + 4; 		// 190200 
...
# basic.c:2662: 	K_API_SPRINTF[K_SPRINTF]	= 	((int)sprintf) + 4;				// 190300
...
# basic.c:2663: 	K_API_SPRINTF[K_VSPRINTF]	= 	((int)vsprintf) + 4;			// 190304
...
# basic.c:2665: 	K_API_GRAPHICS[K_PIXEL]		=	((int)pixel) + 4;				// 190400
...
# basic.c:2666: 	K_API_GRAPHICS[K_LINE]		=	((int)line) + 4;				// 190404
...
# basic.c:2667: 	K_API_GRAPHICS[K_CIRCLE]	=	((int)circle) + 4;				// 190408
...
# basic.c:2668: 	K_API_GRAPHICS[K_DRAW]		=	((int)draw) + 4;				// 190412
...
# basic.c:2670: 	K_API_SPI[K_INIT_SPI]		=    ((int)init_spi) + 4; 			// 190500
...
# basic.c:2671: 	K_API_SPI[K_DEINIT_SPI]		=    ((int)deinit_spi) + 4; 		// 190504
...
# basic.c:2672: 	K_API_SPI[K_SEND_SPI]		=    ((int)send_spi) + 4; 			// 190508
...
# basic.c:2673: 	K_API_SPI[K_READ_SPI]		=    ((int)read_spi) + 4; 			// 190512
...
# basic.c:2674: 	K_API_SPI[K_SPI_BYTE]		=    ((int)SPI_Byte) + 4; 			// 190516
...
# basic.c:2676: 	K_API_TCPIP[K_INIT_TCPIP]	= 	 ((int)init_tcpip) + 4;			// 190600
...
# basic.c:2677: 	K_API_TCPIP[K_BROWSE_URL]	= 	 ((int)browseUrl) + 4;			// 190604
...
# basic.c:2678: 	K_API_TCPIP[K_HTTP_POST]	= 	 ((int)httpPost) + 4;			// 190608
...
# basic.c:2679: 	K_API_TCPIP[K_MAIN_LOOP]	= 	 ((int)mainLoop) + 4;			// 190612
...
# basic.c:2682: 	K_API_FAT[K_SDCARD_INIT]	= 	 ((int)sdcard_init) + 4;		// 190700
...
# basic.c:2683: 	K_API_FAT[K_VOLUME_INIT]	= 	 ((int)volume_init) + 4;		// 190704
...
# basic.c:2684: 	K_API_FAT[K_FILE_OPEN]		= 	 ((int)file_open) + 4;			// 190708
...
# basic.c:2685: 	K_API_FAT[K_FILE_READ]		= 	 ((int)file_read) + 4;			// 190712
...
# basic.c:2686: 	K_API_FAT[K_GET_DIR_ENTRY]	= 	 ((int)getDirEntry) + 4;		// 190716
...
# basic.c:2687: 	K_API_FAT[K_FILE_SEEK]		= 	 ((int)file_seek) + 4;			// 190720
...
# basic.c:2688: 	K_API_FAT[K_FILE_WRITE]		= 	 ((int)file_write) + 4;			// 190724
...
# basic.c:2689: 	K_API_FAT[K_FILE_DELETE]	= 	 ((int)file_delete) + 4;		// 190728
...
# basic.c:2725: 			getln('>');
	...
	st.w	[r1], r0	#, tmp60
	call	getln		#
# basic.c:2726: 			toUppercaseBuffer();
	call	toUppercaseBuffer		#
# basic.c:2727: 			skip_to_end();
	call	skip_to_end		#
	j	.L557		#
.L556:
# basic.c:2731: 			res = 0;
...
# basic.c:2732: 			toUppercaseBuffer();
	call	toUppercaseBuffer		#
.L557:
# basic.c:2735: 		linenum = testnum();
	call	testnum		#
	mov.w	r1, r0	# _10,
# basic.c:2735: 		linenum = testnum();
...
# basic.c:2737: 		ignore_blanks();
	call	ignore_blanks		#
# basic.c:2739: 		if (linenum == 0)
...
# basic.c:2739: 		if (linenum == 0)
	...
	jnz	.L558		#
.L564:
# basic.c:2742: 				res = direct();
	call	direct		#
	st.w	[r13 + (-4)], r0	# res,
# basic.c:2743: 				if (res == 1)
	ld.w	r1, [r13 + (-4)]	# tmp64, res
	mov.w	r0, 1	# tmp65,
	cmp.w	r1, r0	# tmp64, tmp65
	jnz	.L559		#
# basic.c:2744: 					return 0;
	xor.w	r0, r0	# _64
	j	.L567		#
.L559:
# basic.c:2745: 				if (res == 2)
	ld.w	r1, [r13 + (-4)]	# tmp66, res
	mov.w	r0, 2	# tmp67,
	cmp.w	r1, r0	# tmp66, tmp67
	jnz	.L561		#
# basic.c:2747: 					txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	ld.w	r0, [current_line]	# current_line.610_13, current_line
	add.w	r0, 5 #111	# _14,
# basic.c:2747: 					txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	st.w	[txtpos], r0	# txtpos, _14
# basic.c:2748: 					continue;
	j	.L562		#
.L561:
# basic.c:2750: 				ignore_blanks();
	call	ignore_blanks		#
# basic.c:2751: 				if (*txtpos == NL || *txtpos != ':')
...
# basic.c:2753: 				txtpos++;
	...
	add.w	r0, 1 #111	# _20,
	st.w	[txtpos], r0	# txtpos, _20
# basic.c:2754: 				ignore_blanks();
	call	ignore_blanks		#
.L562:
# basic.c:2742: 				res = direct();
	j	.L564		#
.L558:
# basic.c:2757: 		else if (linenum == 0xFFFF)
...
# basic.c:2759: 			qhow();
	...
	j	.L566		#
.L565:
# basic.c:2763: 			entered_with_line_num();
	call	entered_with_line_num		#
# basic.c:2723: 		if (res != 3)
	j	.L566		#
.L567:
