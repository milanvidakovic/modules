...
dma_receive:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 8 #111	#,
	ld.w	r0, [r13 + (12)]	# tmp34, count
	st.s	[r13 + (-8)], r0	# count, tmp35
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/fat.c:234:     finished_dma_read_1 = 0;
	xor.w	r0, r0	# tmp37
	st.w	[finished_dma_read_1], r0	# finished_dma_read_1, tmp37
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/fat.c:237:     *PORT_DMA_START_RCV_1 = 1;
	mov.s	r1, 1	# tmp38,
	st.s	[r0], r1	# *PORT_DMA_START_RCV_1.17_5, tmp38
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/fat.c:238:     while (!finished_dma_read_1) {
	nop	
.L43:
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/fat.c:238:     while (!finished_dma_read_1) {
	ld.w	r1, [finished_dma_read_1]	# finished_dma_read_1.18_6, finished_dma_read_1
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/fat.c:238:     while (!finished_dma_read_1) {
	xor.w	r0, r0	# tmp39
	cmp.w	r1, r0	# finished_dma_read_1.18_6, tmp39
	jz	.L43		#
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/fat.c:287:   if (!inBlock_ || block != block_ || offset < offset_) {
	zex.b	r1, r0	# tmp68, inBlock_.19_4
	xor.w	r0, r0	# tmp69
	cmp.w	r1, r0	# tmp68, tmp69
	jz	.L51		#
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/fat.c:287:   if (!inBlock_ || block != block_ || offset < offset_) {
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/fat.c:359:   if (!partialBlockRead_ || offset_ >= 512) {
	zex.b	r1, r0	# tmp122, partialBlockRead_.25_24
	xor.w	r0, r0	# tmp123
...
# /mnt/c/Prj/Altera/C/moxiebox/modules/lib/fat.c:359:   if (!partialBlockRead_ || offset_ >= 512) {
	zex.s	r1, r0	# tmp124, offset_.26_25
	mov.w	r0, 511	# tmp125,
