...
copy_sprite_def:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 8 #111	#,
# sprites.c:80: 	short *p = (short *)spr_def;
	ld.w	r0, [r13 + (8)]	# tmp27, spr_def
	st.w	[r13 + (-4)], r0	# p, tmp27
# sprites.c:81: 	for (int i = 0; i < 16*4; i++)
	xor.w	r0, r0	# tmp28
	st.w	[r13 + (-8)], r0	# i, tmp28
# sprites.c:81: 	for (int i = 0; i < 16*4; i++)
	j	.L2		#
.L3:
# sprites.c:83: 		*p = plane[i];
...
draw_bitmap:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# sprites.c:91: 	short *p1 = (short *)(1024 + y * 160 + x/2);
...
# sprites.c:92: 	for (int i = 0; i < height; i++)
	xor.w	r0, r0	# tmp112
	st.w	[r13 + (-4)], r0	# i, tmp112
# sprites.c:92: 	for (int i = 0; i < height; i++)
	j	.L5		#
.L15:
# sprites.c:95: 		short *p2 = p1 + (i * 80);
...
# sprites.c:96: 		int shorts_per_row = width / 4;
...
# sprites.c:97: 		for (int j = 0; j < shorts_per_row; j++) 
	xor.w	r0, r0	# tmp126
	st.w	[r13 + (-12)], r0	# j, tmp126
# sprites.c:97: 		for (int j = 0; j < shorts_per_row; j++) 
	j	.L7		#
.L14:
# sprites.c:99: 			switch (x % 4)
...
# sprites.c:99: 			switch (x % 4)
	...
	j	.L10		#
.L12:
# sprites.c:102: 					*p2 = bitmap[i*shorts_per_row + j];
...
# sprites.c:104: 					break;
	j	.L10		#
.L13:
# sprites.c:106: 					first = (*p2)      | (bitmap[i*shorts_per_row + j] >> 4);
...
# sprites.c:107: 					second = (*(p2+1)) | (bitmap[i*shorts_per_row + j] << 12);
...
# sprites.c:111: 					break;
	j	.L10		#
.L11:
# sprites.c:113: 					first = (*p2)      | (bitmap[i*shorts_per_row + j] >> 8);
...
# sprites.c:114: 					second = (*(p2+1)) | (bitmap[i*shorts_per_row + j] << 8);
...
# sprites.c:118: 					break;
	j	.L10		#
.L9:
# sprites.c:120: 					first = (*p2)      | (bitmap[i*shorts_per_row + j] >> 12);
...
# sprites.c:121: 					second = (*(p2+1)) | (bitmap[i*shorts_per_row + j] << 4);
...
# sprites.c:141: 	memset((short *)addr, 0, 2*4*16);
	...
	st.w	[r0], r1	#, addr.1_2
	call	memset		#
# sprites.c:142: 	memset(spr, 0, sizeof(sprite));
	mov.w	r0, sp	# tmp33,
	mov.w	r1, 8	# tmp34,
	st.w	[r0 + (8)], r1	#, tmp34
	xor.w	r1, r1	# tmp35
...
main:
	...
	mov.w	r12, 564	#,
	sub.w	sp, r12 #222	#,
# sprites.c:158: 	init_stdio();
	call	init_stdio		#
# sprites.c:160: 	video_mode(1);
	mov.w	r1, sp	# tmp119,
	mov.w	r0, 1	# tmp120,
	st.w	[r1], r0	#, tmp120
	call	video_mode		#
# sprites.c:162: 	cls(0);	
	...
	st.w	[r1], r0	#, tmp122
	call	cls		#
# sprites.c:164: 	circle(100, 100, 50, BLUE);
	mov.w	r0, sp	# tmp123,
	mov.w	r1, 1	# tmp124,
	...
	st.w	[r0], r1	#, tmp127
	call	circle		#
# sprites.c:166: 	int start = get_millis();
	call	get_millis		#
	st.w	[r13 + (-24)], r0	# start,
# sprites.c:170: 	asm("push r1\npush r2\n push r3\nmov.w r1, 1024\nmov.w r2, 9024\nmov.w r3, 30000\nblit\npop r3\npop r2\npop r1\n");
# 170 "sprites.c" 1
	push r1
push r2
 push r3
...
# sprites.c:173: 	sprintf(str, "millis: %d", get_millis() - start);
	call	get_millis		#
	mov.w	r1, r0	# _1,
# sprites.c:173: 	sprintf(str, "millis: %d", get_millis() - start);
	...
	st.w	[r0], r1	#, tmp131
	call	sprintf		#
# sprites.c:174: 	draw(10, 10, GREEN, str);
	mov.w	r0, sp	# tmp133,
	mov.w	r2, -532	# tmp135,
	mov.w	r1, r13	# tmp134,
	...
	st.w	[r0], r1	#, tmp138
	call	draw		#
# sprites.c:176: 	copy_sprite_def(sprite_addr1);copy_sprite_def(sprite_addr2); copy_sprite_def(sprite_addr3);copy_sprite_def(sprite_addr4);copy_sprite_def(sprite_addr5);
...
# sprites.c:176: 	copy_sprite_def(sprite_addr1);copy_sprite_def(sprite_addr2); copy_sprite_def(sprite_addr3);copy_sprite_def(sprite_addr4);copy_sprite_def(sprite_addr5);
	...
	call	copy_sprite_def		#
# sprites.c:177: 	init_sprite(sprite_def1, sprite_addr1, 50, 50);init_sprite(sprite_def2, sprite_addr2, 70, 50);init_sprite(sprite_def3, sprite_addr3, 90, 50);init_sprite(sprite_def4, sprite_addr4, 110, 50);init_sprite(sprite_def5, sprite_addr5, 130, 50);
...
# sprites.c:182: 	for (int i = 0; i < 5; i++)
	j	.L20		#
.L21:
# sprites.c:183: 		draw_bitmap(200 + (i * 20), 150, 16, 16, plane);
...
# sprites.c:182: 	for (int i = 0; i < 5; i++)
	...
	jses	.L21		#
# sprites.c:184: 	for (int i = 0; i < 5; i++)
	xor.w	r0, r0	# tmp176
	st.w	[r13 + (-8)], r0	# i, tmp176
# sprites.c:184: 	for (int i = 0; i < 5; i++)
	j	.L22		#
.L23:
# sprites.c:185: 		draw_bitmap(203 + (i * 20), 170, 16, 16, plane);
...
# sprites.c:184: 	for (int i = 0; i < 5; i++)
	...
	jses	.L23		#
# sprites.c:187: 	for (int i = 0; i < 5; i++)
	xor.w	r0, r0	# tmp192
	st.w	[r13 + (-12)], r0	# i, tmp192
# sprites.c:187: 	for (int i = 0; i < 5; i++)
	j	.L24		#
.L25:
# sprites.c:188: 		draw_bitmap(0 + (i * 40), 85, 32, 16, plane2);
...
# sprites.c:187: 	for (int i = 0; i < 5; i++)
	...
	jses	.L25		#
# sprites.c:190: 	int vkp = 0, vkr = 0, old = 0;
	xor.w	r0, r0	# tmp208
...
.L48:
# sprites.c:194: 		short int status =  mouse_status(&mouse_x, &mouse_y, &mouse_key);
	mov.w	r0, sp	# tmp211,
	mov.w	r2, -534	# tmp213,
	mov.w	r1, r13	# tmp212,
...
# sprites.c:195: 		if (status) {
	ld.s	r0, [r13 + (-30)]	#, status
	sex.s	r1, r0	# tmp218,
	xor.w	r0, r0	# tmp219
	cmp.w	r1, r0	# tmp218, tmp219
	jz	.L26		#
# sprites.c:196: 			sprite_def->x = mouse_x;
...
# sprites.c:197: 			sprite_def->y = mouse_y;
...
# sprites.c:198: 			key = mouse_key;
	ld.s	r0, [r13 + (-534)]	# tmp220, mouse_key
	st.s	[r13 + (-32)], r0	# key, tmp220
# sprites.c:200: 			asm("mov.w r1, 4224\nmov.w r2, 33024\nmov.w r3, 1600\nblit\n");
# 200 "sprites.c" 1
	mov.w r1, 4224
mov.w r2, 33024
mov.w r3, 1600
...
# sprites.c:201: 			sprintf(str, "mouse: %d, %d, %d", key, sprite_def->x, sprite_def->y);
	ld.s	r0, [r13 + (-32)]	#, key
	sex.s	r1, r0	# _44,
# sprites.c:201: 			sprintf(str, "mouse: %d, %d, %d", key, sprite_def->x, sprite_def->y);
...
# sprites.c:201: 			sprintf(str, "mouse: %d, %d, %d", key, sprite_def->x, sprite_def->y);
	...
	st.w	[r0], r1	#, tmp223
	call	sprintf		#
# sprites.c:202: 			draw(10, 20, RED, str);
	mov.w	r0, sp	# tmp225,
	mov.w	r2, -532	# tmp227,
	mov.w	r1, r13	# tmp226,
	...
	call	draw		#
.L26:
# sprites.c:205: 		vkp = is_key_pressed();
	call	is_key_pressed		#
	st.w	[r13 + (-16)], r0	# vkp,
# sprites.c:206: 		vkr = is_key_released();
	call	is_key_released		#
	st.w	[r13 + (-28)], r0	# vkr,
# sprites.c:207: 		if (vkp != VK_SPACE && vkr != VK_SPACE)
...
# sprites.c:209: 			if ((vkp == 0) && (vkr == 0))
	...
	jnz	.L28		#
# sprites.c:211: 				vkp = old;
	ld.w	r0, [r13 + (-20)]	# tmp239, old
	st.w	[r13 + (-16)], r0	# vkp, tmp239
.L28:
# sprites.c:213: 			if ((vkr != 0) && (vkr == old))
...
# sprites.c:227: 			if (sprite_def->x < 0)
...
# sprites.c:232: 			if (sprite_def->x > 319-16)
...
# sprites.c:232: 			if (sprite_def->x > 319-16)
	...
	jses	.L52		#
# sprites.c:233: 				sprite_def->x = 319-16;
...
# sprites.c:237: 			if (sprite_def->y > 239-16)
...
# sprites.c:237: 			if (sprite_def->y > 239-16)
	...
	jses	.L53		#
# sprites.c:238: 				sprite_def->y = 239-16;
...
# sprites.c:242: 			if (sprite_def->y < 0)
...
# sprites.c:244: 			break;
	nop	
.L32:
# sprites.c:266: 		if (vkp != 0 && vkp != VK_SPACE)
