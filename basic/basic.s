...
keywords:
	...
	.size	func_tab, 65
func_tab:
	.string	"PEEK\001ABS\001AREAD\001DREAD\001RND\001KEY\001ISKEY\001SIN\001COS\001TAN\001EXP\001LOG\001SQRT\001POW\001"
	.global	to_tab
	.p2align	2
	.type	to_tab, @object
	.size	to_tab, 4
...
toUppercaseBuffer:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 8 #111	#,
# basic.c:260: 	char *c = txtpos;
	ld.w	r0, [txtpos]	# tmp36, txtpos
	st.w	[r13 + (-4)], r0	# c, tmp36
# basic.c:261: 	char quote = 0;
	xor.w	r0, r0	# tmp37
	st.b	[r13 + (-5)], r0	# quote, tmp37
# basic.c:263: 	while (*c != NL)
	j	.L4		#
.L9:
# basic.c:266: 		if (*c == quote)
...
# basic.c:269: 			quote = *c;
	...
	j	.L6		#
.L8:
# basic.c:270: 		else if (quote == 0 && *c >= 'a' && *c <= 'z')
	ld.b	r0, [r13 + (-5)]	#, quote
	sex.b	r1, r0	# tmp50,
	xor.w	r0, r0	# tmp51
...
ignore_blanks:
	push	r13		#
	mov.w	r13, sp	#,
# basic.c:278: 	while (*txtpos == SPACE || *txtpos == TAB)
	j	.L11		#
.L12:
# basic.c:279: 		txtpos++;
...
skip_to_end:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 4 #111	#,
# basic.c:284: 	txtpos = program_end + sizeof(LINENUM);
	ld.w	r0, [program_end]	# program_end.10_1, program_end
	add.w	r0, 4 #111	# _2,
# basic.c:284: 	txtpos = program_end + sizeof(LINENUM);
	st.w	[txtpos], r0	# txtpos, _2
# basic.c:287: 	while (*txtpos != NL)
	j	.L14		#
.L15:
# basic.c:288: 		txtpos++;
...
# basic.c:314: 		if (((LINENUM *)line)[0] >= linenum)
	...
	js	.L24		#
# basic.c:315: 			return line;
	ld.w	r0, [r13 + (-4)]	# _9, line
	j	.L23		#
.L24:
# basic.c:318: 		line += line[sizeof(LINENUM)];
...
# basic.c:330: 	printf("%d ", line_num);
	...
	st.w	[r0], r1	#, tmp41
	call	printf		#
# basic.c:331: 	while (*list_line != NL)
	j	.L27		#
.L28:
# basic.c:333: 		put_char(*list_line);
...
testnum:
	...
	push	r6		#
	sub.w	sp, 28 #111	#,
# basic.c:342: 	VAR num = 0;
	xor.w	r0, r0	# tmp41
	st.w	[r13 + (-8)], r0	# num, tmp41
# basic.c:343: 	ignore_blanks(txtpos);
	ld.w	r0, [txtpos]	# txtpos.27_1, txtpos
	mov.w	r1, sp	# tmp42,
	st.w	[r1], r0	#, txtpos.27_1
	call	ignore_blanks		#
# basic.c:345: 	while (*txtpos >= '0' && *txtpos <= '9')
	j	.L30		#
.L34:
# basic.c:348: 		if (num >= 0xFFFFFFFF / 10)
	...
	jss	.L37		#
# basic.c:350: 			num = 0xFFFFFFFF;
	mov.w	r0, 1333788672	# tmp47,
	st.w	[r13 + (-8)], r0	# num, tmp47
# basic.c:351: 			break;
	j	.L33		#
.L37:
# basic.c:354: 		num = num * 10 + *txtpos - '0';
...
entered_with_line_num:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 84 #111	#,
# basic.c:370: 	linelen = 0;
	xor.w	r0, r0	# tmp98
	st.b	[r13 + (-1)], r0	# linelen, tmp98
# basic.c:371: 	while (txtpos[linelen] != NL)
	j	.L39		#
.L40:
# basic.c:372: 		linelen++;
...
# basic.c:384: 		txtpos[sizeof(LINENUM) + sizeof(char)] = ' ';
...
# basic.c:396: 	if (start != program_end && *((LINENUM *)start) == linenum)
	...
	jnz	.L43		#
# basic.c:401: 		from = start + start[sizeof(LINENUM)];
...
# basic.c:402: 		dest = start;
	ld.w	r0, [r13 + (-8)]	# tmp123, start
	st.w	[r13 + (-20)], r0	# dest, tmp123
# basic.c:404: 		tomove = program_end - from;
...
# basic.c:405: 		while (tomove > 0)
	j	.L44		#
.L45:
# basic.c:407: 			*dest = *from;
...
# basic.c:405: 		while (tomove > 0)
	...
	jnz	.L45		#
# basic.c:412: 		program_end = dest;
	ld.w	r0, [r13 + (-20)]	# tmp135, dest
	st.w	[program_end], r0	# program_end, tmp135
.L43:
# basic.c:415: 	if (txtpos[sizeof(LINENUM) + sizeof(char)] == NL)
...
# basic.c:415: 	if (txtpos[sizeof(LINENUM) + sizeof(char)] == NL)
	...
	jz	.L58		#
# basic.c:422: 	first_time = 1; // odd address hack
	mov.w	r0, 1	# tmp138,
	st.w	[r13 + (-16)], r0	# first_time, tmp138
# basic.c:424: 	while (linelen > 0)
	j	.L48		#
.L57:
# basic.c:430: 		space_to_make = txtpos - program_end;
...
# basic.c:435: 		tomove = program_end - start;
...
# basic.c:450: 		if(first_time && (txtpos[sizeof(LINENUM) + sizeof(char)] == ' '))
...
# basic.c:450: 		if(first_time && (txtpos[sizeof(LINENUM) + sizeof(char)] == ' '))
	...
	jnz	.L52		#
# basic.c:455: 			k = txtpos[sizeof(LINENUM)];
	ld.w	r0, [txtpos]	# txtpos.54_45, txtpos
	add.w	r0, 4 #111	# _46,
	ld.b	r0, [r0]	# _47, *_46
# basic.c:455: 			k = txtpos[sizeof(LINENUM)];
	st.b	[r13 + (-49)], r0	# k, _47
# basic.c:456: 			k -= sizeof(LINENUM) + sizeof(char); // actual length of line
	ld.b	r0, [r13 + (-49)]	# k.55_48, k
	add.w	r0, -5 #111	# tmp161,
	st.b	[r13 + (-49)], r0	# k, _49
# basic.c:457: 			for (l = 0; l < k; l++)
	xor.w	r0, r0	# tmp162
	st.w	[r13 + (-12)], r0	# l, tmp162
# basic.c:457: 			for (l = 0; l < k; l++)
	j	.L53		#
.L54:
# basic.c:459: 				txtpos[sizeof(LINENUM) + sizeof(char) + l] = txtpos[sizeof(LINENUM) + sizeof(char) + l + 1];
...
# basic.c:457: 			for (l = 0; l < k; l++)
	...
	jss	.L54		#
# basic.c:461: 			txtpos[k + sizeof(LINENUM) + sizeof(char) - 2] = 32;
...
# basic.c:462: 			txtpos[k + sizeof(LINENUM) + sizeof(char) - 1] = NL;
...
.L52:
# basic.c:467: 		for (tomove = 0; tomove < space_to_make; tomove++)
	xor.w	r0, r0	# tmp168
	st.w	[r13 + (-32)], r0	# tomove, tmp168
# basic.c:467: 		for (tomove = 0; tomove < space_to_make; tomove++)
	j	.L55		#
.L56:
# basic.c:469: 			*start = *txtpos;
...
# basic.c:467: 		for (tomove = 0; tomove < space_to_make; tomove++)
	...
	js	.L56		#
# basic.c:476: 		program_end = newEnd;
	ld.w	r0, [r13 + (-48)]	# tmp178, newEnd
	st.w	[program_end], r0	# program_end, tmp178
# basic.c:477: 		first_time = 0;  // odd address hack
	xor.w	r0, r0	# tmp179
...
exec_mem:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:499: 	printf("TinyBasic %s\n", kVersion);
	mov.w	r0, sp	# tmp29,
	mov.w	r1, .LC4	# tmp30,
	st.w	[r0 + (4)], r1	#, tmp30
	mov.w	r1, .LC5	# tmp31,
	st.w	[r0], r1	#, tmp31
	call	printf		#
# basic.c:500: 	printf("%d bytes free\n", variables_begin - program_end);
...
# basic.c:506: 	table_index = 0;
	xor.w	r0, r0	# tmp46
	st.b	[table_index], r0	# table_index, tmp46
.L71:
# basic.c:510: 		if (*table == 0)
...
# basic.c:527: 			if (*table == 0x01)
	...
	cmp.w	r1, r0	# tmp56, tmp57
	jnz	.L69		#
# basic.c:529: 				txtpos += i;  // Advance the pointer to following the keyword
...
# basic.c:556: 	txtpos++;
	...
	add.w	r0, 1 #111	# _4,
	st.w	[txtpos], r0	# txtpos, _4
# basic.c:559: 	while (txtpos[i] != delim)
	j	.L76		#
.L78:
# basic.c:561: 		if (txtpos[i] == NL)
...
# basic.c:559: 	while (txtpos[i] != delim)
	cmp.w	r1, r0	# _13, _14
	jnz	.L78		#
# basic.c:567: 	while (*txtpos != delim)
	j	.L79		#
.L80:
# basic.c:569: 		put_char(*txtpos);
...
# basic.c:567: 	while (*txtpos != delim)
	cmp.w	r1, r0	# _22, _23
	jnz	.L80		#
# basic.c:572: 	txtpos++; // Skip over the last delimiter
	ld.w	r0, [txtpos]	# txtpos.85_24, txtpos
	add.w	r0, 1 #111	# _25,
	st.w	[txtpos], r0	# txtpos, _25
# basic.c:574: 	return 1;
	mov.b	r0, 1	# _27,
.L75:
# basic.c:575: }
	mov.w	sp, r13	#,
...
check_no_arg_func:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:579: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:580: 	if (*txtpos != '(')
...
expr4:
	...
	push	r6		#
	sub.w	sp, 52 #111	#,
# basic.c:592: 	unsigned char f = table_index;
	ld.b	r0, [table_index]	# table_index.90_1, table_index
	st.b	[r13 + (-21)], r0	# f, table_index.90_1
# basic.c:595: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:601: 	if (*txtpos == '-') {
...
# basic.c:603: 		return -expr4();
	...
	j	.L87		#
.L86:
# basic.c:614: 	if (*txtpos >= '0' && *txtpos <= '9')
...
# basic.c:635: 		} while ((*txtpos >= '0' && *txtpos <= '9') || (*txtpos == '.'));
...
# basic.c:635: 		} while ((*txtpos >= '0' && *txtpos <= '9') || (*txtpos == '.'));
	...
	jz	.L93		#
# basic.c:639: 		return a;
	ld.w	r1, [r13 + (-8)]	# _98, a
	j	.L87		#
.L88:
# basic.c:646: 	if (txtpos[0] >= 'A' && txtpos[0] <= 'Z')
...
# basic.c:646: 	if (txtpos[0] >= 'A' && txtpos[0] <= 'Z')
	...
	cmp.w	r1, r0	# tmp159, tmp160
	jg	.L94		#
# basic.c:650: 		if (txtpos[1] < 'A' || txtpos[1] > 'Z')
...
# basic.c:650: 		if (txtpos[1] < 'A' || txtpos[1] > 'Z')
	...
	jse	.L96		#
.L95:
# basic.c:656: 			val = ((VAR *)variables_begin)[*txtpos - 'A'];
...
# basic.c:658: 			return val;
	ld.w	r1, [r13 + (-28)]	# _98, val
	j	.L87		#
.L96:
# basic.c:662: 		scantable(func_tab);
	mov.w	r1, sp	# tmp168,
	mov.w	r0, func_tab	# tmp169,
	st.w	[r1], r0	#, tmp169
	call	scantable		#
# basic.c:668: 		if (table_index == FUNC_UNKNOWN)
...
# basic.c:668: 		if (table_index == FUNC_UNKNOWN)
	...
	jz	.L124		#
# basic.c:671: 		switch(table_index)
	...
	j	.L122		#
.L99:
# basic.c:674: 			if (check_no_arg_func())
	call	check_no_arg_func		#
	mov.w	r1, r0	# _55,
# basic.c:674: 			if (check_no_arg_func())
	xor.w	r0, r0	# tmp174
	cmp.w	r1, r0	# _55, tmp174
	jnz	.L125		#
# basic.c:676: 			return getc();
	call	getc		#
	st.w	[sp], r0	#, _56
	call	__floatsisf		#
	mov.w	r1, r0	# _98,
	j	.L87		#
.L100:
# basic.c:678: 			if (check_no_arg_func())
	call	check_no_arg_func		#
	mov.w	r1, r0	# _57,
# basic.c:678: 			if (check_no_arg_func())
	xor.w	r0, r0	# tmp175
	cmp.w	r1, r0	# _57, tmp175
	jnz	.L126		#
# basic.c:680: 			return is_key_pressed();
	call	is_key_pressed		#
	st.w	[sp], r0	#, _58
	call	__floatsisf		#
	mov.w	r1, r0	# _98,
...
# basic.c:689: 		expression_error = 0;
	xor.w	r0, r0	# tmp178
	st.b	[expression_error], r0	# expression_error, tmp178
# basic.c:690: 		val = expression();
	call	expression		#
	st.w	[r13 + (-28)], r0	# val,
# basic.c:691: 		if (expression_error)
	ld.b	r0, [expression_error]	# expression_error.114_64, expression_error
# basic.c:691: 		if (expression_error)
	sex.b	r1, r0	# tmp179, expression_error.114_64
	xor.w	r0, r0	# tmp180
	cmp.w	r1, r0	# tmp179, tmp180
	jnz	.L128		#
# basic.c:694: 		ignore_blanks();
	call	ignore_blanks		#
# basic.c:699: 		VAR val2 = 0;
	xor.w	r0, r0	# tmp181
	st.w	[r13 + (-20)], r0	# val2, tmp181
# basic.c:700: 		if (*txtpos != ')')
	ld.w	r0, [txtpos]	# txtpos.115_65, txtpos
	ld.b	r0, [r0]	# _66, *txtpos.115_65
# basic.c:700: 		if (*txtpos != ')')
	zex.b	r1, r0	# tmp182, _66
	mov.w	r0, 41	# tmp183,
	cmp.w	r1, r0	# tmp182, tmp183
	jz	.L106		#
# basic.c:702: 			if (*txtpos == ',') 
	ld.w	r0, [txtpos]	# txtpos.116_67, txtpos
	ld.b	r0, [r0]	# _68, *txtpos.116_67
# basic.c:702: 			if (*txtpos == ',') 
	zex.b	r1, r0	# tmp184, _68
	mov.w	r0, 44	# tmp185,
...
# basic.c:705: 				expression_error = 0;
	xor.w	r0, r0	# tmp186
	st.b	[expression_error], r0	# expression_error, tmp186
# basic.c:706: 				val2 = expression();
	call	expression		#
	st.w	[r13 + (-20)], r0	# val2,
# basic.c:707: 				if (expression_error)
	ld.b	r0, [expression_error]	# expression_error.118_71, expression_error
# basic.c:707: 				if (expression_error)
	sex.b	r1, r0	# tmp187, expression_error.118_71
	xor.w	r0, r0	# tmp188
...
# basic.c:715: 		switch (f)
	ld.b	r0, [r13 + (-21)]	# _74, f
	mov.w	r1, 13	# tmp189,
	cmp.w	r0, r1	# _74, tmp189
	jz	.L108		#
	mov.w	r1, 13	# tmp190,
	cmp.w	r0, r1	# _74, tmp190
	jgs	.L94		#
	mov.w	r1, 12	# tmp191,
	cmp.w	r0, r1	# _74, tmp191
	jz	.L109		#
	mov.w	r1, 12	# tmp192,
	cmp.w	r0, r1	# _74, tmp192
	jgs	.L94		#
	mov.w	r1, 11	# tmp193,
	...
	j	.L94		#
.L116:
# basic.c:718: 				return buffer[(int)val];
	ld.w	r6, [buffer]	# buffer.120_75, buffer
# basic.c:718: 				return buffer[(int)val];
	ld.w	r0, [r13 + (-28)]	# tmp207, val
	st.w	[sp], r0	#, tmp207
	call	__fixsfsi		#
	mov.w	r1, r0	# _77, _76
# basic.c:718: 				return buffer[(int)val];
	...
	ld.b	r0, [r0]	# _79, *_78
	sex.b	r0, r0	# tmp208, _79
	st.w	[sp], r0	#, tmp208
	call	__floatsisf		#
	mov.w	r1, r0	# _98,
	j	.L87		#
.L117:
# basic.c:720: 				if (val < 0)
	xor.w	r0, r0	# tmp209
	st.w	[sp + (4)], r0	#, tmp209
	ld.w	r0, [r13 + (-28)]	# tmp210, val
	st.w	[sp], r0	#, tmp210
	call	__ltsf2		#
	mov.w	r1, r0	# tmp211,
	xor.w	r0, r0	# tmp212
	...
	jges	.L123		#
# basic.c:721: 					return -val;
	ld.w	r1, [r13 + (-28)]	# tmp213, val
	mov.w	r0, -2147483648	# tmp214,
	xor.w	r1, r0	# _98, tmp214
	j	.L87		#
.L123:
# basic.c:722: 				return val;
	ld.w	r1, [r13 + (-28)]	# _98, val
	j	.L87		#
.L115:
# basic.c:724: 				return(rand() % (int)val);
	call	rand		#
	mov.w	r6, r0	# _80,
# basic.c:724: 				return(rand() % (int)val);
	ld.w	r0, [r13 + (-28)]	# tmp215, val
	st.w	[sp], r0	#, tmp215
	call	__fixsfsi		#
	mov.w	r1, r0	# _81,
# basic.c:724: 				return(rand() % (int)val);
...
# basic.c:728: 				return(cosf(val));
	...
	j	.L87		#
.L112:
# basic.c:730: 				return(tanf(val));
	mov.w	r1, sp	# tmp220,
	ld.w	r0, [r13 + (-28)]	# tmp221, val
	st.w	[r1], r0	#, tmp221
	call	tanf		#
	mov.w	r1, r0	# _98,
	j	.L87		#
.L111:
# basic.c:732: 				return(expf(val));
	mov.w	r1, sp	# tmp222,
	ld.w	r0, [r13 + (-28)]	# tmp223, val
	st.w	[r1], r0	#, tmp223
	call	expf		#
	mov.w	r1, r0	# _98,
	j	.L87		#
.L110:
# basic.c:734: 				return(logf(val));
	mov.w	r1, sp	# tmp224,
...
# basic.c:736: 				return(sqrtf(val));
	...
	j	.L87		#
.L108:
# basic.c:738: 				return(powf(val, val2));
	mov.w	r0, sp	# tmp228,
	ld.w	r1, [r13 + (-20)]	# tmp229, val2
	st.w	[r0 + (4)], r1	#, tmp229
	ld.w	r1, [r13 + (-28)]	# tmp230, val
	st.w	[r0], r1	#, tmp230
	call	powf		#
	mov.w	r1, r0	# _98,
	j	.L87		#
.L94:
# basic.c:742: 	if (*txtpos == '(')
	ld.w	r0, [txtpos]	# txtpos.121_83, txtpos
	ld.b	r0, [r0]	# _84, *txtpos.121_83
# basic.c:742: 	if (*txtpos == '(')
	zex.b	r1, r0	# tmp231, _84
	mov.w	r0, 40	# tmp232,
...
# basic.c:746: 		a = expression();
	call	expression		#
	st.w	[r13 + (-32)], r0	# a,
# basic.c:747: 		if (*txtpos != ')')
	ld.w	r0, [txtpos]	# txtpos.123_87, txtpos
	ld.b	r0, [r0]	# _88, *txtpos.123_87
# basic.c:747: 		if (*txtpos != ')')
	zex.b	r1, r0	# tmp233, _88
	mov.w	r0, 41	# tmp234,
...
# basic.c:686: 			goto expr4_error;
	...
	j	.L98		#
.L128:
# basic.c:692: 			goto expr4_error;
	nop	
	j	.L98		#
.L129:
# basic.c:710: 				goto expr4_error;
	nop	
	j	.L98		#
.L130:
# basic.c:708: 					goto expr4_error;
	nop	
	j	.L98		#
.L131:
# basic.c:754: expr4_error:
	nop	
	j	.L98		#
.L132:
# basic.c:748: 			goto expr4_error;
	nop	
.L98:
# basic.c:755: 	expression_error = 1;
	mov.b	r0, 1	# tmp235,
	st.b	[expression_error], r0	# expression_error, tmp235
# basic.c:756: 	return 0;
	xor.w	r1, r1	# _98
.L87:
# basic.c:758: }
...
# basic.c:765: 	a = expr4();
	call	expr4		#
	st.w	[r13 + (-8)], r0	# a,
# basic.c:767: 	ignore_blanks(); // fix for eg:  100 a = a + 1
	call	ignore_blanks		#
.L143:
# basic.c:771: 		if (*txtpos == '*')
...
# basic.c:782: 				a /= b;
	...
	j	.L143		#
.L146:
# basic.c:784: 				expression_error = 1;
	mov.b	r0, 1	# tmp58,
	st.b	[expression_error], r0	# expression_error, tmp58
	j	.L143		#
.L136:
# basic.c:786: 		else if (*txtpos == '%')
...
# basic.c:793: 				a = x;
	...
	j	.L143		#
.L147:
# basic.c:795: 				expression_error = 1;
	mov.b	r0, 1	# tmp71,
	st.b	[expression_error], r0	# expression_error, tmp71
	j	.L143		#
.L139:
# basic.c:798: 			return a;
	ld.w	r0, [r13 + (-8)]	# _23, a
	mov.w	r1, r0	# <retval>, _23
# basic.c:800: }
	mov.w	r0, r1	#, <retval>
...
# basic.c:836: 	a = expr2();
	call	expr2		#
	st.w	[r13 + (-4)], r0	# a,
# basic.c:843: 	if (expression_error)	return a;
...
# basic.c:843: 	if (expression_error)	return a;
	...
	j	.L161		#
.L160:
# basic.c:845: 	scantable(relop_tab);
	mov.w	r1, sp	# tmp34,
	mov.w	r0, relop_tab	# tmp35,
	st.w	[r1], r0	#, tmp35
	call	scantable		#
# basic.c:851: 	if (table_index == RELOP_UNKNOWN)
...
# basic.c:851: 	if (table_index == RELOP_UNKNOWN)
	...
	cmp.w	r1, r0	# tmp36, tmp37
	jnz	.L162		#
# basic.c:852: 		return a;
	ld.w	r0, [r13 + (-4)]	# _5, a
	j	.L161		#
.L162:
# basic.c:854: 	switch (table_index)
...
assignment:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 32 #111	#,
# basic.c:898: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:901: 		return;
	j	.L198		#
.L200:
# basic.c:906: 	var = (VAR *)variables_begin + *txtpos - 'A';
...
# basic.c:912: 	txtpos++;
	...
	add.w	r0, 1 #111	# _12,
	st.w	[txtpos], r0	# txtpos, _12
# basic.c:914: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:916: 	if (*txtpos != '=')
...
# basic.c:922: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:923: 	expression_error = 0;
	xor.w	r0, r0	# tmp56
	st.b	[expression_error], r0	# expression_error, tmp56
# basic.c:924: 	value = expression();
	call	expression		#
	st.w	[r13 + (-8)], r0	# value,
# basic.c:925: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:932: 	if (expression_error)
...
# basic.c:935: 		return;
	j	.L198		#
.L203:
# basic.c:938: 	if (*txtpos != NL && *txtpos != ':')
...
# basic.c:953: 	if (*txtpos == NL)
	...
	jz	.L220		#
.L206:
# basic.c:960: 		ignore_blanks(txtpos);
	ld.w	r0, [txtpos]	# txtpos.151_3, txtpos
	mov.w	r1, sp	# tmp63,
	st.w	[r1], r0	#, txtpos.151_3
	call	ignore_blanks		#
# basic.c:961: 		if (print_quoted_string())
...
# basic.c:961: 		if (print_quoted_string())
	...
	cmp.w	r1, r0	# tmp64, tmp65
	jz	.L208		#
# basic.c:963: 			ignore_blanks(txtpos);
	...
	j	.L209		#
.L208:
# basic.c:965: 		else if (*txtpos == '"' || *txtpos == '\'')
...
# basic.c:968: 			return;
	j	.L205		#
.L211:
# basic.c:973: 			expression_error = 0;
	xor.w	r0, r0	# tmp71
	st.b	[expression_error], r0	# expression_error, tmp71
# basic.c:974: 			e = expression();
	call	expression		#
	st.w	[r13 + (-4)], r0	# e,
# basic.c:975: 			if (expression_error)
...
# basic.c:978: 				return;
	j	.L205		#
.L212:
# basic.c:980: 			printf("%f", roundf(e*10000.0f) / 10000.0f);
...
# basic.c:984: 		if (*txtpos == ',')
	...
	jnz	.L213		#
# basic.c:985: 			txtpos++;	// Skip the comma and move onto the next
	ld.w	r0, [txtpos]	# txtpos.157_17, txtpos
	add.w	r0, 1 #111	# _18,
	st.w	[txtpos], r0	# txtpos, _18
	j	.L206		#
.L213:
# basic.c:986: 		else if (txtpos[0] == ';' && (txtpos[1] == NL || txtpos[1] == ':' || txtpos[1] == ' '))
...
# basic.c:986: 		else if (txtpos[0] == ';' && (txtpos[1] == NL || txtpos[1] == ':' || txtpos[1] == ' '))
	...
	jnz	.L215		#
.L216:
# basic.c:988: 			txtpos++; // This has to be the end of the print - no newline
...
# basic.c:989: 			break;
	j	.L205		#
.L215:
# basic.c:991: 		else if (*txtpos == NL || *txtpos == ':')
...
exec_list:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 32 #111	#,
# basic.c:1008: 	linenum = testnum(); // Retuns 0 if no line found.
	call	testnum		#
	mov.w	r1, r0	# _1,
# basic.c:1008: 	linenum = testnum(); // Retuns 0 if no line found.
...
# basic.c:1014: 		return;
	j	.L221		#
.L222:
# basic.c:1018: 	list_line = findline();
	call	findline		#
# basic.c:1018: 	list_line = findline();
...
# basic.c:1020: 	while (list_line < program_end)
	j	.L224		#
.L225:
# basic.c:1022: 		printline();
	call	printline		#
# basic.c:1023: 		i++;
	ld.w	r0, [r13 + (-4)]	# tmp38, i
	add.w	r0, 1 #111	# tmp37,
	st.w	[r13 + (-4)], r0	# i, tmp37
# basic.c:1024: 		if (i == 29)
...
exec_run:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 28 #111	#,
# basic.c:1038: 	while (current_line < program_end) // Out of lines to run
	j	.L228		#
.L233:
# basic.c:1040: 		txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	ld.w	r0, [current_line]	# current_line.168_1, current_line
	add.w	r0, 5 #111	# _2,
# basic.c:1040: 		txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	st.w	[txtpos], r0	# txtpos, _2
.L232:
# basic.c:1043: 			res = direct();
	call	direct		#
	st.w	[r13 + (-4)], r0	# res,
# basic.c:1044: 			if (res == 1)
	ld.w	r1, [r13 + (-4)]	# tmp42, res
	mov.w	r0, 1	# tmp43,
	cmp.w	r1, r0	# tmp42, tmp43
	jz	.L234		#
# basic.c:1046: 			ignore_blanks();
	call	ignore_blanks		#
# basic.c:1047: 			if (*txtpos == NL || *txtpos != ':')
...
# basic.c:1049: 			txtpos++;
	...
	add.w	r0, 1 #111	# _8,
	st.w	[txtpos], r0	# txtpos, _8
# basic.c:1050: 			ignore_blanks();
	call	ignore_blanks		#
# basic.c:1043: 			res = direct();
	j	.L232		#
.L231:
# basic.c:1053: 		if (res < 2)
	ld.w	r1, [r13 + (-4)]	# tmp48, res
	mov.w	r0, 1	# tmp49,
	cmp.w	r1, r0	# tmp48, tmp49
	jgs	.L228		#
# basic.c:1054: 			current_line += current_line[sizeof(LINENUM)];
...
exec_if:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 32 #111	#,
# basic.c:1067: 	expression_error = 0;
	xor.w	r0, r0	# tmp37
	st.b	[expression_error], r0	# expression_error, tmp37
# basic.c:1068: 	condition = expression();
	call	expression		#
	st.w	[r13 + (-4)], r0	# condition,
# basic.c:1069: 	if (expression_error || *txtpos == NL)
...
# basic.c:1092: 	return;
	j	.L246		#
.L244:
# basic.c:1077: 			res = direct();
	call	direct		#
	st.w	[r13 + (-8)], r0	# res,
# basic.c:1078: 			if (res == 1)
	ld.w	r1, [r13 + (-8)]	# tmp46, res
	mov.w	r0, 1	# tmp47,
	cmp.w	r1, r0	# tmp46, tmp47
	jz	.L245		#
# basic.c:1080: 			if (res == 2)
	ld.w	r1, [r13 + (-8)]	# tmp48, res
	mov.w	r0, 2	# tmp49,
	cmp.w	r1, r0	# tmp48, tmp49
	jnz	.L242		#
# basic.c:1082: 				txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	ld.w	r0, [current_line]	# current_line.178_4, current_line
	add.w	r0, 5 #111	# _5,
# basic.c:1082: 				txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	st.w	[txtpos], r0	# txtpos, _5
# basic.c:1083: 				continue;
	j	.L243		#
.L242:
# basic.c:1085: 			ignore_blanks();
	call	ignore_blanks		#
# basic.c:1086: 			if (*txtpos == NL || *txtpos != ':')
...
exec_for:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 44 #111	#,
# basic.c:1100: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1101: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:1108: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1109: 	if (*txtpos != '=')
...
# basic.c:1114: 	txtpos++;
	...
	add.w	r0, 1 #111	# _11,
	st.w	[txtpos], r0	# txtpos, _11
# basic.c:1115: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1117: 	expression_error = 0;
	xor.w	r0, r0	# tmp71
	st.b	[expression_error], r0	# expression_error, tmp71
# basic.c:1118: 	initial = expression();
	call	expression		#
	st.w	[r13 + (-12)], r0	# initial,
# basic.c:1119: 	if (expression_error)
...
# basic.c:1122: 		return;
	j	.L247		#
.L252:
# basic.c:1125: 	scantable(to_tab);
	mov.w	r1, sp	# tmp74,
	mov.w	r0, to_tab	# tmp75,
	st.w	[r1], r0	#, tmp75
	call	scantable		#
# basic.c:1126: 	if (table_index != 0)
...
# basic.c:1129: 		return;
	j	.L247		#
.L253:
# basic.c:1132: 	terminal = expression();
	call	expression		#
	st.w	[r13 + (-16)], r0	# terminal,
# basic.c:1133: 	if (expression_error)
...
# basic.c:1136: 		return;
	j	.L247		#
.L254:
# basic.c:1139: 	scantable(step_tab);
	mov.w	r1, sp	# tmp80,
	mov.w	r0, step_tab	# tmp81,
	st.w	[r1], r0	#, tmp81
	call	scantable		#
# basic.c:1140: 	if (table_index == 0)
...
# basic.c:1140: 	if (table_index == 0)
	...
	jnz	.L255		#
# basic.c:1142: 		step = expression();
	call	expression		#
	st.w	[r13 + (-4)], r0	# step,
# basic.c:1143: 		if (expression_error)
...
.L256:
# basic.c:1152: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1153: 	if (*txtpos != NL && *txtpos != ':')
...
# basic.c:1156: 		return;
	j	.L247		#
.L257:
# basic.c:1159: 	if (!expression_error && ((*txtpos == NL) || (*txtpos == ':')))
...
# basic.c:1159: 	if (!expression_error && ((*txtpos == NL) || (*txtpos == ':')))
	...
	jnz	.L258		#
.L259:
# basic.c:1162: 		if (bsp + sizeof(struct stack_for_frame) < stack_limit)
...
# basic.c:1165: 			return;
	j	.L247		#
.L260:
# basic.c:1168: 		bsp -= sizeof(struct stack_for_frame);
	ld.w	r0, [bsp]	# bsp.200_29, bsp
	add.w	r0, -20 #111	# _30,
	st.w	[bsp], r0	# bsp, _30
# basic.c:1169: 		f = (struct stack_for_frame *)bsp;
	ld.w	r0, [bsp]	# tmp97, bsp
	st.w	[r13 + (-20)], r0	# f, tmp97
# basic.c:1170: 		((VAR *)variables_begin)[var - 'A'] = initial;
...
exec_return:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 44 #111	#,
# basic.c:1195: 	tempsp = bsp;
	ld.w	r0, [bsp]	# bsp.205_1, bsp
	st.w	[tempsp], r0	# tempsp, bsp.205_1
# basic.c:1196: 	while (tempsp < program + kRamSize - 1)
	j	.L262		#
.L276:
# basic.c:1202: 		switch (tempsp[0])
...
# basic.c:1202: 		switch (tempsp[0])
	...
	jnz	.L264		#
# basic.c:1205: 			if (table_index == KW_RETURN)
...
# basic.c:1205: 			if (table_index == KW_RETURN)
	...
	cmp.w	r1, r0	# tmp72, tmp73
	jnz	.L265		#
# basic.c:1207: 				struct stack_gosub_frame *f = (struct stack_gosub_frame *)tempsp;
	ld.w	r0, [tempsp]	# tmp74, tempsp
	st.w	[r13 + (-12)], r0	# f, tmp74
# basic.c:1208: 				current_line = f->current_line;
	ld.w	r0, [r13 + (-12)]	# tmp75, f
	ld.w	r0, [r0 + (4)]	# _6, f_53->current_line
# basic.c:1208: 				current_line = f->current_line;
	st.w	[current_line], r0	# current_line, _6
# basic.c:1209: 				txtpos = f->txtpos;
	ld.w	r0, [r13 + (-12)]	# tmp76, f
	ld.w	r0, [r0 + (8)]	# _7, f_53->txtpos
# basic.c:1209: 				txtpos = f->txtpos;
	st.w	[txtpos], r0	# txtpos, _7
# basic.c:1210: 				bsp += sizeof(struct stack_gosub_frame);
	ld.w	r0, [bsp]	# bsp.208_8, bsp
	add.w	r0, 12 #111	# _9,
	st.w	[bsp], r0	# bsp, _9
# basic.c:1211: 				return 0;
	xor.w	r0, r0	# _45
	j	.L266		#
.L265:
# basic.c:1214: 			tempsp += sizeof(struct stack_gosub_frame);
...
# basic.c:1215: 			break;
	j	.L262		#
.L263:
# basic.c:1218: 			if (table_index == KW_NEXT)
...
# basic.c:1218: 			if (table_index == KW_NEXT)
	...
	jnz	.L267		#
# basic.c:1220: 				struct stack_for_frame *f = (struct stack_for_frame *)tempsp;
	ld.w	r0, [tempsp]	# tmp79, tempsp
	st.w	[r13 + (-16)], r0	# f, tmp79
# basic.c:1222: 				var = txtpos[-1];
...
# basic.c:1224: 				while (var == ' ') 
	j	.L268		#
.L269:
# basic.c:1226: 					var = txtpos[i];
...
# basic.c:1229: 				if (var == f->for_var)
	...
	jnz	.L267		#
# basic.c:1231: 					VAR *varaddr = ((VAR *)variables_begin) + var - 'A';
...
# basic.c:1232: 					*varaddr = *varaddr + f->step;
...
# basic.c:1234: 					if ((f->step > 0 && *varaddr <= f->terminal) || (f->step < 0 && *varaddr >= f->terminal))
...
# basic.c:1234: 					if ((f->step > 0 && *varaddr <= f->terminal) || (f->step < 0 && *varaddr >= f->terminal))
	...
	jss	.L273		#
.L272:
# basic.c:1237: 						txtpos = f->txtpos;
	ld.w	r0, [r13 + (-16)]	# tmp120, f
	ld.w	r0, [r0 + (16)]	# _34, f_58->txtpos
# basic.c:1237: 						txtpos = f->txtpos;
	st.w	[txtpos], r0	# txtpos, _34
# basic.c:1238: 						current_line = f->current_line;
	ld.w	r0, [r13 + (-16)]	# tmp121, f
	ld.w	r0, [r0 + (12)]	# _35, f_58->current_line
# basic.c:1238: 						current_line = f->current_line;
	st.w	[current_line], r0	# current_line, _35
# basic.c:1239: 						return 0;
	xor.w	r0, r0	# _45
	j	.L266		#
.L273:
# basic.c:1242: 					bsp = tempsp + sizeof(struct stack_for_frame);
	ld.w	r0, [tempsp]	# tempsp.215_36, tempsp
	add.w	r0, 20 #111	# _37,
# basic.c:1242: 					bsp = tempsp + sizeof(struct stack_for_frame);
	st.w	[bsp], r0	# bsp, _37
# basic.c:1243: 					return 0;
	xor.w	r0, r0	# _45
	j	.L266		#
.L267:
# basic.c:1247: 			tempsp += sizeof(struct stack_for_frame);
...
# basic.c:1248: 			break;
	j	.L262		#
.L264:
# basic.c:1250: 			printf("Stack is stuffed!\n");
	mov.w	r1, sp	# tmp122,
	mov.w	r0, .LC8	# tmp123,
	st.w	[r1], r0	#, tmp123
	call	puts		#
# basic.c:1251: 			return 1;
	mov.w	r0, 1	# _45,
	j	.L266		#
.L262:
# basic.c:1196: 	while (tempsp < program + kRamSize - 1)
...
exec_next:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:1262: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1266: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:1275: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1276: 	if (*txtpos != ':' && *txtpos != NL)
...
exec_gosub:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 28 #111	#,
# basic.c:1285: 	expression_error = 0;
	xor.w	r0, r0	# tmp39
	st.b	[expression_error], r0	# expression_error, tmp39
# basic.c:1286: 	linenum = expression();
	call	expression		#
	mov.w	r1, r0	# _1,
# basic.c:1286: 	linenum = expression();
	...
	call	__fixsfsi		#
	st.w	[linenum], r0	# linenum, _2
# basic.c:1287: 	if (!expression_error && *txtpos == NL)
...
# basic.c:1287: 	if (!expression_error && *txtpos == NL)
	...
	cmp.w	r1, r0	# tmp43, tmp44
	jnz	.L285		#
# basic.c:1290: 		if (bsp + sizeof(struct stack_gosub_frame) < stack_limit)
...
# basic.c:1301: 		current_line = findline();
	call	findline		#
# basic.c:1301: 		current_line = findline();
	st.w	[current_line], r0	# current_line, _13
# basic.c:1302: 		exec_run();
	call	exec_run		#
# basic.c:1303: 		return;
	j	.L284		#
.L285:
...
exec_input:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 32 #111	#,
# basic.c:1314: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1316: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:1323: 	txtpos++;
	...
	add.w	r0, 1 #111	# _7,
	st.w	[txtpos], r0	# txtpos, _7
# basic.c:1324: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1326: 	if (*txtpos != NL && *txtpos != ':')
...
# basic.c:1335: 		getln('?');
	...
	st.w	[r1], r0	#, tmp57
	call	getln		#
# basic.c:1336: 		toUppercaseBuffer();
	call	toUppercaseBuffer		#
# basic.c:1337: 		txtpos = program_end + sizeof(VAR);
	ld.w	r0, [program_end]	# program_end.238_13, program_end
	add.w	r0, 4 #111	# _14,
# basic.c:1337: 		txtpos = program_end + sizeof(VAR);
	st.w	[txtpos], r0	# txtpos, _14
# basic.c:1338: 		ignore_blanks();
	call	ignore_blanks		#
# basic.c:1339: 		expression_error = 0;
	xor.w	r0, r0	# tmp58
	st.b	[expression_error], r0	# expression_error, tmp58
# basic.c:1340: 		value = expression();
	call	expression		#
	st.w	[r13 + (-8)], r0	# value,
# basic.c:1341: 		if (!expression_error)
...
# basic.c:1342: 			break;
	nop	
# basic.c:1344: 	((VAR *)variables_begin)[var - 'A'] = value;
...
exec_edit:
	...
	push	r6		#
	sub.w	sp, 36 #111	#,
# basic.c:1354: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1355: 	expression_error = 0;
	xor.w	r0, r0	# tmp62
	st.b	[expression_error], r0	# expression_error, tmp62
# basic.c:1356: 	linenum = expression();
	call	expression		#
	mov.w	r1, r0	# _1,
# basic.c:1356: 	linenum = expression();
	...
	call	__fixsfsi		#
	st.w	[linenum], r0	# linenum, _2
# basic.c:1357: 	if (expression_error)
...
# basic.c:1359: 		qhow();
	call	qhow		#
# basic.c:1360: 		return 0;
	xor.w	r0, r0	# _33
	j	.L300		#
.L299:
# basic.c:1362: 	line = findline();
	call	findline		#
	st.w	[r13 + (-16)], r0	# line,
# basic.c:1363: 	if (line == program_end)
...
# basic.c:1365: 		qhow();
	call	qhow		#
# basic.c:1366: 		return 0;
	xor.w	r0, r0	# _33
	j	.L300		#
.L301:
# basic.c:1369: 	txtpos = program_end + sizeof(LINENUM);
	ld.w	r0, [program_end]	# program_end.244_5, program_end
	add.w	r0, 4 #111	# _6,
# basic.c:1369: 	txtpos = program_end + sizeof(LINENUM);
	st.w	[txtpos], r0	# txtpos, _6
# basic.c:1370: 	txtpos[0] = 0;
	ld.w	r0, [txtpos]	# txtpos.245_7, txtpos
# basic.c:1370: 	txtpos[0] = 0;
	xor.w	r1, r1	# tmp67
	st.b	[r0], r1	# *txtpos.245_7, tmp67
# basic.c:1371: 	sprintf(txtpos, "%d ", linenum);
	...
	call	sprintf		#
# basic.c:1372: 	j = strlen(txtpos);
	ld.w	r0, [txtpos]	# txtpos.248_10, txtpos
	mov.w	r1, sp	# tmp70,
	st.w	[r1], r0	#, txtpos.248_10
	call	strlen		#
	st.w	[r13 + (-12)], r0	# j,
# basic.c:1373: 	for (i = sizeof(VAR) + 1; i < line[sizeof(VAR)] - 1; i++)
	mov.w	r0, 5	# tmp71,
	st.w	[r13 + (-8)], r0	# i, tmp71
# basic.c:1373: 	for (i = sizeof(VAR) + 1; i < line[sizeof(VAR)] - 1; i++)
	j	.L302		#
.L303:
# basic.c:1376: 		txtpos[j++] = line[i];
...
# basic.c:1396: 	memcpy(to_print_buff, eth_buffer+off, len);
...
eth_read_file:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 40 #111	#,
# basic.c:1403: 	int len = 0;
	xor.w	r0, r0	# tmp44
	st.w	[r13 + (-4)], r0	# len, tmp44
# basic.c:1404: 	int init_offset = 0;
	xor.w	r0, r0	# tmp45
	st.w	[r13 + (-8)], r0	# init_offset, tmp45
# basic.c:1405: 	int size = 1000000;
	mov.w	r0, 1000000	# tmp46,
	st.w	[r13 + (-12)], r0	# size, tmp46
# basic.c:1406: 	int fail_count = 0;
	xor.w	r0, r0	# tmp47
	st.w	[r13 + (-16)], r0	# fail_count, tmp47
# basic.c:1407: 	printf("Loading file %s from the ethernet network drive\n", file_name);
	mov.w	r0, sp	# tmp48,
	...
	st.w	[r0], r1	#, tmp50
	call	printf		#
# basic.c:1408: 	to_print_len = 0;
	xor.w	r0, r0	# tmp51
	st.w	[to_print_len], r0	# to_print_len, tmp51
# basic.c:1409: 	asm ("irq 0\n"); // IRQ 0000, xxx0 <- turn off timer irq
# 1409 "basic.c" 1
	irq 0

# basic.c:1410: 	browseUrl("/load:", file_name, server_ip, 0, my_callback);
	mov.w	r0, sp	# tmp52,
...
# basic.c:1419: 				size |= to_print_buff[2];
...
# basic.c:1421: 				size |= to_print_buff[1];
...
# basic.c:1423: 				size |= to_print_buff[0];
...
# basic.c:1424: 				init_offset = 4;
	mov.w	r0, 4	# tmp79,
	st.w	[r13 + (-8)], r0	# init_offset, tmp79
# basic.c:1425: 				if (size == 0) {
	ld.w	r1, [r13 + (-12)]	# tmp80, size
	xor.w	r0, r0	# tmp81
	cmp.w	r1, r0	# tmp80, tmp81
	jnz	.L310		#
# basic.c:1426: 					printf("File %s does not exist\n", file_name);
	mov.w	r0, sp	# tmp82,
...
# basic.c:1433: 			printf("#");
	...
	st.w	[r1], r0	#, tmp90
	call	putchar		#
# basic.c:1434: 			fail_count = 0;
	xor.w	r0, r0	# tmp91
	st.w	[r13 + (-16)], r0	# fail_count, tmp91
# basic.c:1435: 			to_print_buff[to_print_len] = 0;
...
# basic.c:1436: 			memcpy(buffer + len, to_print_buff + init_offset, to_print_len);
...
# basic.c:1436: 			memcpy(buffer + len, to_print_buff + init_offset, to_print_len);
	...
	st.w	[r0], r1	#, _11
	call	memcpy		#
# basic.c:1437: 			len += to_print_len - init_offset;
...
# basic.c:1412: 	while (len < size) {
	...
	jss	.L313		#
.L311:
# basic.c:1452: 	asm ("irq 1\n"); // IRQ 0000, xxx1 <- turn on timer irq
# 1452 "basic.c" 1
	irq 1

# basic.c:1453: 	return len;
...
# basic.c:1470: 	if (eth)
	...
	jz	.L316		#
# basic.c:1471: 		mainLoop(eth_buffer);
	mov.w	r1, sp	# tmp28,
	mov.w	r0, eth_buffer	# tmp29,
	st.w	[r1], r0	#, tmp29
	call	mainLoop		#
.L316:
# basic.c:1474: 	asm("pop r13\npop r13\n");
# 1474 "basic.c" 1
	pop r13
pop r13
...
exec_load:
	...
	push	r6		#
	sub.w	sp, 168 #111	#,
# basic.c:1501: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1502: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:1505: 		return;
	j	.L319		#
.L321:
# basic.c:1509: 	for (i = 0; txtpos[i] != NL && txtpos[i] != CR && txtpos[i] != SPACE && txtpos[i] != TAB && i < 32; i++)
	xor.w	r0, r0	# tmp120
	st.w	[r13 + (-8)], r0	# i, tmp120
# basic.c:1509: 	for (i = 0; txtpos[i] != NL && txtpos[i] != CR && txtpos[i] != SPACE && txtpos[i] != TAB && i < 32; i++)
	j	.L323		#
.L325:
# basic.c:1512: 		s[i] = txtpos[i];
...
# basic.c:1514: 	s[i] = 0;
	...
	xor.w	r1, r1	# tmp139
	st.b	[r0], r1	# s, tmp139
# basic.c:1516: 	printf("Loading file: <%s>\n", s);
	mov.w	r0, sp	# tmp140,
	mov.w	r1, r13	# tmp141,
...
# basic.c:1517: 	if (drive == 2) {
	...
	jnz	.L326		#
# basic.c:1520: 		delay(100);
	mov.w	r1, sp	# tmp145,
	mov.w	r0, 100	# tmp146,
	st.w	[r1], r0	#, tmp146
	call	delay		#
# basic.c:1521: 		i = uart_read_file(buffer, s);
...
# basic.c:1523: 	} else if (drive == 0)
	...
	jnz	.L328		#
# basic.c:1527: load_load_again:		
	nop	
.L329:
# basic.c:1528: 		if(file_open(s, &fd, O_READ))
	mov.w	r0, sp	# tmp151,
	xor.w	r1, r1	# tmp152
	st.w	[r0 + (8)], r1	#, tmp152
	mov.w	r1, r13	# tmp153,
...
# basic.c:1528: 		if(file_open(s, &fd, O_READ))
	...
	cmp.w	r1, r0	# tmp155, tmp156
	jz	.L330		#
# basic.c:1530: 			int len = fd.dir_entry.filesize;
	ld.w	r0, [r13 + (-116)]	# _30, fd.dir_entry.filesize
# basic.c:1530: 			int len = fd.dir_entry.filesize;
	st.w	[r13 + (-32)], r0	# len, _30
# basic.c:1531: 			int total = 0;
	xor.w	r0, r0	# tmp157
	st.w	[r13 + (-20)], r0	# total, tmp157
# basic.c:1533: 			while(total < len)
	j	.L331		#
.L334:
# basic.c:1535: 				current = file_read(&fd, &buffer[total], 512);
...
# basic.c:1539: 						printf("#");
	...
	j	.L331		#
.L332:
# basic.c:1541: 					printf("Error reading file!\n");
	mov.w	r1, sp	# tmp172,
...
# basic.c:1551: 			strcpy(fileName, s);
	mov.w	r0, sp	# tmp178,
	mov.w	r1, r13	# tmp179,
	...
	st.w	[r0], r1	#, tmp180
	call	strcpy		#
# basic.c:1552: 			int sum = 0;
	xor.w	r0, r0	# tmp181
	st.w	[r13 + (-24)], r0	# sum, tmp181
# basic.c:1553: 			for (int j = 0; j < i; j++) {
	xor.w	r0, r0	# tmp182
	st.w	[r13 + (-28)], r0	# j, tmp182
# basic.c:1553: 			for (int j = 0; j < i; j++) {
	j	.L335		#
.L336:
# basic.c:1554: 				sum += buffer[j];
...
# basic.c:1556: 			printf("\nSum: %d\n", sum);
	...
	j	.L327		#
.L330:
# basic.c:1559: 			printf("SD card file open failed\n");
	mov.w	r1, sp	# tmp192,
...
# basic.c:1560: 			return;
	j	.L319		#
.L328:
# basic.c:1565: 		i = eth_read_file(buffer, s);
...
# basic.c:1568: 	if (i > 0)
	...
	jses	.L337		#
# basic.c:1570: 		printf("File size: %d\n", i);
	mov.w	r0, sp	# tmp198,
	...
	st.w	[r0], r1	#, tmp200
	call	printf		#
# basic.c:1571: 		if (strstr(s, ".BIN") != (char *)0) 
	mov.w	r0, sp	# tmp201,
...
# basic.c:1571: 		if (strstr(s, ".BIN") != (char *)0) 
	...
	jz	.L338		#
# basic.c:1573: 			printf("Loaded executable file. Run it using: SYS 0\n");
	mov.w	r1, sp	# tmp205,
...
# basic.c:1574: 			return;
	j	.L319		#
.L338:
# basic.c:1575: 		} else if (strstr(s, ".BAS") == (char *)0) 
	mov.w	r0, sp	# tmp207,
...
# basic.c:1575: 		} else if (strstr(s, ".BAS") == (char *)0) 
	...
	jnz	.L339		#
# basic.c:1577: 			printf("Loaded successfuly at address 0 (reachable by PEEK and POKE).\n");
	mov.w	r1, sp	# tmp211,
...
# basic.c:1578: 			return;
	j	.L319		#
.L339:
# basic.c:1580: 		program_end = program_start;
...
# basic.c:1582: 		for (j = 0; j <= i; j++)
	xor.w	r0, r0	# tmp214
	st.w	[r13 + (-12)], r0	# j, tmp214
# basic.c:1582: 		for (j = 0; j <= i; j++)
	j	.L340		#
.L345:
# basic.c:1584: 			if (buffer[j] == CR)
...
.L341:
# basic.c:1588: 			if (buffer[j] == NL || buffer[j] == 0)
...
# basic.c:1588: 			if (buffer[j] == NL || buffer[j] == 0)
	...
	jnz	.L343		#
.L342:
# basic.c:1590: 				txtpos = program_end + sizeof(LINENUM);
	ld.w	r0, [program_end]	# program_end.306_67, program_end
	add.w	r0, 4 #111	# _68,
# basic.c:1590: 				txtpos = program_end + sizeof(LINENUM);
	st.w	[txtpos], r0	# txtpos, _68
# basic.c:1591: 				strncpy(txtpos, &buffer[k], j);
...
.L344:
# basic.c:1598: 				toUppercaseBuffer();
	call	toUppercaseBuffer		#
# basic.c:1599: 				skip_to_end();
	call	skip_to_end		#
# basic.c:1600: 				linenum = testnum();
	call	testnum		#
	mov.w	r1, r0	# _86,
# basic.c:1600: 				linenum = testnum();
...
# basic.c:1601: 				if (linenum > 0)
	ld.w	r1, [linenum]	# linenum.315_88, linenum
# basic.c:1601: 				if (linenum > 0)
	xor.w	r0, r0	# tmp240
	cmp.w	r1, r0	# linenum.315_88, tmp240
	jses	.L343		#
# basic.c:1605: 					ignore_blanks();
	call	ignore_blanks		#
# basic.c:1606: 					entered_with_line_num();
...
# basic.c:1582: 		for (j = 0; j <= i; j++)
	...
	jses	.L345		#
# basic.c:1610: 		printf("OK loading file %s\n", s);
	mov.w	r0, sp	# tmp245,
	mov.w	r1, r13	# tmp246,
	...
	j	.L319		#
.L337:
# basic.c:1614: 		printf("Error loading file %s\n", s);
	mov.w	r0, sp	# tmp248,
	mov.w	r1, r13	# tmp249,
...
# basic.c:1627: 	sprintf(s, "%d ", line_num);
	...
	st.w	[r0], r1	#, tmp54
	call	sprintf		#
# basic.c:1628: 	strcpy(&buffer[i], s);
...
# basic.c:1630: 	while (*list_line != NL)
	j	.L349		#
.L350:
# basic.c:1632: 		buffer[i] = *list_line;
...
# basic.c:1646: 	printf("\nSaving to SD card...\n");
	...
	st.w	[r1], r0	#, tmp37
	call	puts		#
# basic.c:1647: 	int res = file_open(file_name, &fd, O_WRITE);
	mov.w	r0, sp	# tmp38,
	mov.w	r1, 1	# tmp39,
	st.w	[r0 + (8)], r1	#, tmp39
	mov.w	r1, r13	# tmp40,
...
# basic.c:1648: 	if (res)
	...
	cmp.w	r1, r0	# tmp43, tmp44
	jz	.L353		#
# basic.c:1650: 		int i, curr, total = 0, count = len /512 + 1;
	xor.w	r0, r0	# tmp45
...
# basic.c:1651: 		for (i = 0; i < count; i++)
	xor.w	r0, r0	# tmp53
	st.w	[r13 + (-4)], r0	# i, tmp53
# basic.c:1651: 		for (i = 0; i < count; i++)
	j	.L355		#
.L360:
# basic.c:1653: 			curr = file_write(&fd, &buff[total], len > 512 ? 512 : len);
...
# basic.c:1663: 		printf("\n");
	...
	j	.L361		#
.L353:
# basic.c:1667: 		printf("Could not open file for save.\n");
	mov.w	r1, sp	# tmp75,
	mov.w	r0, .LC26	# tmp76,
	st.w	[r1], r0	#, tmp76
	call	puts		#
.L361:
# basic.c:1669: 	return 1;	
	mov.w	r0, 1	# _33,
# basic.c:1670: }
	mov.w	sp, r13	#,
	pop	r13		#
...
eth_write_file:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:1674: 	printf("Saving file %s of %d bytes to the ethernet network drive\n", file_name, len);
	mov.w	r0, sp	# tmp27,
...
exec_save:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 64 #111	#,
# basic.c:1682: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1683: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:1685: 		qwhat();
	...
	j	.L365		#
.L367:
# basic.c:1689: 	int spi = 0;
	xor.w	r0, r0	# tmp59
	st.w	[r13 + (-8)], r0	# spi, tmp59
# basic.c:1690: 	for (i = 0; txtpos[i] != NL && txtpos[i] != SPACE && txtpos[i] != TAB; i++)
	xor.w	r0, r0	# tmp60
	st.w	[r13 + (-4)], r0	# i, tmp60
# basic.c:1690: 	for (i = 0; txtpos[i] != NL && txtpos[i] != SPACE && txtpos[i] != TAB; i++)
	j	.L369		#
.L371:
# basic.c:1692: 		s[i] = txtpos[i];
...
# basic.c:1694: 	s[i] = 0;
	...
	xor.w	r1, r1	# tmp75
	st.b	[r0], r1	# s, tmp75
# basic.c:1695: 	printf("Filename: <%s>\n", s);
	mov.w	r0, sp	# tmp76,
	mov.w	r1, r13	# tmp77,
	...
	st.w	[r0], r1	#, tmp78
	call	printf		#
# basic.c:1698: 	list_line = findline();
	call	findline		#
# basic.c:1698: 	list_line = findline();
...
# basic.c:1700: 	while (list_line < program_end)
	j	.L372		#
.L373:
# basic.c:1702: 		i = sprintline(i);
	mov.w	r1, sp	# tmp80,
...
# basic.c:1704: 	if (drive == 0) {
	...
	cmp.w	r1, r0	# tmp82, tmp83
	jnz	.L374		#
# basic.c:1706: 		sd_write_file(buffer, i, s);
...
# basic.c:1707: 	} else if (drive == 2) {
	...
	cmp.w	r1, r0	# tmp87, tmp88
	jnz	.L376		#
# basic.c:1709: 		uart_write_file(buffer, i, s);
	...
	j	.L375		#
.L376:
# basic.c:1713: 		eth_write_file(buffer, i, s);
	...
	call	eth_write_file		#
.L375:
# basic.c:1715: 	printf("OK saving file %s, length: %d\n", s, i);
	mov.w	r0, sp	# tmp95,
...
# basic.c:1733: 		while ((next = getDirEntry(&fd, next)) != 0)
	...
	j	.L377		#
.L380:
# basic.c:1740: 		to_print_len = 0;
	xor.w	r0, r0	# tmp53
	st.w	[to_print_len], r0	# to_print_len, tmp53
# basic.c:1741: 		browseUrl("/dir", "", server_ip, 0, my_callback);
	mov.w	r0, sp	# tmp54,
	...
	st.w	[r0], r1	#, tmp59
	call	browseUrl		#
# basic.c:1742: 		delay(100);
	mov.w	r1, sp	# tmp60,
	mov.w	r0, 100	# tmp61,
	st.w	[r1], r0	#, tmp61
	call	delay		#
# basic.c:1743: 		for (i = 0; i < 1000; i++) {
	xor.w	r0, r0	# tmp62
	st.w	[r13 + (-4)], r0	# i, tmp62
# basic.c:1743: 		for (i = 0; i < 1000; i++) {
	j	.L383		#
.L385:
# basic.c:1746: 			if (to_print_len > 0) {
	ld.w	r1, [to_print_len]	# to_print_len.351_12, to_print_len
# basic.c:1746: 			if (to_print_len > 0) {
	xor.w	r0, r0	# tmp63
	cmp.w	r1, r0	# to_print_len.351_12, tmp63
	jses	.L384		#
# basic.c:1747: 				to_print_buff[to_print_len] = 0;
...
# basic.c:1748: 				printf("%s\n", to_print_buff);
	mov.w	r1, sp	# tmp67,
	mov.w	r0, to_print_buff	# tmp68,
	st.w	[r1], r0	#, tmp68
	call	puts		#
# basic.c:1749: 				to_print_len = 0;
	xor.w	r0, r0	# tmp69
	st.w	[to_print_len], r0	# to_print_len, tmp69
# basic.c:1750: 				return;
	j	.L377		#
.L384:
# basic.c:1752: 			  delay(10);
	mov.w	r1, sp	# tmp70,
	mov.w	r0, 10	# tmp71,
	st.w	[r1], r0	#, tmp71
	call	delay		#
...
# basic.c:1743: 		for (i = 0; i < 1000; i++) {
	...
	jses	.L385		#
# basic.c:1754: 		printf("NETWORK TIMEOUT\n");
	mov.w	r1, sp	# tmp76,
	mov.w	r0, .LC33	# tmp77,
	st.w	[r1], r0	#, tmp77
	call	puts		#
...
# basic.c:1784: 			break;
	j	.L386		#
.L390:
# basic.c:1786: 			video_mode(0);
	mov.w	r1, sp	# tmp43,
	xor.w	r0, r0	# tmp44
	st.w	[r1], r0	#, tmp44
	call	video_mode		#
# basic.c:1788: 			printf("Invalid video mode: %d\n", value);
...
# basic.c:1838: 		return;
	j	.L393		#
.L399:
# basic.c:1841: 	pixel((int)x, (int)y, (int)c);
...
# basic.c:1848: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1849: 	expression_error = 0;
	xor.w	r0, r0	# tmp52
	st.b	[expression_error], r0	# expression_error, tmp52
# basic.c:1850: 	x1 = expression();	
	call	expression		#
	st.w	[r13 + (-20)], r0	# x1,
# basic.c:1851: 	if (expression_error)
...
# basic.c:1854: 		return;
	j	.L400		#
.L401:
# basic.c:1856: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1857: 	if (*txtpos != ',')
...
# basic.c:1866: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1867: 	expression_error = 0;
	xor.w	r0, r0	# tmp57
	st.b	[expression_error], r0	# expression_error, tmp57
# basic.c:1868: 	y1 = expression();	
	call	expression		#
	st.w	[r13 + (-24)], r0	# y1,
# basic.c:1869: 	if (expression_error)
...
# basic.c:1872: 		return;
	j	.L400		#
.L404:
# basic.c:1875: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1876: 	if (*txtpos != ',')
...
# basic.c:1883: 		txtpos++;
	...
	add.w	r0, 1 #111	# _10,
	st.w	[txtpos], r0	# txtpos, _10
# basic.c:1885: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1886: 	expression_error = 0;
	xor.w	r0, r0	# tmp62
	st.b	[expression_error], r0	# expression_error, tmp62
# basic.c:1887: 	x2 = expression();	
	call	expression		#
	st.w	[r13 + (-28)], r0	# x2,
# basic.c:1888: 	if (expression_error)
...
# basic.c:1891: 		return;
	j	.L400		#
.L406:
# basic.c:1893: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1894: 	if (*txtpos != ',')
...
# basic.c:1903: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1904: 	expression_error = 0;
	xor.w	r0, r0	# tmp67
	st.b	[expression_error], r0	# expression_error, tmp67
# basic.c:1905: 	y2 = expression();	
	call	expression		#
	st.w	[r13 + (-32)], r0	# y2,
# basic.c:1906: 	if (expression_error)
...
# basic.c:1909: 		return;
	j	.L400		#
.L408:
# basic.c:1911: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1912: 	if (*txtpos != ',')
...
# basic.c:1928: 		return;
	j	.L400		#
.L410:
# basic.c:1931: 	line((int)x1, (int)y1, (int)x2, (int)y2, (int)c);
...
exec_circle:
	...
	push	r8		#
	sub.w	sp, 40 #111	#,
# basic.c:1939: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1940: 	expression_error = 0;
	xor.w	r0, r0	# tmp46
	st.b	[expression_error], r0	# expression_error, tmp46
# basic.c:1941: 	x = expression();	
	call	expression		#
	st.w	[r13 + (-16)], r0	# x,
# basic.c:1942: 	if (expression_error)
...
# basic.c:1945: 		return;
	j	.L411		#
.L412:
# basic.c:1947: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1948: 	if (*txtpos != ',')
...
# basic.c:1955: 		txtpos++;
	...
	add.w	r0, 1 #111	# _5,
	st.w	[txtpos], r0	# txtpos, _5
# basic.c:1957: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1958: 	expression_error = 0;
	xor.w	r0, r0	# tmp51
	st.b	[expression_error], r0	# expression_error, tmp51
# basic.c:1959: 	y = expression();	
	call	expression		#
	st.w	[r13 + (-20)], r0	# y,
# basic.c:1960: 	if (expression_error)
...
# basic.c:1963: 		return;
	j	.L411		#
.L415:
# basic.c:1965: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1966: 	if (*txtpos != ',')
...
# basic.c:1973: 		txtpos++;
	...
	add.w	r0, 1 #111	# _10,
	st.w	[txtpos], r0	# txtpos, _10
# basic.c:1975: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1976: 	expression_error = 0;
	xor.w	r0, r0	# tmp56
	st.b	[expression_error], r0	# expression_error, tmp56
# basic.c:1977: 	r = expression();	
	call	expression		#
	st.w	[r13 + (-24)], r0	# r,
# basic.c:1978: 	if (expression_error)
...
# basic.c:1981: 		return;
	j	.L411		#
.L417:
# basic.c:1983: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1984: 	if (*txtpos != ',')
...
# basic.c:1993: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:1994: 	expression_error = 0;
	xor.w	r0, r0	# tmp61
	st.b	[expression_error], r0	# expression_error, tmp61
# basic.c:1995: 	c = expression();	
	call	expression		#
	st.w	[r13 + (-28)], r0	# c,
# basic.c:1996: 	if (expression_error)
...
# basic.c:1999: 		return;
	j	.L411		#
.L419:
# basic.c:2002: 	circle((int)x, (int)y, (int)r, (int)c);
...
# basic.c:2011: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2012: 	expression_error = 0;
	xor.w	r0, r0	# tmp63
	st.b	[expression_error], r0	# expression_error, tmp63
# basic.c:2013: 	x = expression();	
	call	expression		#
	st.w	[r13 + (-16)], r0	# x,
# basic.c:2014: 	if (expression_error)
...
# basic.c:2017: 		return;
	j	.L420		#
.L421:
# basic.c:2019: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2020: 	if (*txtpos != ',')
...
# basic.c:2035: 		return;
	j	.L420		#
.L424:
# basic.c:2037: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2038: 	if (*txtpos != ',')
...
# basic.c:2045: 		txtpos++;
	...
	add.w	r0, 1 #111	# _10,
	st.w	[txtpos], r0	# txtpos, _10
# basic.c:2047: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2048: 	expression_error = 0;
	xor.w	r0, r0	# tmp73
	st.b	[expression_error], r0	# expression_error, tmp73
# basic.c:2049: 	c = expression();	
	call	expression		#
	st.w	[r13 + (-24)], r0	# c,
# basic.c:2050: 	if (expression_error)
...
# basic.c:2053: 		return;
	j	.L420		#
.L426:
# basic.c:2055: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2056: 	if (*txtpos != ',')
...
# basic.c:2073: 	while (*txtpos != NL && *txtpos != 0)
	j	.L429		#
.L433:
# basic.c:2075: 		if (*txtpos == '"' || *txtpos == '\'')
...
# basic.c:2073: 	while (*txtpos != NL && *txtpos != 0)
	...
	jnz	.L433		#
.L432:
# basic.c:2084: 	draw((int)x, (int)y, (int)c, s);
...
exec_help:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:2089: 	printf("END\n");
	mov.w	r1, sp	# tmp26,
	mov.w	r0, .LC35	# tmp27,
	st.w	[r1], r0	#, tmp27
	call	puts		#
# basic.c:2090: 	printf("MEM\n");
	mov.w	r1, sp	# tmp28,
	mov.w	r0, .LC36	# tmp29,
	st.w	[r1], r0	#, tmp29
	call	puts		#
# basic.c:2091: 	printf("LET I = 5\n");
	mov.w	r1, sp	# tmp30,
	mov.w	r0, .LC37	# tmp31,
	st.w	[r1], r0	#, tmp31
	call	puts		#
# basic.c:2092: 	printf("I = 5\n");
	mov.w	r1, sp	# tmp32,
	mov.w	r0, .LC38	# tmp33,
	st.w	[r1], r0	#, tmp33
	call	puts		#
# basic.c:2093: 	printf("INPUT A\n");
	mov.w	r1, sp	# tmp34,
	mov.w	r0, .LC39	# tmp35,
	st.w	[r1], r0	#, tmp35
	call	puts		#
# basic.c:2094: 	printf("PRINT A\n");
	mov.w	r1, sp	# tmp36,
	mov.w	r0, .LC40	# tmp37,
	st.w	[r1], r0	#, tmp37
	call	puts		#
# basic.c:2095: 	printf("? A\n");
	mov.w	r1, sp	# tmp38,
	mov.w	r0, .LC41	# tmp39,
	st.w	[r1], r0	#, tmp39
	call	puts		#
# basic.c:2096: 	printf("FOR I = 1 TO 10 STEP 2\n");
	mov.w	r1, sp	# tmp40,
	mov.w	r0, .LC42	# tmp41,
	st.w	[r1], r0	#, tmp41
	call	puts		#
# basic.c:2097: 	printf("NEXT I\n");
	mov.w	r1, sp	# tmp42,
	mov.w	r0, .LC43	# tmp43,
	st.w	[r1], r0	#, tmp43
	call	puts		#
# basic.c:2098: 	printf("IF I = 5 GOTO 100\n");
	mov.w	r1, sp	# tmp44,
	mov.w	r0, .LC44	# tmp45,
	st.w	[r1], r0	#, tmp45
	call	puts		#
# basic.c:2099: 	printf("GOTO 100\n");
	mov.w	r1, sp	# tmp46,
	mov.w	r0, .LC45	# tmp47,
	st.w	[r1], r0	#, tmp47
	call	puts		#
# basic.c:2100: 	printf("GOSUB 100\n");
	mov.w	r1, sp	# tmp48,
	mov.w	r0, .LC46	# tmp49,
	st.w	[r1], r0	#, tmp49
	call	puts		#
# basic.c:2101: 	printf("RETURN\n");
	mov.w	r1, sp	# tmp50,
	mov.w	r0, .LC47	# tmp51,
	st.w	[r1], r0	#, tmp51
	call	puts		#
# basic.c:2102: 	printf("LOAD P1.BAS\n");
	mov.w	r1, sp	# tmp52,
	mov.w	r0, .LC48	# tmp53,
	st.w	[r1], r0	#, tmp53
	call	puts		#
# basic.c:2103: 	printf("SAVE P2.BAS\n");
	mov.w	r1, sp	# tmp54,
	mov.w	r0, .LC49	# tmp55,
	st.w	[r1], r0	#, tmp55
	call	puts		#
# basic.c:2104: 	printf("MODE 0 (MODE 1, MODE 2)\n");
	mov.w	r1, sp	# tmp56,
	mov.w	r0, .LC50	# tmp57,
	st.w	[r1], r0	#, tmp57
	call	puts		#
# basic.c:2105: 	printf("PLOT 100, 100, color\n");
	mov.w	r1, sp	# tmp58,
	mov.w	r0, .LC51	# tmp59,
	st.w	[r1], r0	#, tmp59
	call	puts		#
# basic.c:2106: 	printf("LINE 100, 100, 200, 200, color\n");
	mov.w	r1, sp	# tmp60,
	mov.w	r0, .LC52	# tmp61,
	st.w	[r1], r0	#, tmp61
	call	puts		#
# basic.c:2107: 	printf("CIRCLE 100, 100, 50, color\n");
	mov.w	r1, sp	# tmp62,
	mov.w	r0, .LC53	# tmp63,
	st.w	[r1], r0	#, tmp63
	call	puts		#
# basic.c:2108: 	printf("DRAW 100, 100, color, 'TEXT'\n");
	mov.w	r1, sp	# tmp64,
	mov.w	r0, .LC54	# tmp65,
	st.w	[r1], r0	#, tmp65
	call	puts		#
# basic.c:2109: 	printf("A = KEY()\n");
	mov.w	r1, sp	# tmp66,
	mov.w	r0, .LC55	# tmp67,
	st.w	[r1], r0	#, tmp67
	call	puts		#
# basic.c:2110: 	printf("A = ISKEY()\n");
	mov.w	r1, sp	# tmp68,
	mov.w	r0, .LC56	# tmp69,
	st.w	[r1], r0	#, tmp69
	call	puts		#
# basic.c:2111: 	printf("DELAY 1000\n");
	mov.w	r1, sp	# tmp70,
	mov.w	r0, .LC57	# tmp71,
	st.w	[r1], r0	#, tmp71
	call	puts		#
# basic.c:2112: 	printf("CURSOR 10, 10\n");
	mov.w	r1, sp	# tmp72,
	mov.w	r0, .LC58	# tmp73,
	st.w	[r1], r0	#, tmp73
	call	puts		#
# basic.c:2113: 	printf("EXEC TEST.BIN\n");
	mov.w	r1, sp	# tmp74,
	mov.w	r0, .LC59	# tmp75,
	st.w	[r1], r0	#, tmp75
	call	puts		#
# basic.c:2114: 	printf("SYS 0\n");
	mov.w	r1, sp	# tmp76,
	mov.w	r0, .LC60	# tmp77,
	st.w	[r1], r0	#, tmp77
	call	puts		#
# basic.c:2115: 	printf("DRIVE 0 (SD) or DRIVE 1 (ETHERNET) or DRIVE 2 (UART)\n");
	mov.w	r1, sp	# tmp78,
	mov.w	r0, .LC61	# tmp79,
	st.w	[r1], r0	#, tmp79
	call	puts		#
# basic.c:2116: 	printf("TIME\n");
	mov.w	r1, sp	# tmp80,
	mov.w	r0, .LC62	# tmp81,
	st.w	[r1], r0	#, tmp81
	call	puts		#
# basic.c:2117: 	printf("ETH 1 or ETH 0\n");
	mov.w	r1, sp	# tmp82,
	mov.w	r0, .LC63	# tmp83,
	st.w	[r1], r0	#, tmp83
	call	puts		#
...
exec_delay:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 28 #111	#,
# basic.c:2124: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2125: 	expression_error = 0;
	xor.w	r0, r0	# tmp28
	st.b	[expression_error], r0	# expression_error, tmp28
# basic.c:2126: 	d = expression();	
	call	expression		#
	st.w	[r13 + (-4)], r0	# d,
# basic.c:2127: 	if (expression_error)
...
# basic.c:2155: 		txtpos++;
	...
	add.w	r0, 1 #111	# _5,
	st.w	[txtpos], r0	# txtpos, _5
# basic.c:2157: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2158: 	expression_error = 0;
	xor.w	r0, r0	# tmp39
	st.b	[expression_error], r0	# expression_error, tmp39
# basic.c:2159: 	y = expression();	
	call	expression		#
	st.w	[r13 + (-12)], r0	# y,
# basic.c:2160: 	if (expression_error)
...
# basic.c:2173: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2174: 	expression_error = 0;
	xor.w	r0, r0	# tmp38
	st.b	[expression_error], r0	# expression_error, tmp38
# basic.c:2175: 	addr = expression();	
	call	expression		#
	st.w	[r13 + (-12)], r0	# addr,
# basic.c:2176: 	if (expression_error)
...
# basic.c:2179: 		return;
	j	.L444		#
.L445:
# basic.c:2181: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2182: 	if (*txtpos != ',')
...
# basic.c:2189: 		txtpos++;
	...
	add.w	r0, 1 #111	# _5,
	st.w	[txtpos], r0	# txtpos, _5
# basic.c:2191: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2192: 	expression_error = 0;
	xor.w	r0, r0	# tmp43
	st.b	[expression_error], r0	# expression_error, tmp43
# basic.c:2193: 	value = expression();	
	call	expression		#
	st.w	[r13 + (-16)], r0	# value,
# basic.c:2194: 	if (expression_error)
...
# basic.c:2197: 		return;
	j	.L444		#
.L448:
# basic.c:2200: 	buffer[(int)addr] = (int)value & 0XFF;
...
# basic.c:2205: 	if(!sdcard_init())
	...
	jnz	.L450		#
# basic.c:2207: 		printf("SD card init failed!\n");
	mov.w	r1, sp	# tmp30,
	mov.w	r0, .LC64	# tmp31,
	st.w	[r1], r0	#, tmp31
	call	puts		#
.L450:
# basic.c:2209: 	if (!volume_init(1))
	mov.w	r1, sp	# tmp32,
	mov.w	r0, 1	# tmp33,
	st.w	[r1], r0	#, tmp33
	call	volume_init		#
# basic.c:2209: 	if (!volume_init(1))
	...
	cmp.w	r1, r0	# tmp34, tmp35
	jnz	.L452		#
# basic.c:2211: 		printf("SD card volume failed!\n");
	mov.w	r1, sp	# tmp36,
	mov.w	r0, .LC65	# tmp37,
	st.w	[r1], r0	#, tmp37
	call	puts		#
...
exec_exec:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 160 #111	#,
# basic.c:2220: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2221: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:2224: 		return;
	j	.L453		#
.L455:
# basic.c:2228: 	for (i = 0; txtpos[i] != NL && txtpos[i] != CR && txtpos[i] != SPACE && txtpos[i] != TAB &&  i < 32; i++)
	xor.w	r0, r0	# tmp79
	st.w	[r13 + (-4)], r0	# i, tmp79
# basic.c:2228: 	for (i = 0; txtpos[i] != NL && txtpos[i] != CR && txtpos[i] != SPACE && txtpos[i] != TAB &&  i < 32; i++)
	j	.L457		#
.L459:
# basic.c:2231: 		s[i] = txtpos[i];
...
# basic.c:2236: 	printf("Loading program: [%s]\n", s);
	mov.w	r0, sp	# tmp100,
	mov.w	r1, r13	# tmp101,
...
# basic.c:2237: 	if (drive == 0)
	...
	jnz	.L460		#
# basic.c:2241: load_again:		
	nop	
.L461:
# basic.c:2242: 		if(file_open(s, &fd, O_READ))
	mov.w	r0, sp	# tmp105,
	xor.w	r1, r1	# tmp106
	st.w	[r0 + (8)], r1	#, tmp106
	mov.w	r1, r13	# tmp107,
...
# basic.c:2242: 		if(file_open(s, &fd, O_READ))
	...
	jz	.L462		#
# basic.c:2244: 			int len = fd.dir_entry.filesize;
	ld.w	r0, [r13 + (-104)]	# _28, fd.dir_entry.filesize
# basic.c:2244: 			int len = fd.dir_entry.filesize;
	st.w	[r13 + (-20)], r0	# len, _28
# basic.c:2245: 			int total = 0;
	xor.w	r0, r0	# tmp111
	st.w	[r13 + (-8)], r0	# total, tmp111
# basic.c:2247: 			while(total < len)
	j	.L463		#
.L466:
# basic.c:2249: 				current = file_read(&fd, &buffer[total], 512);
...
# basic.c:2253: 						printf("#");
	...
	j	.L463		#
.L464:
# basic.c:2256: 					printf("Error reading file!\n");
	mov.w	r1, sp	# tmp126,
...
# basic.c:2266: 			strcpy(fileName, s);
	mov.w	r0, sp	# tmp132,
	mov.w	r1, r13	# tmp133,
	...
	st.w	[r0], r1	#, tmp134
	call	strcpy		#
# basic.c:2267: 			int sum = 0;
	xor.w	r0, r0	# tmp135
	st.w	[r13 + (-12)], r0	# sum, tmp135
# basic.c:2268: 			for (int j = 0; j < i; j++) {
	xor.w	r0, r0	# tmp136
	st.w	[r13 + (-16)], r0	# j, tmp136
# basic.c:2268: 			for (int j = 0; j < i; j++) {
	j	.L467		#
.L468:
# basic.c:2269: 				sum += buffer[j];
...
# basic.c:2271: 			printf("\nSum: %d\n", sum);
	...
	j	.L469		#
.L462:
# basic.c:2275: 			printf("File open failed for file: [%s]\n", s);
	mov.w	r0, sp	# tmp146,
	mov.w	r1, r13	# tmp147,
...
# basic.c:2279: 	else if (drive == 2)
	...
	cmp.w	r1, r0	# tmp149, tmp150
	jnz	.L470		#
# basic.c:2283: 		delay(100);
	mov.w	r1, sp	# tmp151,
	mov.w	r0, 100	# tmp152,
	st.w	[r1], r0	#, tmp152
	call	delay		#
# basic.c:2284: 		i = uart_read_file(buffer, s);
	...
	j	.L469		#
.L470:
# basic.c:2288: 		i = eth_read_file(buffer, s);
...
# basic.c:2290: 	if (i > 0) 
	...
	cmp.w	r1, r0	# tmp157, tmp158
	jses	.L471		#
# basic.c:2293: 		int old_color = color;
	ld.w	r0, [color]	# tmp159, color
	st.w	[r13 + (-28)], r0	# old_color, tmp159
# basic.c:2294: 		asm("mov.w r0, 197632\ncallr r0\n"); //asm("call 197632\n");
# 2294 "basic.c" 1
	mov.w r0, 197632
callr r0

# basic.c:2295: 		init_stdio();
	call	init_stdio		#
# basic.c:2296: 		video_mode(0);
	mov.w	r1, sp	# tmp160,
	xor.w	r0, r0	# tmp161
	st.w	[r1], r0	#, tmp161
	call	video_mode		#
# basic.c:2297: 		color = old_color;
	ld.w	r0, [r13 + (-28)]	# tmp162, old_color
	st.w	[color], r0	# color, tmp162
# basic.c:2300: 		uart_init_files();
...
# basic.c:2301: 		if (eth)
	...
	jz	.L453		#
# basic.c:2303: 			init_spi();
	call	init_spi		#
# basic.c:2304: 			init_tcpip();
	call	init_tcpip		#
# basic.c:2305: 			init_sd();
	call	init_sd		#
	j	.L453		#
.L471:
# basic.c:2310: 		printf("Error loading program %s\n", s);
	mov.w	r0, sp	# tmp164,
	mov.w	r1, r13	# tmp165,
...
exec_sys:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 64 #111	#,
# basic.c:2319: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2320: 	expression_error = 0;
	xor.w	r0, r0	# tmp29
	st.b	[expression_error], r0	# expression_error, tmp29
# basic.c:2321: 	addr = (int)expression();	
	call	expression		#
	mov.w	r1, r0	# _1,
# basic.c:2321: 	addr = (int)expression();	
...
# basic.c:2322: 	if (expression_error)
...
# basic.c:2337: 	if (eth)
	...
	jz	.L474		#
# basic.c:2339: 		init_spi();
	call	init_spi		#
# basic.c:2340: 		init_tcpip();
	call	init_tcpip		#
# basic.c:2341: 		init_sd();
	call	init_sd		#
.L474:
# basic.c:2343: }
	mov.w	sp, r13	#,
...
# basic.c:2351: 		return;
	j	.L478		#
.L479:
# basic.c:2353: 	if (*txtpos < '0' || *txtpos > '9')
...
# basic.c:2359: 	if (drive >= 0 && drive <= 2)
...
# basic.c:2360: 		printf("DRIVE: %d\n", drive);
	...
	j	.L478		#
.L483:
# basic.c:2363: 		printf("Invalid drive number: %d. Can be from 0 to 2.\n", drive);
...
exec_eth:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:2370: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2371: 	if (*txtpos == NL)
...
# basic.c:2371: 	if (*txtpos == NL)
	...
	cmp.w	r1, r0	# tmp42, tmp43
	jnz	.L485		#
# basic.c:2373: 		printf("ETHERNET: %d\n", eth);
...
# basic.c:2374: 		return;
	j	.L484		#
.L485:
# basic.c:2376: 	if (*txtpos < '0' || *txtpos > '9')
...
# basic.c:2382: 	if (eth >= 0 && eth <= 1) 
	...
	jgs	.L489		#
# basic.c:2384: 		printf("ETHERNET: %d\n", eth);
	...
	st.w	[r0], r1	#, tmp53
	call	printf		#
# basic.c:2386: 		if (eth == 1) 
	ld.w	r1, [eth]	# eth.455_15, eth
# basic.c:2386: 		if (eth == 1) 
	mov.w	r0, 1	# tmp54,
	cmp.w	r1, r0	# eth.455_15, tmp54
	jnz	.L490		#
# basic.c:2388: 			asm ("irq 1\n"); // IRQ 0000, xxx1 <- turn ON timer irq
# 2388 "basic.c" 1
	irq 1

# basic.c:2389: 			init_tcpip();
	call	init_tcpip		#
# basic.c:2386: 		if (eth == 1) 
	j	.L484		#
.L490:
# basic.c:2393: 			asm ("irq 0\n"); // IRQ 0000, xxx0 <- turn OFF timer irq
# 2393 "basic.c" 1
	irq 0
...
# basic.c:2386: 		if (eth == 1) 
	j	.L484		#
.L489:
# basic.c:2400: 		printf("Invalid ethernet value: %d. Can be 0 or 1.\n", eth);
...
# basic.c:2412: 		return;
	j	.L492		#
.L493:
# basic.c:2414: 	expression_error = 0;
	xor.w	r0, r0	# tmp35
	st.b	[expression_error], r0	# expression_error, tmp35
# basic.c:2415: 	int c = (int)expression();	
	call	expression		#
	mov.w	r1, r0	# _4,
# basic.c:2415: 	int c = (int)expression();	
...
# basic.c:2416: 	if (expression_error)
...
# basic.c:2431: 	if (*txtpos == NL)
	...
	cmp.w	r1, r0	# tmp49, tmp50
	jnz	.L498		#
# basic.c:2432: 		return 0;
	xor.w	r0, r0	# _20
	j	.L499		#
.L498:
# basic.c:2434: 	scantable(keywords);
	mov.w	r1, sp	# tmp51,
	mov.w	r0, keywords	# tmp52,
	st.w	[r1], r0	#, tmp52
	call	scantable		#
# basic.c:2440: 	if (should_break())
	call	should_break		#
	mov.w	r1, r0	# _3,
# basic.c:2440: 	if (should_break())
	xor.w	r0, r0	# tmp53
	...
	jz	.L500		#
# basic.c:2442: 		return 0;
	xor.w	r0, r0	# _20
	j	.L499		#
.L500:
# basic.c:2445: 	switch (table_index)
	...
	j	.L545		#
.L537:
# basic.c:2449: 		exec_mem();
	call	exec_mem		#
# basic.c:2450: 		return 0;
	xor.w	r0, r0	# _20
	j	.L499		#
.L545:
# basic.c:2454: 		printf("I cannot exit. I am the boss.\n");
	mov.w	r1, sp	# tmp127,
...
# basic.c:2479: 		if (expression_error || *txtpos != NL)
...
# basic.c:2480: 			qhow();
	call	qhow		#
.L541:
# basic.c:2481: 		current_line = findline();
	call	findline		#
# basic.c:2481: 		current_line = findline();
	st.w	[current_line], r0	# current_line, _13
# basic.c:2482: 		return 2;
	mov.w	r0, 2	# _20,
	j	.L499		#
.L529:
# basic.c:2484: 		exec_for();
	call	exec_for		#
# basic.c:2485: 		break;
	j	.L539		#
.L528:
# basic.c:2487: 		exec_next();
	call	exec_next		#
# basic.c:2488: 		break;
	j	.L539		#
.L526:
# basic.c:2490: 		exec_gosub();
	call	exec_gosub		#
# basic.c:2491: 		break;
	j	.L539		#
.L527:
# basic.c:2493: 		if (!exec_return())
	call	exec_return		#
	mov.w	r1, r0	# _14,
# basic.c:2493: 		if (!exec_return())
	xor.w	r0, r0	# tmp135
	...
	jnz	.L547		#
# basic.c:2494: 			return 1;
	mov.w	r0, 1	# _20,
	j	.L499		#
.L525:
# basic.c:2499: 		if (txtpos[0] != NL)
...
# basic.c:2511: 		break;
	j	.L539		#
.L522:
# basic.c:2513: 		return exec_edit();
	call	exec_edit		#
	j	.L499		#
.L521:
# basic.c:2515: 		exec_load();
	call	exec_load		#
# basic.c:2516: 		break;
	j	.L539		#
.L520:
# basic.c:2518: 		exec_save();
	call	exec_save		#
# basic.c:2519: 		break;
	j	.L539		#
.L519:
# basic.c:2521: 		exec_dir();
	call	exec_dir		#
# basic.c:2522: 		break;
	j	.L539		#
.L518:
# basic.c:2524: 		exec_mode();
	call	exec_mode		#
# basic.c:2525: 		break;
	j	.L539		#
.L517:
# basic.c:2527: 		exec_plot();
	call	exec_plot		#
# basic.c:2528: 		break;
	j	.L539		#
.L516:
# basic.c:2530: 		exec_line();
	call	exec_line		#
# basic.c:2531: 		break;
	j	.L539		#
.L515:
# basic.c:2533: 		exec_circle();
	call	exec_circle		#
# basic.c:2534: 		break;
	j	.L539		#
.L514:
# basic.c:2536: 		exec_draw();
	call	exec_draw		#
# basic.c:2537: 		break;
	j	.L539		#
.L513:
# basic.c:2539: 		exec_help();
	call	exec_help		#
# basic.c:2540: 		break;
	j	.L539		#
.L512:
# basic.c:2542: 		exec_delay();
	call	exec_delay		#
# basic.c:2543: 		break;
	j	.L539		#
.L511:
# basic.c:2545: 		exec_cursor();
	call	exec_cursor		#
# basic.c:2546: 		break;
	j	.L539		#
.L510:
# basic.c:2548: 		exec_poke();
	call	exec_poke		#
# basic.c:2549: 		break;
	j	.L539		#
.L509:
# basic.c:2551: 		exec_exec();
	call	exec_exec		#
# basic.c:2552: 		break;
	j	.L539		#
.L508:
# basic.c:2554: 		exec_sys();
	call	exec_sys		#
# basic.c:2555: 		break;
	j	.L539		#
.L507:
# basic.c:2557: 		exec_drive();
	call	exec_drive		#
# basic.c:2558: 		break;
	j	.L539		#
.L506:
# basic.c:2560: 		printf("Current millis: %d\n", get_millis());
	call	get_millis		#
	mov.w	r1, r0	# _19,
	mov.w	r0, sp	# tmp139,
	st.w	[r0 + (4)], r1	#, _19
...
# basic.c:2561: 	break;
	j	.L539		#
.L504:
# basic.c:2566: 		exec_eth();
	call	exec_eth		#
# basic.c:2567: 		break;
	j	.L539		#
.L503:
# basic.c:2569: 		exec_color();
	call	exec_color		#
# basic.c:2570: 		break;
	j	.L539		#
.L501:
# basic.c:2572: 		assignment();
	call	assignment		#
# basic.c:2573: 		break;
	j	.L539		#
.L502:
# basic.c:2575: 		return 0;
	xor.w	r0, r0	# _20
	j	.L499		#
.L546:
# basic.c:2564: 		break;
...
init_K_API:
	push	r13		#
	mov.w	r13, sp	#,
# basic.c:2581: 	K_API_STDIO[K_CLS] 				= ((int)cls) + 4;               // 190000 
...
# basic.c:2582: 	K_API_STDIO[K_PUT_CHAR] 		= ((int)put_char) + 4;          // 190004 
...
# basic.c:2582: 	K_API_STDIO[K_PUT_CHAR] 		= ((int)put_char) + 4;          // 190004 
	st.w	[r0], r1	# *_6, _7
# basic.c:2583: 	K_API_STDIO[K_PRINTF] 			= ((int)printf) + 4;            // 190008 
...
# basic.c:2583: 	K_API_STDIO[K_PRINTF] 			= ((int)printf) + 4;            // 190008 
	st.w	[r0], r1	# *_10, _11
# basic.c:2584: 	K_API_STDIO[K_PUTS] 			= ((int)puts) + 4;              // 190012 
...
# basic.c:2584: 	K_API_STDIO[K_PUTS] 			= ((int)puts) + 4;              // 190012 
	st.w	[r0], r1	# *_14, _15
# basic.c:2585: 	K_API_STDIO[K_RAND] 			= ((int)rand) + 4;              // 190016 
...
# basic.c:2585: 	K_API_STDIO[K_RAND] 			= ((int)rand) + 4;              // 190016 
	st.w	[r0], r1	# *_18, _19
# basic.c:2586: 	K_API_STDIO[K_SHOULD_BREAK] 	= ((int)should_break) + 4;      // 190020 
...
# basic.c:2586: 	K_API_STDIO[K_SHOULD_BREAK] 	= ((int)should_break) + 4;      // 190020 
	st.w	[r0], r1	# *_22, _23
# basic.c:2587: 	K_API_STDIO[K_GETC] 			= ((int)getc) + 4;              // 190024 
...
# basic.c:2587: 	K_API_STDIO[K_GETC] 			= ((int)getc) + 4;              // 190024 
	st.w	[r0], r1	# *_26, _27
# basic.c:2588: 	K_API_STDIO[K_GETS] 			= ((int)gets) + 4;              // 190028 
...
# basic.c:2588: 	K_API_STDIO[K_GETS] 			= ((int)gets) + 4;              // 190028 
	st.w	[r0], r1	# *_30, _31
# basic.c:2589: 	K_API_STDIO[K_INIT_STDIO] 		= ((int)init_stdio) + 4;        // 190032 
...
# basic.c:2589: 	K_API_STDIO[K_INIT_STDIO] 		= ((int)init_stdio) + 4;        // 190032 
	st.w	[r0], r1	# *_34, _35
# basic.c:2590: 	K_API_STDIO[K_DELAY] 			= ((int)delay) + 4;             // 190036 
...
# basic.c:2590: 	K_API_STDIO[K_DELAY] 			= ((int)delay) + 4;             // 190036 
	st.w	[r0], r1	# *_38, _39
# basic.c:2591: 	K_API_STDIO[K_XY] 				= ((int)xy) + 4;                // 190040 
...
# basic.c:2591: 	K_API_STDIO[K_XY] 				= ((int)xy) + 4;                // 190040 
	st.w	[r0], r1	# *_42, _43
# basic.c:2592: 	K_API_STDIO[K_GET_MILLIS]		= ((int)get_millis) + 4;        // 190044 
...
# basic.c:2592: 	K_API_STDIO[K_GET_MILLIS]		= ((int)get_millis) + 4;        // 190044 
	st.w	[r0], r1	# *_46, _47
# basic.c:2593: 	K_API_STDIO[K_IS_KEY_PRESSED]	= ((int)is_key_pressed) + 4;    // 190048 
...
# basic.c:2593: 	K_API_STDIO[K_IS_KEY_PRESSED]	= ((int)is_key_pressed) + 4;    // 190048 
	st.w	[r0], r1	# *_50, _51
# basic.c:2594: 	K_API_STDIO[K_IS_KEY_RELEASED]	= ((int)is_key_released) + 4;   // 190052 
...
# basic.c:2594: 	K_API_STDIO[K_IS_KEY_RELEASED]	= ((int)is_key_released) + 4;   // 190052 
	st.w	[r0], r1	# *_54, _55
# basic.c:2595: 	K_API_STDIO[K_TOGGLE_CURSOR] 	= ((int)toggle_cursor) + 4;     // 190056 
...
# basic.c:2595: 	K_API_STDIO[K_TOGGLE_CURSOR] 	= ((int)toggle_cursor) + 4;     // 190056 
	st.w	[r0], r1	# *_58, _59
# basic.c:2596: 	K_API_STDIO[K_PUTCHAR]			= ((int)putchar) + 4;           // 190060 
...
# basic.c:2596: 	K_API_STDIO[K_PUTCHAR]			= ((int)putchar) + 4;           // 190060 
	st.w	[r0], r1	# *_62, _63
# basic.c:2597: 	K_API_STDIO[K_VIDEO_MODE]		= ((int)video_mode) + 4;        // 190064 
...
# basic.c:2597: 	K_API_STDIO[K_VIDEO_MODE]		= ((int)video_mode) + 4;        // 190064 
	st.w	[r0], r1	# *_66, _67
# basic.c:2598: 	K_API_GRAPHICS[K_SCROLL_UP]	    = ((int)scroll_up) + 4;			// 190068
...
# basic.c:2598: 	K_API_GRAPHICS[K_SCROLL_UP]	    = ((int)scroll_up) + 4;			// 190068
	st.w	[r0], r1	# *_70, _71
# basic.c:2600: 	K_API_STRING[K_STRLEN] =        ((int)strlen) + 4;				// 190100 
...
# basic.c:2601: 	K_API_STRING[K_STRCMP] =        ((int)strcmp) + 4;				// 190104 
...
# basic.c:2601: 	K_API_STRING[K_STRCMP] =        ((int)strcmp) + 4;				// 190104 
	st.w	[r0], r1	# *_77, _78
# basic.c:2602: 	K_API_STRING[K_STRNCMP] =       ((int)strncmp) + 4;				// 190108 
...
# basic.c:2602: 	K_API_STRING[K_STRNCMP] =       ((int)strncmp) + 4;				// 190108 
	st.w	[r0], r1	# *_81, _82
# basic.c:2603: 	K_API_STRING[K_MEMCPY] =        ((int)memcpy) + 4; 				// 190112 
...
# basic.c:2603: 	K_API_STRING[K_MEMCPY] =        ((int)memcpy) + 4; 				// 190112 
	st.w	[r0], r1	# *_85, _86
# basic.c:2604: 	K_API_STRING[K_MEMSET] =        ((int)memset) + 4; 				// 190116 
...
# basic.c:2604: 	K_API_STRING[K_MEMSET] =        ((int)memset) + 4; 				// 190116 
	st.w	[r0], r1	# *_89, _90
# basic.c:2605: 	K_API_STRING[K_MEMMOVE] =       ((int)memmove) + 4; 			// 190120 
...
# basic.c:2605: 	K_API_STRING[K_MEMMOVE] =       ((int)memmove) + 4; 			// 190120 
	st.w	[r0], r1	# *_93, _94
# basic.c:2606: 	K_API_STRING[K_STRCPY] =        ((int)strcpy) + 4; 				// 190124 
...
# basic.c:2606: 	K_API_STRING[K_STRCPY] =        ((int)strcpy) + 4; 				// 190124 
	st.w	[r0], r1	# *_97, _98
# basic.c:2607: 	K_API_STRING[K_STRNCPY] =       ((int)strncpy) + 4; 			// 190128 
...
# basic.c:2608: 	K_API_STRING[K_STRCAT] =        ((int)strcat) + 4;				// 190132 
...
# basic.c:2609: 	K_API_STRING[K_STRSTR] =        ((int)strstr) + 4;				// 190136 
...
# basic.c:2610: 	K_API_STRING[K_TOLOWER] =       ((int)tolower) + 4;				// 190140 
...
# basic.c:2611: 	K_API_STRING[K_TOUPPER] =       ((int)toupper) + 4;				// 190144 
...
# basic.c:2612: 	K_API_STRING[K_STR_TOUPPER] =   ((int)str_toupper) + 4;			// 190148 
...
# basic.c:2613: 	K_API_STRING[K_STR_N_TOUPPER] = ((int)str_n_toupper) + 4;		// 190152 
...
# basic.c:2614: 	K_API_STRING[K_ISDIGIT] =       ((int)isdigit) + 4;				// 190156 
...
# basic.c:2615: 	K_API_STRING[K_ISLOWER] =       ((int)islower) + 4;				// 190160 
...
# basic.c:2616: 	K_API_STRING[K_ISUPPER] =       ((int)isupper) + 4;				// 190164 
...
# basic.c:2617: 	K_API_STRING[K_ISALPHA] =       ((int)isalpha) + 4;				// 190168 
...
# basic.c:2618: 	K_API_STRING[K_ISALNUM] =       ((int)isalnum) + 4;				// 190172 
...
# basic.c:2619: 	K_API_STRING[K_ATOI] =          ((int)atoi) + 4;				// 190176 
...
# basic.c:2620: 	K_API_STRING[K_ISSPACE] =       ((int)isspace) + 4;				// 190180 
...
# basic.c:2621: 	K_API_STRING[K_MEMCMP] =        ((int)memcmp) + 4;		 	 	// 190184 
...
# basic.c:2622: 	K_API_STRING[K_STRTOK] =        ((int)strtok) + 4;				// 190188 
...
# basic.c:2623: 	K_API_STRING[K_STRCHR] =        ((int)strchr) + 4; 				// 190192 
...
# basic.c:2624: 	K_API_STRING[K_STRRRCHR] =      ((int)strrchr) + 4; 			// 190196 
...
# basic.c:2625: 	K_API_STRING[K_STRNCASECMP] =   ((int)strncasecmp) + 4; 		// 190200 
...
# basic.c:2627: 	K_API_SPRINTF[K_SPRINTF]	= 	((int)sprintf) + 4;				// 190300
...
# basic.c:2628: 	K_API_SPRINTF[K_VSPRINTF]	= 	((int)vsprintf) + 4;			// 190304
...
# basic.c:2630: 	K_API_GRAPHICS[K_PIXEL]		=	((int)pixel) + 4;				// 190400
...
# basic.c:2631: 	K_API_GRAPHICS[K_LINE]		=	((int)line) + 4;				// 190404
...
# basic.c:2632: 	K_API_GRAPHICS[K_CIRCLE]	=	((int)circle) + 4;				// 190408
...
# basic.c:2633: 	K_API_GRAPHICS[K_DRAW]		=	((int)draw) + 4;				// 190412
...
# basic.c:2635: 	K_API_SPI[K_INIT_SPI]		=    ((int)init_spi) + 4; 			// 190500
...
# basic.c:2636: 	K_API_SPI[K_DEINIT_SPI]		=    ((int)deinit_spi) + 4; 		// 190504
...
# basic.c:2637: 	K_API_SPI[K_SEND_SPI]		=    ((int)send_spi) + 4; 			// 190508
...
# basic.c:2638: 	K_API_SPI[K_READ_SPI]		=    ((int)read_spi) + 4; 			// 190512
...
# basic.c:2639: 	K_API_SPI[K_SPI_BYTE]		=    ((int)SPI_Byte) + 4; 			// 190516
...
# basic.c:2641: 	K_API_TCPIP[K_INIT_TCPIP]	= 	 ((int)init_tcpip) + 4;			// 190600
...
# basic.c:2642: 	K_API_TCPIP[K_BROWSE_URL]	= 	 ((int)browseUrl) + 4;			// 190604
...
# basic.c:2643: 	K_API_TCPIP[K_HTTP_POST]	= 	 ((int)httpPost) + 4;			// 190608
...
# basic.c:2644: 	K_API_TCPIP[K_MAIN_LOOP]	= 	 ((int)mainLoop) + 4;			// 190612
...
# basic.c:2647: 	K_API_FAT[K_SDCARD_INIT]	= 	 ((int)sdcard_init) + 4;		// 190700
...
# basic.c:2648: 	K_API_FAT[K_VOLUME_INIT]	= 	 ((int)volume_init) + 4;		// 190704
...
# basic.c:2649: 	K_API_FAT[K_FILE_OPEN]		= 	 ((int)file_open) + 4;			// 190708
...
# basic.c:2650: 	K_API_FAT[K_FILE_READ]		= 	 ((int)file_read) + 4;			// 190712
...
# basic.c:2651: 	K_API_FAT[K_GET_DIR_ENTRY]	= 	 ((int)getDirEntry) + 4;		// 190716
...
# basic.c:2652: 	K_API_FAT[K_FILE_SEEK]		= 	 ((int)file_seek) + 4;			// 190720
...
# basic.c:2653: 	K_API_FAT[K_FILE_WRITE]		= 	 ((int)file_write) + 4;			// 190724
...
# basic.c:2654: 	K_API_FAT[K_FILE_DELETE]	= 	 ((int)file_delete) + 4;		// 190728
...
# basic.c:2691: 			getln('>');
	...
	st.w	[r1], r0	#, tmp60
	call	getln		#
# basic.c:2692: 			toUppercaseBuffer();
	call	toUppercaseBuffer		#
# basic.c:2693: 			skip_to_end();
	call	skip_to_end		#
	j	.L551		#
.L550:
# basic.c:2697: 			res = 0;
...
# basic.c:2698: 			toUppercaseBuffer();
	call	toUppercaseBuffer		#
.L551:
# basic.c:2701: 		linenum = testnum();
	call	testnum		#
	mov.w	r1, r0	# _10,
# basic.c:2701: 		linenum = testnum();
...
# basic.c:2703: 		ignore_blanks();
	call	ignore_blanks		#
# basic.c:2705: 		if (linenum == 0)
...
# basic.c:2705: 		if (linenum == 0)
	...
	jnz	.L552		#
.L558:
# basic.c:2708: 				res = direct();
	call	direct		#
	st.w	[r13 + (-4)], r0	# res,
# basic.c:2709: 				if (res == 1)
	ld.w	r1, [r13 + (-4)]	# tmp64, res
	mov.w	r0, 1	# tmp65,
	cmp.w	r1, r0	# tmp64, tmp65
	jnz	.L553		#
# basic.c:2710: 					return 0;
	xor.w	r0, r0	# _65
	j	.L561		#
.L553:
# basic.c:2711: 				if (res == 2)
	ld.w	r1, [r13 + (-4)]	# tmp66, res
	mov.w	r0, 2	# tmp67,
	cmp.w	r1, r0	# tmp66, tmp67
	jnz	.L555		#
# basic.c:2713: 					txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	ld.w	r0, [current_line]	# current_line.610_13, current_line
	add.w	r0, 5 #111	# _14,
# basic.c:2713: 					txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	st.w	[txtpos], r0	# txtpos, _14
# basic.c:2714: 					continue;
	j	.L556		#
.L555:
# basic.c:2716: 				ignore_blanks();
	call	ignore_blanks		#
# basic.c:2717: 				if (*txtpos == NL || *txtpos != ':')
...
# basic.c:2719: 				txtpos++;
	...
	add.w	r0, 1 #111	# _20,
	st.w	[txtpos], r0	# txtpos, _20
# basic.c:2720: 				ignore_blanks();
	call	ignore_blanks		#
.L556:
# basic.c:2708: 				res = direct();
	j	.L558		#
.L552:
# basic.c:2723: 		else if (linenum == 0xFFFF)
...
# basic.c:2725: 			qhow();
	...
	j	.L560		#
.L559:
# basic.c:2729: 			entered_with_line_num();
	call	entered_with_line_num		#
# basic.c:2689: 		if (res != 3)
	j	.L560		#
.L561:
